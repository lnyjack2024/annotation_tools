...
!(function () {
  ...
  function j(e, t) {
    return (
      (n = se.fromDom(e)),
      (r = t),
      0 < (o = y(n.dom.childNodes, se.fromDom)).length && r < o.length
        ? M(o[r], 0)
        : M(n, r)
    );
    var n, r, o;
  ...
  function H(e, t, n, r, o) {
    ...
    I((i = e), (a = n)) ||
      P(i, a) ||
      R(i, a) ||
      ('true' === (c = i).getContentEditable((u = a)) &&
        'false' === c.getContentEditableParent(u.parentNode)) ||
      ((l = e.getParent(r, e.isBlock)),
      (s = new de(n, l)),
      V(e, (o ? s.next : s.prev).bind(s), n, {
        boundary: f,
        cef: f,
        text: function (e) {
          o ? (t.fOffset += e.length) : (t.sOffset += e.length),
            t.elements.push(se.fromDom(e));
        },
      }));
  }
  function L(e, t, n, r, o, i) {
    ...
    var a = new de(n, t),
      ...
      u = W();
    function l() {
      return 0 < u.elements.length && (c.push(u), (u = W())), !1;
    }
    return (
      H(e, u, n, t, !1),
      V(
        ...
        n,
        {
          ...
          text: function (e) {
            u.elements.push(se.fromDom(e)), o && o.text(e, u);
          },
        },
        r,
        i,
  ...
  function U(u, e) {
    var n = j(e.startContainer, e.startOffset),
      r = n.element.dom,
      o = j(e.endContainer, e.endOffset),
      i = o.element.dom;
    return L(
      u,
        ...
        cef: function (e) {
          var t,
            ...
            a = w(
              ...
              (1 !== (o = i = void 0 === n ? document : n.dom).nodeType &&
                9 !== o.nodeType &&
                11 !== o.nodeType) ||
              0 === o.childElementCount
                ? []
                : y(i.querySelectorAll(r), se.fromDom)),
              function (e) {
                var t = e.dom;
                return L(u, t, t);
              },
            ...
            c = function (e, t) {
              return (
                ...
                0 != (n.compareDocumentPosition(r) & o) ? 1 : -1
              );
              var n, r, o;
            };
          return (t = k.call(a, 0)).sort(c), t;
        },
      },
      !1,
    );
  ...
  function $(e, t) {
    return t.collapsed ? [] : U(e, t);
  }
  function _(e, t) {
    var n = e.createRng();
    return n.selectNode(t), $(e, n);
  }
  function z(c, e) {
        ...
        i = (function (e, t, n, r) {
          ...
          for (var i, a = []; (i = o.exec(e)); ) {
            var c = i[t.matchIndex],
              ...
              l = u + c.length;
            if (r < l) break;
            a.push({ start: u, finish: l }), (o.lastIndex = l);
          }
          return a;
  ...
  function q(e, i) {
    b(e, function (e, o) {
      b(e, function (e) {
        var t = se.fromDom(i.cloneNode(!1));
        D(t, 'data-mce-index', o);
        var n,
          r = e.element.dom;
    ...
    return (
      ...
      r
        ? ((c = e.dom),
          ...
          (s = o),
          (d = l.getBookmark()),
          (m = c.select('td[data-mce-selected],th[data-mce-selected]')),
          q(
            (h = z(
              u,
              0 < m.length
          ...
          l.moveToBookmark(d),
          h.length)
        : ((i = o), q((a = z(n, _(e.dom, g))), i), a.length)
    );
  }
  function J(e) {
    var t = e.parentNode;
  ...
  function Q(e, t) {
    var n = [],
      r = N.toArray(e.getBody().getElementsByTagName('span'));
    if (r.length)
  ...
  function X(e, t, n) {
    ...
    (n = !1 !== n)
      ...
      ? (o = r.count - 1)
      : o--,
      i.removeClass(Q(e, r.index), 'mce-match-marker-selected');
    var a = Q(e, o);
    return a.length
      ? (i.addClass(Q(e, o), 'mce-match-marker-selected'),
    ...
    var a,
      ...
      l =
        ...
        (c =
          ...
          ')'),
        a ? '(?:^|\\s|' + E() + ')' + c + '(?=$|\\s|' + E() + ')' : c),
      s = K(e, t, { regex: new RegExp(l, r ? 'g' : 'gi'), matchIndex: 1 }, i);
    return (
      s &&
        ((u = X(e, t, !0)),
        t.set({
  ...
  function re(e, t, n, r, o) {
    ...
    for (
      var l = e.getBody(),
        s = N.grep(N.toArray(l.getElementsByTagName('span')), ne),
        f = 0;
      f < s.length;
      f++
    ) {
      ...
      if (o || m === a.index) {
        for (
          n.length
            ? ((s[f].firstChild.nodeValue = n), J(s[f]))
            : Y(e.dom, s[f]);
          s[++f];

        ) {
          if ((m = parseInt(G(s[f]), 10)) !== i) {
            f--;
            break;
          }
          Y(e.dom, s[f]);
    ...
    return (
      t.set(v(v({}, a), { count: o ? 0 : a.count - 1, index: u })),
      (r ? ee : te)(e, t),
      !o && 0 < t.get().count
    );
  }
  function oe(i, a) {
    ...
    i.undoManager.add();
    var d = N.trim(i.selection.getContent({ format: 'text' })),
      m = a.get(),
      h = {
        ...
        onAction: function (e, t) {
          ...
          switch (t.name) {
            case 'find':
              ...
              break;
            case 'replace':
              (re(i, a, o.replacetext) ? c : s)(e);
              break;
            case 'replaceall':
              re(i, a, o.replacetext, !0, !0), s(e);
              break;
            case 'prev':
              te(i, a), c(e);
              break;
        ...
        onClose: function () {
          i.focus(), me(i, a), i.undoManager.add();
        },
      };
    r.set(i.windowManager.open(h, { inline: 'toolbar' }));
  }
  function ie(e, t) {
    return function () {
      oe(e, t);
  ...
  var ue,
    ...
    se = {
      ...
      fromPoint: function (e, t, n) {
        return T.from(e.dom.elementFromPoint(t, n)).map(ce);
      },
    },
    fe =
      ((ue = ae),
      {
        get: function (e) {
          if (!ue(e)) throw new Error('Can only get text value of a text node');
          return le(e).getOr('');
        },
        getOption: (le = function (e) {
          return ue(e) ? T.from(e.dom.nodeValue) : T.none();
        }),
        set: function (e, t) {
          if (!ue(e))
    ...
    de = tinymce.util.Tools.resolve('tinymce.dom.TreeWalker'),
    me = function (e, t, n) {
      for (
        var r,
          o,
          i = t.get(),
          a = N.toArray(e.getBody().getElementsByTagName('span')),
          c = 0;
        c < a.length;
        c++
      ) {
        ...
        null !== u &&
          u.length &&
          (u === i.index.toString() &&
            ((r = r || a[c].firstChild), (o = a[c].firstChild)),
          J(a[c]));
      }
      if ((t.set(v(v({}, i), { index: -1, count: 0, text: '' })), r && o)) {
    ...
    he = tinymce.util.Tools.resolve('tinymce.Env');
    ...
    return (
      ...
      (i = a),
      {
        ...
        find: function (e, t, n, r) {
          return Z(o, i, e, t, n, (r = void 0 !== r && r));
        },
        next: function () {
          return ee(o, i);
        },
