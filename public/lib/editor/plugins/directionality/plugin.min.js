...
!(function () {
  ...
  function g(n, t) {
    for (var r = 0, o = n.length; r < o; r++) t(n[r], r);
  }
  function h(n, t) {
    var r = n.dom;
  ...
  function O(n) {
    return 'rtl' ===
      ((r = 'direction'),
      (o = (t = n).dom),
      '' !== (e = window.getComputedStyle(o).getPropertyValue(r)) || B(t)
        ? e
        : H(o, r))
      ? 'rtl'
      : 'ltr';
  ...
  function C(n, u) {
    ...
    0 < t.length &&
      (g(t, function (n) {
        ...
        y.from(e.dom.parentNode)
          .map(w.fromDom)
          .filter(E)
          .each(function (n) {
            O(n) !== u ? N(e, 'dir', u) : O(e) !== u && T(e, 'dir'),
              o &&
                g(A(e, 'li[dir]'), function (n) {
                  return T(n, 'dir'), 0;
                });
          });
      }),
  ...
  var E = D(1),
    ...
    B = function (n) {
      ...
      return (
        (e = w.fromDom(t)),
        (i = x(e)),
        (R((u = i)) && null != u.dom.host ? y.some(i) : y.none()).fold(
          function () {
    ...
    H = function (n, t) {
      return void 0 !== n.style && f(n.style.getPropertyValue)
