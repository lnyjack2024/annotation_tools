...
!(function () {
  ...
  var d = function (t) {
    ...
    b = {};
  function h(e) {
    return r.Prism && e.getParam('codesample_global_prismjs', !1, 'boolean')
      ? r.Prism
      : k;
  }
  function y(e) {
  ...
  function w(s) {
    var t,
      ...
      a = (0 < (e = n).length ? p.some(e[0]) : p.none()).fold(
        o(''),
        function (e) {
          return e.value;
        },
    ...
    s.windowManager.open({
      ...
      body: {
        type: 'panel',
        items: [
          { type: 'selectbox', name: 'language', label: 'Language', items: n },
        ...
        t.undoManager.transact(function () {
          ...
          return (
            ...
            e.fold(
              function () {
                t.insertContent(
                  '<pre id="__new" class="language-' + a + '">' + r + '</pre>',
                ),
                  t.selection.select(t.$('#__new').removeAttr('id')[0]);
              },
              function (e) {
                t.dom.setAttrib(e, 'class', 'language-' + a),
                  (e.innerHTML = r),
                  h(t).highlightElement(e),
    ...
    (window.Prism = { manual: !0 }),
      (function (e) {
        ...
        return (function s(i, o, l) {
          ...
          for (var c = !1, e = 0; e < l.length; e++) u(l[e]);
          return u;
        })(
          {
            1: [
                        ...
                        C = {
                          ...
                          util: {
                            ...
                            clone: function t(e, a) {
                              var r, n;
                              switch (((a = a || {}), C.util.type(e))) {
                                case 'Object':
                                  if (((n = C.util.objId(e)), a[n]))
                                    return a[n];
                          ...
                          languages: {
                            ...
                            extend: function (e, n) {
                              var t,
                                a = C.util.clone(C.languages[e]);
                              for (t in n) a[t] = n[t];
                              return a;
                            },
                            insertBefore: function (t, e, n, a) {
                              var r,
                                s = (a = a || C.languages)[t],
                                i = {};
                              for (r in s)
                            ...
                            DFS: function e(n, t, a, r) {
                              ...
                              for (s in n)
                                n.hasOwnProperty(s) &&
                                  (t.call(n, s, n[s], a || s),
                                  (i = n[s]),
                                  'Object' !== (o = C.util.type(i)) || r[l(i)]
                                    ? 'Array' !== o ||
                                      r[l(i)] ||
                                      ((r[l(i)] = !0), e(i, t, s, r))
                                    : ((r[l(i)] = !0), e(i, t, null, r)));
                            },
                          },
                          plugins: {},
                          ...
                          highlightAllUnder: function (e, n, t) {
                            ...
                            for (var r, s = 0; (r = a.elements[s++]); )
                              C.highlightElement(r, !0 === n, a.callback);
                          },
                          highlightElement: function (e, n, t) {
                            var a = C.util.getLanguage(e),
                              r = C.languages[a];
                            e.className =
                            ...
                            C.hooks.run('before-highlight', o),
                              o.grammar
                                ? n && u.Worker
                                  ? (((i = new Worker(C.filename)).onmessage =
                                      function (e) {
                                        l(e.data);
                                      }),
                                    i.postMessage(
                          ...
                          highlight: function (e, n, t) {
                            ...
                            return (
                              ...
                              O.stringify(C.util.encode(a.tokens), a.language)
                            );
                          },
                                    ...
                                    for (
                                      ...
                                      for (
                                        var b = d.pattern || d,
                                          h = r.next,
                                          y = s;
                                        h !== t.tail && !(i && y >= i.reach);
                                        y += h.value.length, h = h.next
                                      ) {
                                        var w = h.value;
                                        ...
                                        if (!(w instanceof O)) {
                                          var k,
                                            v = 1;
                                          if (m) {
                                            if (!(k = N(b, y, n, g))) break;
                                            var x = k.index,
                                              _ = k.index + k[0].length,
                                              F = y;
                                            for (F += h.value.length; F <= x; )
                                              F += (h = h.next).value.length;
                                            if (
                                              ((y = F -= h.value.length),
                                              h.value instanceof O)
                                            )
                                              continue;
                                            for (
                                              var P = h;
            ...
            5: [
              function (e, n, t) {
                !(function (t) {
                  ...
                  var l = o('class enum interface struct'),
                    u = RegExp(
                      o(n + ' class enum interface struct ' + s + ' ' + i),
                    ),
                    c = o('class enum interface struct ' + s + ' ' + i),
                    d = o(n + ' class enum interface struct ' + i),
                    p = e(/<(?:[^<>;=+\-*/%&|^]|<<self>>)*>/.source, 2),
                    g = e(/\((?:[^()]|<<self>>)*\)/.source, 2),
                    m = /@?\b[A-Za-z_]\w*\b/.source,
                    f = a(/<<0>>(?:\s*<<1>>)?/.source, [m, p]),
                    b = a(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [c, f]),
                    h = /\[\s*(?:,\s*)*\]/.source,
                    y = a(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [
                      b,
                      h,
                    ]),
                    w = a(/[^,()<>[\];=+\-*/%&|^]|<<0>>|<<1>>|<<2>>/.source, [
                  ...
                  (t.languages.csharp = t.languages.extend('clike', {
                    string: [
                      ...
                      { pattern: RegExp(_), greedy: !0, alias: 'character' },
                    ],
                    'class-name': [
                      {
                        pattern: r(
                      ...
                      {
                        pattern: r(/(\b<<0>>\s+)<<1>>/.source, [l, f]),
                        lookbehind: !0,
                        inside: x,
                      },
                      {
                        pattern: r(/(\bcatch\s*\(\s*)<<0>>/.source, [b]),
                        lookbehind: !0,
                        inside: x,
                      },
                      {
                    ...
                    t.languages.insertBefore('csharp', 'class-name', {
                      ...
                      'constructor-invocation': {
                        pattern: r(/(\bnew\s+)<<0>>(?=\s*[[({])/.source, [v]),
                        lookbehind: !0,
                        inside: x,
                        alias: 'class-name',
                      },
                      'generic-method': {
                        pattern: r(/<<0>>\s*<<1>>(?=\s*\()/.source, [m, p]),
                        inside: {
                  ...
                  var P = F + '|' + _,
                    ...
                    S = e(a(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [A]), 2),
                    $ =
                      /\b(?:assembly|event|field|method|module|param|property|return|type)\b/
                        .source,
                    z = a(/<<0>>(?:\s*\(<<1>>*\))?/.source, [b, S]);
                  t.languages.insertBefore('csharp', 'class-name', {
                    attribute: {
                      pattern: r(
                  ...
                  (y.languages['markup-templating'] = {}),
                  {
                      ...
                      value: function (a, r, e, s) {
                        ...
                        a.language === r &&
                          ...
                          (a.code = a.code.replace(e, function (e) {
                            ...
                            for (
                              var n, t = i.length;
                              -1 !== a.code.indexOf((n = h(r, t)));

                            )
                              ++t;
                            return (i[t] = e), n;
                          })),
                          (a.grammar = y.languages.markup));
                      },
                    },
                    tokenizePlaceholders: {
                      value: function (g, m) {
                        ...
                        g.language === m &&
                          g.tokenStack &&
                          ((g.grammar = y.languages[m]),
                          (f = 0),
                          (b = Object.keys(g.tokenStack)),
                          (function e(n) {
                            for (
                              var t = 0;
                              t < n.length && !(f >= b.length);
                              t++
                            ) {
                              var a,
                                r,
                              ...
                              (p.content && 'string' == typeof p.content)
                                ? ((a = b[f]),
                                  ...
                                  -1 < (o = s.indexOf(i)) &&
                                    ...
                                    (u = new y.Token(
                                      m,
                                      y.tokenize(r, g.grammar),
                                      'language-' + m,
                                      r,
                                    )),
                                    (c = s.substring(o + i.length)),
                                    (d = []),
                                    l && d.push.apply(d, e([l])),
                                    d.push(u),
                                    c && d.push.apply(d, e([c])),
                                    'string' == typeof p
                                      ? n.splice.apply(n, [t, 1].concat(d))
                                      : (p.content = d)))
                                : p.content && e(p.content);
                            }
                            return n;
                          })(g.tokens));
                      },
            ...
            14: [
              function (e, n, t) {
                var a = e('prismjs/components/prism-core');
  ...
  t.add('codesample', function (n) {
    ...
    (r = (t = n).$),
      t.on('PreProcess', function (e) {
        r('pre[contenteditable=false]', e.node)
          .filter(c(u))
          .each(function (e, n) {
            var t = r(n),
              a = n.textContent;
            t.attr('class', r.trim(t.attr('class'))),
              t.removeAttr('contentEditable'),
              t.empty().append(
                r('<code></code>').each(function () {
                  this.textContent = a;
                }),
              );
          });
          ...
          t.undoManager.transact(function () {
            e.each(function (e, n) {
              r(n)
                ...
                h(t).highlightElement(n),
                (n.className = r.trim(n.className));
            });
          });
      }),
