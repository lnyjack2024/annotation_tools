    ...
    a.ui.registry.addButton('quickimage', {
      ...
      onAction: function () {
        ...
        new s(function (n) {
          ...
          var o = function (t) {
            ...
            d.os.isAndroid() && 'remove' !== t.type
              ? f.setEditorTimeout(i, e, 0)
              : e(),
          ...
          0 < t.length &&
            ...
            new s(function (t) {
              ...
              (n = t),
                (r = c),
                (i = (e = a).editorUpload.blobCache),
                (u = i.create(
                  ((o = new Date().getTime()),
                  'mceu_' + Math.floor(1e9 * Math.random()) + ++l + String(o)),
                  r,
                  n,
                )),
                i.add(u),
                e.insertContent(e.dom.createHTML('img', { src: u.blobUri() }));
            }));
        });
      },
    }),
      a.ui.registry.addButton('quicktable', {
        ...
        onAction: function () {
          var t, n;
          (t = a).plugins.table
            ? t.plugins.table.insertTable(2, 2)
            : (n = t).undoManager.transact(function () {
                n.insertContent(
                  (function () {
    ...
    x =
      ...
      function (t, e, n) {
        return (
          ...
          (function (t, e) {
            if (g(t) || m(t))
              throw new Error('expected a string but found: ' + t);
    ...
    n(t),
          ...
          predicate: function (t) {
            ...
            return E(N, O, n, 'table', e).fold(function () {
              return E(
                ...
                function (t) {
                  return (
                    t.dom.nodeName.toLowerCase() in r && o.dom.isEmpty(t.dom)
                  );
                },
                e,
              ).isSome();
      ...
      (function (e) {
        function n(t) {
          return (
            'IMG' === t.nodeName ||
            ('FIGURE' === t.nodeName && /image/i.test(t.className))
          );
        }
        var t = x(
          e,
        ...
        0 < t.trim().length &&
          e.ui.registry.addContextToolbar('imageselection', {
            predicate: n,
            items: t,
            position: 'node',
          });
          ...
          e.ui.registry.addContextToolbar('textselection', {
            predicate: function (t) {
              return (
                ...
                'false' !== e.dom.getContentEditableParent(t)
              );
            },
            items: r,
            position: 'selection',
