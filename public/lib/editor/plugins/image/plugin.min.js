...
!(function () {
  ...
  function Z(e) {
    return (
      0 === we.getAttrib(e, 'alt').length &&
      'presentation' === we.getAttrib(e, 'role')
    );
  }
  function q() {
    return {
  ...
  function ae(r, e) {
    var t = (function (e) {
      ...
      if (
        ...
        Se(t, e.alt, e.isDecorative),
        e.caption)
      ) {
        var n = we.create('figure', { class: 'image' });
        return (
          n.appendChild(t),
          n.appendChild(
            we.create('figcaption', { contentEditable: 'true' }, 'Caption'),
          ),
    ...
    r.dom.setAttrib(t, 'data-mce-id', '__mcenew'),
      r.focus(),
      r.selection.setContent(t.outerHTML);
    var n,
      a = r.dom.select('*[data-mce-id="__mcenew"]')[0];
    r.dom.setAttrib(a, 'data-mce-id', null),
      X(a) ? ((n = re(r, a)), r.selection.select(n)) : r.selection.select(a);
  }
  function ie(e) {
    ...
    return S([
      ...
      [
        y(
          y(
            {},
            e.classList.isSome() && e.hasImageCaption
              ? { type: 'grid', columns: 2 }
              : { type: 'panel' },
          ),
          {
  ...
  function ue(e, t, n, r) {
    ...
    (U = t),
      ...
      (/^(?:[a-zA-Z]+:)?\/\//.test(O)
        ? L.none()
        : x.prependURL.bind(function (e) {
            return O.substring(0, e.length) !== e ? L.some(e + O) : L.none();
          })
      ).each(function (e) {
        C.setData({ src: { value: e, meta: I.src.meta } });
      }),
      (h = t),
      (w = (b = r).getData()),
      void 0 !== (S = w.src.meta) &&
        ...
        (A = y),
        (D = S),
        (v = h).hasDescription && T(D.alt) && (A.alt = D.alt),
        v.hasAccessibilityOptions &&
          (A.isDecorative = D.isDecorative || A.isDecorative || !1),
        v.hasImageTitle && T(D.title) && (A.title = D.title),
        v.hasDimensions &&
          (T(D.width) && (A.dimensions.width = D.width),
          T(D.height) && (A.dimensions.height = D.height)),
        T(D.class) &&
          Pe(v.classList, D.class).each(function (e) {
            A.classes = e.value;
          }),
        v.hasImageCaption && N(D.caption) && (A.caption = D.caption),
        v.hasAdvTab &&
          (T(D.style) && (A.style = D.style),
          T(D.vspace) && (A.vspace = D.vspace),
          T(D.border) && (A.border = D.border),
          T(D.hspace) && (A.hspace = D.hspace),
          T(D.borderstyle) && (A.borderstyle = D.borderstyle)),
        b.setData(y)),
      (a = e),
      (i = t),
      (o = n),
      (c = (s = (l = r).getData()).src.value),
      (u = s.src.meta || {}).width ||
        u.height ||
        !i.hasDimensions ||
        (0 < c.length
          ...
          : l.setData({ dimensions: { width: '', height: '' } })),
      (m = t),
      (d = n),
      (p = (g = r).getData()),
      (f = Pe(m.imageList, p.src.value)),
      (d.prevImage = f),
      g.setData({
        images: f
          .map(function (e) {
  ...
  function me(l, s, t, c) {
    ...
    c.block('Uploading image'),
      (0 < (e = n.fileinput).length ? L.some(e[0]) : L.none()).fold(
        function () {
          c.unblock();
        },
        function (n) {
    ...
    return function (e, t) {
      ...
      'src' === t.name
        ...
        ? ((c = S),
          ...
          (m = C),
          (g = (d = e).getData()),
          (p = Pe(u.imageList, g.images)).each(function (e) {
            '' === g.alt ||
            m.prevImage
              .map(function (e) {
                return e.text === g.alt;
              ...
              .getOr(!1)
              ? '' === e.value
                ? d.setData({ src: e, alt: m.prevAlt })
                : d.setData({ src: e, alt: e.text })
              : d.setData({ src: e });
          }),
          (m.prevImage = p),
          ue(c, u, m, d))
        : 'alt' === t.name
        ? (C.prevAlt = e.getData().alt)
        : 'style' === t.name
        ? ((o = S),
          (s = (l = e).getData()),
          (y = o.parseStyle),
          ...
          ((w = Ce({}, A)).vspace =
            ...
            D['margin-top'] === D['margin-bottom']
              ? O(String(D['margin-top']))
              : ''),
          (w.hspace =
            D['margin-right'] &&
            D['margin-left'] &&
            D['margin-right'] === D['margin-left']
              ? O(String(D['margin-right']))
              : ''),
          (w.border = D['border-width'] ? O(String(D['border-width'])) : ''),
          (w.borderstyle = D['border-style'] ? String(D['border-style']) : ''),
          (w.style = v(y(v(D)))),
          l.setData(w))
        : 'vspace' === t.name ||
          'hspace' === t.name ||
          ...
          'borderstyle' === t.name
        ? ((n = S),
          (a = Ce(se(U.image), (r = e).getData())),
          (f = n.normalizeCss),
          (h = ce(a, !1)),
          H((b = document.createElement('img')), 'style', h.style),
          (!R(b) && '' === h.hspace) || V(b, h.hspace),
          (!k(b) && '' === h.vspace) || $(b, h.vspace),
          (!z(b) && '' === h.border) || J(b, h.border),
          (!j(b, 'borderStyle') && '' === h.borderStyle) || K(b, h.borderStyle),
          (i = f(b.getAttribute('style'))),
          r.setData({ style: i }))
        : 'fileinput' === t.name
        ? me(S, U, C, e)
        : 'isDecorative' === t.name &&
        ...
        onSubmit: function (n) {
          return function (e) {
            ...
            c.execCommand(
              'mceUpdateImage',
              !1,
              ce(t, n.hasAccessibilityOptions),
            ),
              c.editorUpload.uploadImagesAuto(),
              e.close();
          };
        },
        imageSize: function (e) {
          return (
            (a = s.documentBaseURI.toAbsolute(e)),
            new Ae(function (t) {
              function n(e) {
        ...
        uploadImage:
          ...
          function (e) {
            return Ie(t)
              ...
              .then(function (e) {
                return 0 === e.length
                  ? Ae.reject('Failed to upload image')
                  : !1 === e[0].status
                  ? Ae.reject(e[0].error.message)
                  : e[0];
              });
          }),
      };
    return {
      open: function () {
        ...
        (r = v),
          ...
          (o = Le(r.getParam('image_class_list'))),
          (l = r.getParam('image_advtab', !1, 'boolean')),
          (s = r.getParam('image_uploadtab', !0, 'boolean')),
          (c = D(r.getParam('images_upload_url'))),
          (u = D(r.getParam('images_upload_handler'))),
          (m = (e = ne((t = r)))
            ? Q(function (e) {
                return te(t, e);
              }, e)
            : q()),
          (d = r.getParam('image_description', !0, 'boolean')),
          (g = r.getParam('image_title', !1, 'boolean')),
          (p = I(r)),
          (f = r.getParam('image_caption', !1, 'boolean')),
          (h = r.getParam('a11y_advanced_options', !1, 'boolean')),
          (b = r.getParam('automatic_uploads', !0, 'boolean')),
          (y = L.some(r.getParam('image_prepend_url', '', 'string')).filter(
            function (e) {
                    ...
                    (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler
                      ? {
                          ...
                          tabs: S([
                            ...
                            r.hasAdvTab ? [_e(r)] : [],
                            r.hasUploadTab &&
                            (r.hasUploadUrl || r.hasUploadHandler)
                              ? [ke(r)]
                              : [],
                          ]),
                        }
                      : { type: 'panel', items: Re(r) },
                  buttons: [
  ...
  function pe(b) {
    b.addCommand('mceImage', ge(b).open),
      b.addCommand('mceUpdateImage', function (e, h) {
        b.undoManager.transact(function () {
          var t, e, n, r, a, i, o, l, s, c, u, m, d, g, p;
          function f() {
            (g.onload = g.onerror = null),
              m.selection && (m.selection.select(g), m.nodeChanged());
          }
          (e = h),
            (l = ne((t = b)))
              ? ((n = Q(function (e) {
                ...
                (r = y(y({}, n), e)).src
                  ? ((c = r),
                    ...
                    s.dom.setAttrib(p, 'src', p.getAttribute('src')),
                    X(p.parentNode)
                      ? ((u = p.parentNode),
                        re(s, u),
                        s.selection.select(p.parentNode))
                      : (s.selection.select(p),
                        (m = s),
                        (d = c),
                        ((g = p).onload = function () {
                          d.width ||
  ...
  var be,
    ...
    Se = function (e, t, n) {
      n
        ? (we.setAttrib(e, 'role', 'presentation'), C(ye(e), 'alt', ''))
        : (a === t ? ye(e).dom.removeAttribute('alt') : C(ye(e), 'alt', t),
          'presentation' === we.getAttrib(e, 'role') &&
            we.setAttrib(e, 'role', ''));
    },
    Ue = function (e, t, n) {
      ...
      Y(n, r, t, 'caption', function (e, t, n) {
        return (
          B((r = e))
            ? ((o = r.parentNode), we.insertAfter(r, o), we.remove(o))
            : ((a = r),
              (i = we.create('figure', { class: 'image' })),
              we.insertAfter(i, a),
              i.appendChild(a),
              i.appendChild(
                we.create('figcaption', { contentEditable: 'true' }, 'Caption'),
        ...
        Y(n, r, t, 'hspace', ee(V, e)),
        Y(n, r, t, 'vspace', ee($, e)),
        Y(n, r, t, 'border', ee(J, e)),
        Y(n, r, t, 'borderStyle', ee(K, e)),
        (t.alt === r.alt && t.isDecorative === r.isDecorative) ||
    ...
    Ce =
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var a,
            i = e[r];
          for (a in i) h(i, a) && (n[a] = be(n[a], i[a]));
        }
        return n;
      }),
    ...
    Oe = function (e, i) {
      ...
      return (
        xe.each(e, function (e) {
          ...
          void 0 !== e.menu
            ? ((n = Oe(e.menu, i)), o.push({ text: a, items: n }))
    ...
    Ee = function (e) {
      return { title: 'General', name: 'general', items: le(e) };
    },
    Re = le,
    ke = function (e) {
      return {
  ...
  o.add('image', function (e) {
    ...
    (t = e).on('PreInit', function () {
      t.parser.addNodeFilter('figure', fe(!0)),
        t.serializer.addNodeFilter('figure', fe(!1));
    }),
