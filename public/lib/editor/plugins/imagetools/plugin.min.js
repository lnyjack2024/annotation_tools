...
!(function () {
  ...
  function g(t, e) {
    return _(document.createElement('canvas'), t, e);
  }
  function p(t) {
    var e = g(t.width, t.height);
    return A(e).drawImage(t, 0, 0), e;
  }
  var v,
    y,
    w,
    ...
    R =
      ...
      (x.prototype.then = function (n, r) {
        var o = this;
        return new x(function (t, e) {
          U.call(o, new O(n, r, t, e));
        });
      }),
      (x.all = function () {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        var u = Array.prototype.slice.call(
          1 === t.length && b(t[0]) ? t[0] : t,
        );
      ...
      (x.resolve = function (e) {
        return e && 'object' == typeof e && e.constructor === x
          ? e
          : new x(function (t) {
              t(e);
            });
  ...
  function U(n) {
    ...
    null !== this._state
      ? y(function () {
          var t,
            e = r._state ? n.onFulfilled : n.onRejected;
          if (null !== e) {
            try {
              t = e(r._value);
            } catch (t) {
    ...
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        ...
        if ('function' == typeof e)
          return void E(w(e, t), w(j, this), w(S, this));
      }
      (this._state = !0), (this._value = t), M.call(this);
    } catch (t) {
      S.call(this, t);
    }
  }
  function S(t) {
    (this._state = !1), (this._value = t), M.call(this);
  }
  function M() {
  ...
  function L(u) {
    return new R(function (t, e) {
      ...
      var r = URL.createObjectURL(u),
        ...
        a = function () {
          n(), e('Unable to load data of type ' + u.type + ': ' + r);
        };
  ...
  function k(t, r, o) {
    return (
      (r = r || 'image/png'),
      a(HTMLCanvasElement.prototype.toBlob)
        ? new R(function (e, n) {
            t.toBlob(
              function (t) {
                t ? e(t) : n();
        ...
        !(function () {
          ...
          for (
            ...
            for (
              ...
              f[m] = o[d].charCodeAt(0);
            u[c] = new Uint8Array(f);
          }
          return T.some(new Blob(u, { type: n }));
        })().fold(function () {
          e('uri is not base64: ' + h);
        }, t);
      });
    },
    D = function (t) {
  ...
  function $(e, t) {
    return k(e, t).then(function (t) {
      return q(R.resolve(e), t, e.toDataURL());
    });
  }
  function W(t, e) {
    void 0 === e && (e = 2);
    ...
    return (
      ...
      new R(function (t) {
        ...
        (a.onreadystatechange = function () {
          4 === a.readyState && t({ status: a.status, blob: a.response });
        }),
          a.open('GET', e, !0),
          (a.withCredentials = r),
          (function (t) {
            for (var e, n = z(t), r = 0, o = n.length; r < o; r++) {
              var i = n[r];
              (e = t[i]), a.setRequestHeader(i, e);
            }
          })(n),
          (a.responseType = 'blob'),
          a.send();
    ...
    var e,
      n =
        ...
        'ImageProxy HTTP error: ' +
          C(rt, function (t) {
            return e === t.code;
          }).fold(i('Unknown ImageProxy error'), function (t) {
            return t.message;
          }));
    return R.reject(n);
  }
  function J(e) {
    return C(ot, function (t) {
      return t.type === e;
    }).fold(i('Unknown service error'), function (t) {
      return t.message;
    });
  }
  function K(t) {
    return (
      ...
      (function (t) {
        ...
        .bind(function (t) {
          return (
            (n = function (t, e) {
              return h(t) ? t[e] : void 0;
            }),
            (r = t),
            P(['error', 'type'], function (t, e) {
              r = n(r, t);
            }),
            (e = r),
            T.from(e).map(J)
  ...
  function Q(t, e) {
    ...
    return V(
      ...
      return X(t.status)
        ? ((e = t.status),
          'application/json' !== (null == (n = t.blob) ? void 0 : n.type) ||
    ...
    return (
      ...
      e
        ...
        : V(t, {}, n).then(function (t) {
            return X(t.status) ? G(t.status) : R.resolve(t.blob);
          })
    );
  }
  function Z(e) {
    return (
      ...
      new R(function (t) {
        ...
        return q(
          L(e).then(function (t) {
            D(t);
            var e = g(t.naturalWidth || t.width, t.naturalHeight || t.height);
            return A(e).drawImage(t, 0, 0), e;
          }),
          e,
          t,
      ...
      u.push(i),
        (n[i] = function () {
          ...
          return {
            ...
            log: function (t) {
              console.log(t, { constructors: u, constructor: i, params: n });
            },
          };
        });
    });
  ...
  var et = function (t, e, n) {
      var r = ((n < 0 ? 360 + n : n) * Math.PI) / 180,
        ...
        a = Math.sin(r),
        u = Math.cos(r),
        c = W(Math.abs(o * u) + Math.abs(i * a)),
        s = W(Math.abs(o * a) + Math.abs(i * u)),
        l = g(c, s),
        f = A(l);
      return (
        f.translate(c / 2, s / 2),
        f.rotate(r),
        f.drawImage(t, -o / 2, -i / 2),
        $(l, e)
      );
    },
    nt = function (t, e, n) {
      var r = g(t.width, t.height),
        o = A(r);
      return (
        'v' === n
    ...
    it = {
      ...
      fromPoint: function (t, e, n) {
        return T.from(t.dom.elementFromPoint(e, n)).map(tt);
      },
    };
  function at(t) {
  ...
  function ut(t) {
    ...
    return n || r
      ? e(n) && e(r)
        ? { w: parseInt(n, 10), h: parseInt(r, 10) }
        : null
      : ((n = t.width),
        (r = t.height),
        n && r ? { w: parseInt(n, 10), h: parseInt(r, 10) } : null);
  }
  function ct(t) {
  ...
  function st(t) {
    return (
      ...
      C(e.dom.childNodes, function (t) {
        return r(it.fromDom(t));
      }).map(it.fromDom)
    );
    var e, n, r;
  }
  ...
  function dt(e, t) {
    function n(t) {
      return ft(e, t) && (jt(e, t) || St(e, t) || h(at(e)));
    }
    return lt(e, t)
      ? st(t).bind(function (t) {
          return n(t.dom) ? T.some(t.dom) : T.none();
        })
      : n(t)
      ? T.some(t)
      : T.none();
  ...
  function pt(t, e) {
    if (St(t, e))
      return Y(
        ...
        -1 !==
          l.inArray(
            t.getParam('imagetools_credentials_hosts', [], 'string[]'),
            new xt(n.src).host,
          )),
      );
    var n, r;
    if (jt(t, e)) return (0 === (r = e.src).indexOf('data:') ? N : B)(r);
    var o = at(t);
    return Y(
      o +
        (-1 === o.indexOf('?') ? '?' : '&') +
      ...
      t.getParam(
        'api_key',
        t.getParam('imagetools_api_key', '', 'string'),
        'string',
      ),
      !1,
    );
  ...
  function vt(t, e) {
    var n,
      r,
      o = t.editorUpload.blobCache.getByUri(e.src);
    return o
      ? Rt.resolve(o.blob())
      : ((n = t),
        (r = e),
        T.from(n.getParam('imagetools_fetch_image', null, 'function')).fold(
          function () {
            return pt(n, r);
          },
          function (t) {
  ...
  function yt(t) {
    _t.clearTimeout(t.get());
  }
  function wt(u, c, s, l, f, d, m) {
    return s.toBlob().then(function (t) {
      var e,
        n,
        o,
        ...
        a = c.type === t.type;
      return (
        u.getParam('images_reuse_filename', !1, 'boolean') &&
          (n = h((o = r.getByUri(i)))
        ...
        u.undoManager.transact(function () {
          var r = function () {
            ...
            u.$(d).off('load', r),
              u.nodeChanged(),
              l
                ? u.editorUpload.uploadImagesAuto()
                : (yt(f),
                  (t = u),
                  (e = f),
                  (n = _t.setEditorTimeout(
                    t,
                    function () {
          ...
          u.$(d).on('load', r),
            m && u.$(d).attr({ width: m.w, height: m.h }),
            u.$(d).attr({ src: o.blobUri() }).removeAttr('data-mce-src');
        }),
        o
      );
    });
  ...
  function bt(r, o, t, i) {
    return function () {
      return ht(r).fold(
        function () {
          mt(r, 'Could not find selected image');
        },
        function (n) {
          return r
            ._scanForImages()
  ...
  function It(t, e, r) {
    return function () {
      return bt(t, e, function (t) {
        return (
          (n = r),
          (e = t).toCanvas().then(function (t) {
            return nt(t, e.getType(), n);
          })
        );
        var e, n;
      })();
  ...
  function Tt(s, l) {
    return function () {
      ...
      n.each(function (e) {
        dt(s, e.dom).each(function (t) {
          vt(s, e.dom).then(function (t) {
            var e = { blob: t, url: URL.createObjectURL(t) };
            s.windowManager.open({
              ...
              onSubmit: function (t) {
                var o = t.getData().imagetools.blob;
                n.each(function (r) {
                  i.each(function (t) {
                    var e, n, a, u, c;
                    (e = s),
  ...
  function At(e) {
    ...
    function t() {
      return ht(e).exists(function (t) {
        return dt(e, t.dom).isSome();
      });
    }
    function r(e) {
      function i(t) {
        return e.setDisabled(!t);
      }
      return (
        i(t()),
        (o = o.concat([i])),
    ...
    e.on('NodeChange', function () {
      ...
      e.ui.registry.addContextMenu('imagetools', {
        update: function (t) {
          return dt(e, t)
            .map(function (t) {
              return {
  ...
  var _t = tinymce.util.Tools.resolve('tinymce.util.Delay'),
    Rt = tinymce.util.Tools.resolve('tinymce.util.Promise'),
    xt = tinymce.util.Tools.resolve('tinymce.util.URI'),
    Ut = 0,
    jt = function (t, e) {
      var n = e.src;
      return (
        0 === n.indexOf('data:') ||
        0 === n.indexOf('blob:') ||
        new xt(n).host === t.documentBaseURI.host
      );
    },
    St = function (t, e) {
      return (
  ...
  o.add('imagetools', function (t) {
    ...
    l.each(
      {
        mceImageRotateLeft: Et(u, n, -90),
        mceImageRotateRight: Et(u, n, 90),
        mceImageFlipVertical: It(u, n, 'v'),
        mceImageFlipHorizontal: It(u, n, 'h'),
        mceEditImage: Tt(u, n),
      },
      function (t, e) {
        u.addCommand(e, t);
      ...
      At(t),
      (e = t).ui.registry.addContextToolbar('imagetools', {
        items: e.getParam(
          'imagetools_toolbar',
          'rotateleft rotateright flipv fliph editimage imageoptions',
        ),
        predicate: function (t) {
          return dt(e, t).isSome();
        },
        position: 'node',
        scope: 'node',
      }),
      ...
      (r = t).on('NodeChange', function (t) {
        ...
        e &&
          ...
          (yt(o), r.editorUpload.uploadImagesAuto(), i.set(null)),
          n.each(i.set);
      });
  });
})();
