...
!(function () {
  'use strict';
  function l(e, r) {
    var n = e.fire('insertCustomChar', { chr: r }).chr;
    ...
    a = function (e) {
      return (
        ...
        (null === r
          ? 'null'
          : 'object' == n &&
            (Array.prototype.isPrototypeOf(r) ||
              (r.constructor && 'Array' === r.constructor.name))
          ? 'array'
          : 'object' == n &&
            (String.prototype.isPrototypeOf(r) ||
              (r.constructor && 'String' === r.constructor.name))
          ? 'string'
          : n) === t
      );
      var r, n;
  ...
  function h(e) {
    var r = (function (e, r) {
      ...
      if (t) {
        ...
        return a.length
          ? ((a[0].characters = [].concat(a[0].characters).concat(s(t))), r)
          : r.concat({ name: O, characters: s(t) });
      }
      return r;
    })(e, [
      {
  ...
  function y() {
    ...
    for (var n = [], t = '', a = 0, i = e.length; a !== i; ++a) {
      ...
      16383 <=
        ...
        ((t += String.fromCharCode.apply(null, n)), (n.length = 0));
    }
      ...
      (function (e) {
        for (var r, n, t, a, i = 0, o = e.length; i < o; i++)
          (r = e[i]),
            ...
            (d(y(n).toLowerCase(), a) ||
              d(t.toLowerCase(), a) ||
              d(t.toLowerCase().replace(/\s+/g, ''), a)) &&
              c.push(r);
      })(e.characters),
      f(c, function (e) {
        return { text: e[1], value: y(e[0]), icon: y(e[0]) };
      })
    );
  }
  function w(n, a) {
    function r() {
      return [
        { label: 'Search', type: 'input', name: S },
    ...
    var e =
        1 === a.length
          ...
          : {
              type: 'tabpanel',
              tabs: f(a, function (e) {
                return { title: e.name, name: e.name, items: r() };
              }),
            },
      s = { pattern: '', results: v(a[0], '') };
    n.windowManager
      .open({
  ...
  n.add('charmap', function (e) {
    var r,
      ...
      c = o;
    return (
      (r = e).addCommand('mceShowCharmap', function () {
        w(r, c);
      }),
      ...
      (t = e),
      (a = o[0]),
      t.ui.registry.addAutocompleter('charmap', {
        ch: ':',
        columns: 'auto',
        minChars: 2,
        fetch: function (n, e) {
