...
!(function () {
  ...
  function K(t, n) {
    return (
      n ? n.innerText || n.textContent : t.getContent({ format: 'text' })
    ).replace(/\uFEFF/g, '');
  }
  function z(t) {
  ...
  function j(t) {
    ...
    return (
      0 ===
      M(t.selection.getRng(), function (t) {
  ...
  function V(l, c, f) {
    var t,
      ...
      g =
        ...
        0 < P(n).length ||
          !1 !== T(n) ||
          ((r = B(u.rel, '_blank' === u.target)), (u.rel = r || null)),
        it.from(u.target).isNone() && !1 === A(n) && (u.target = N(n)),
        (u.href =
          ((o = u.href),
          ('http' !== (i = C(n)) && 'https' !== i) || U(o)
            ? o
            : i + '://' + o)),
        u);
  ...
  function F(t) {
    ...
    t.hasPlugin('rtc', !0)
      ...
      : (l = t).undoManager.transact(function () {
          var t,
            n,
            e,
            r,
    ...
    At(t, n)
      .then(function (t) {
        var n,
          ...
          r = function (t) {
            ...
            var r = {
              ...
              o = {
                href: e.url.value,
                attach:
                  void 0 !== e.url.meta && e.url.meta.attach
                    ? e.url.meta.attach
                    : h,
              };
            wt(i, r).then(function (t) {
              q(i, o, t);
            }),
              t.close();
          },
          ...
          a = (n = u = t).anchor.text
            .map(function () {
              return { name: 'text', type: 'input', label: 'Text to display' };
            })
            .toArray(),
        ...
        return {
          ...
          body: {
            ...
            items: x([
              ...
              (function (t) {
                ...
                m.anchor.map(ft.createUi('anchor', 'Anchors')),
                m.rels.map(ft.createUi('rel', 'Rel')),
                m.targets.map(ft.createUi('target', 'Open link in...')),
                m.link.map(ft.createUi('link', 'Link list')),
                m.classes.map(ft.createUi('linkClass', 'Class')),
              ]),
            ]),
          },
          buttons: [
          ...
          onChange: function (n, t) {
            var e = t.name;
            g.onChange(n.getData, { name: e }).each(function (t) {
              n.setData(t);
            });
          },
          onSubmit: r,
  ...
  function tt(e) {
    return function (t) {
      function n() {
        return t.setActive(
          !e.mode.isReadOnly() && null !== I(e, e.selection.getNode()),
        );
      }
      return n(), Z(e, n);
    };
  ...
  function rt(t) {
    ...
    return 0 < n.length
      ? it.some([{ text: 'None', value: '' }].concat(n))
      : it.none();
  }
  var ot = function (e) {
      function t() {
    ...
    ct = function (t, i) {
      ...
      return (
        lt.each(t, function (t) {
          ...
          void 0 !== t.menu
            ? ((e = ct(t.menu, i)), u.push({ text: o, items: e }))
    ...
    yt = function (e, t) {
      return b(t, function (t) {
        return D((n = t), 'items') && void 0 !== n.items && null !== n.items
          ? yt(e, t.items)
          : w(t.value === e, t);
        var n;
      });
    ...
    xt = function (t, c) {
      function f(t, n) {
        ...
        return (
          ...
          (a = 0 < r.length),
          void 0 !== u
            ? yt(u, i).map(function (t) {
                return {
                  url: {
                    value: t.value,
                    meta: { text: a ? r : t.text, attach: h },
                  },
                  text: a ? r : t.text,
                };
              })
      ...
      var s = { text: t.text, title: t.title };
      return {
        onChange: function (t, n) {
          ...
          return 'url' === l
            ? ((r = t()),
              (o = r.url),
              (u = w(s.text.length <= 0, it.from(o.meta.text).getOr(o.value))),
              (i = r.url),
              (a = w(s.title.length <= 0, it.from(i.meta.title).getOr(''))),
              u.isSome() || a.isSome()
                ? it.some(
                    st(
                      st(
            ...
            : ((e = ['anchor', 'link']),
              -1 < ut.call(e, l)
                ? f(t(), n)
                : (('text' !== l && 'title' !== l) || (s[l] = t()[l]),
                  it.none()));
        },
      };
    },
    bt = tinymce.util.Tools.resolve('tinymce.util.Delay'),
    Ot = tinymce.util.Tools.resolve('tinymce.util.Promise'),
    wt = function (u, a) {
      return b(
        [
          W,
        ...
        function (i) {
          return new Ot(function (n) {
            ...
            bt.setEditorTimeout(e, function () {
    ...
    Ct = tinymce.util.Tools.resolve('tinymce.util.XHR'),
    Nt = [
        ...
        new Ot(function (n) {
          ...
          .then(function (t) {
            return t.bind(ft.sanitizeWith(n)).map(function (t) {
              return 0 < t.length ? [{ text: 'None', value: '' }].concat(t) : t;
            });
          })
          .then(function (t) {
            var n,
              ...
              s =
                ((e = g),
                (r = (n = m).dom),
                (o = j(n) ? it.some(K(n.selection, e)) : it.none()),
                (i = e ? it.some(r.getAttrib(e, 'href')) : it.none()),
                (u = e ? it.from(r.getAttrib(e, 'target')) : it.none()),
                (a = H(r, e, 'rel')),
                (l = H(r, e, 'class')),
                {
                  url: i,
            ...
            return {
              ...
              catalogs: {
                targets:
                  ((f = A(m)),
                  d(f)
                    ? ft.sanitize(f).orThunk(function () {
                        return it.some(Nt);
                      })
                    : !1 === f
                    ? it.none()
                ...
                classes:
                  0 < (c = m.getParam('link_class_list', [], 'array')).length
                    ? ft.sanitize(c)
                    : it.none(),
                anchor: rt(m),
                link: t,
              ...
              optNode: it.from(g),
              flags: { titleEnabled: m.getParam('link_title', !0, 'boolean') },
            };
          })
      );
      function n(t) {
    ...
    (n = t).ui.registry.addToggleButton('link', {
      ...
      u.on('keydown', function (t) {
        ...
        n &&
          ...
          !1 === t.ctrlKey &&
          !1 === t.metaKey &&
          (t.preventDefault(), $(u, n));
      }),
      (o = t).addCommand('mceLink', function () {
        o.getParam('link_quicklink', !1, 'boolean')
          ? o.fire('contexttoolbar-show', { toolbarKey: 'quicklink' })
          : Q(o)();
      }),
