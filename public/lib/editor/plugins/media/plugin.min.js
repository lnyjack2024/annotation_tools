...
!(function () {
  ...
  function g(e, t) {
    return H(e, t) ? B.from(e[t]) : B.none();
  }
  function v(e) {
  ...
  function y(i, e) {
    ...
    return (
      Q({
        ...
        start: function (e, t) {
          if (!c.get())
            if (H(t.map, 'data-ephox-embed-iri'))
              c.set(!0),
                (a = (o = (n = t).map.style) ? V.parseStyle(o) : {}),
                (s = {
                  type: 'ephox-embed-iri',
                  source: n.map['data-ephox-embed-iri'],
                  altsource: '',
                  poster: '',
                  width: g(a, 'max-width').map(w).getOr(''),
                  height: g(a, 'max-height').map(w).getOr(''),
                });
            else {
              if (
                (s.source || 'param' !== e || (s.source = t.map.movie),
                ('iframe' !== e &&
                  'object' !== e &&
                  'embed' !== e &&
                  'video' !== e &&
                  'audio' !== e) ||
                  (s.type || (s.type = e), (s = J.extend(t.map, s))),
                'script' === e)
              ) {
                var r = b(i, t.map.src);
                if (!r) return;
              ...
              'source' === e &&
                (s.source
                  ? s.altsource || (s.altsource = t.map.src)
                  : (s.source = t.map.src)),
  ...
  function O(a, e) {
    !(function (e) {
      for (var t = G(e), r = 0, n = t.length; r < n; r++) {
        var o = t[r];
        !(function (e, t) {
          var r = '' + e;
          if (a.map[t])
          ...
          start: function (e, t, r) {
            if (!m.get())
              if (H(t.map, 'data-ephox-embed-iri'))
                m.set(!0),
                  (n = c),
                  ((i = (a = (o = t).map.style) ? Z.parseStyle(a) : {})[
                    'max-width'
                  ] = j(n.width)),
                  (i['max-height'] = j(n.height)),
                  O(o, { style: Z.serializeStyle(i) });
              else {
                switch (e) {
                  case 'video':
                  case 'object':
                  ...
                  case 'iframe':
                    void 0 !== c.height &&
                      void 0 !== c.width &&
                      O(t, { width: c.width, height: c.height });
                }
                if (s)
                  switch (e) {
                    case 'video':
                      O(t, { poster: c.poster, src: '' }),
                        c.altsource && O(t, { src: '' });
                      break;
                    case 'iframe':
                      O(t, { src: c.source });
                    ...
                    case 'source':
                      if (
                        d < 2 &&
                        (O(t, { src: c[ee[d]], type: c[ee[d] + 'mime'] }),
                        !c[ee[d]])
                      )
                        return;
                      d++;
              ...
              if ('video' === e && s)
                for (var t, r = 0; r < 2; r++)
                  c[ee[r]] &&
                    (((t = []).map = {}),
                    d <= r &&
                      (O(t, { src: c[ee[r]], type: c[ee[r] + 'mime'] }),
                      l.start('source', t, !0)));
              var n;
              c.poster &&
                'object' === e &&
                ...
                !u &&
                (((n = []).map = {}),
                O(n, { src: c.poster, width: c.width, height: c.height }),
                l.start('img', n, !0));
            }
            l.end(e);
          },
  ...
  function k(r, e) {
    var n = J.extend({}, e);
    if (!n.source && (J.extend(n, y(v(r), n.embed)), !n.source)) return '';
    ...
    var t,
      ...
      a =
        ((t = n.source),
        0 <
        (o = te.filter(function (e) {
          return e.regex.test(t);
        })).length
          ? J.extend({}, o[0], { url: _(o[0], t) })
          : null);
    if (
      (a &&
        ((n.source = a.url),
        ...
        (n.width = n.width || String(a.w)),
        (n.height = n.height || String(a.h))),
      n.embed)
    )
    ...
    return (
      ...
      'iframe' === n.type
        ? ((l = n.allowfullscreen ? ' allowFullscreen="1"' : ''),
          '<iframe src="' +
            n.source +
            '" width="' +
            n.width +
            ...
            : '<audio controls="controls" src="' +
              ...
              (s.altsource
                ? '\n<source src="' +
                  s.altsource +
                  '"' +
                  (s.altsourcemime ? ' type="' + s.altsourcemime + '"' : '') +
                  ' />\n'
                : '') +
              '</audio>')
        : 'script' === n.type
        ...
        : ((c = n),
          d
            ...
            : '<video width="' +
              ...
              c.source +
              '"' +
              (c.sourcemime ? ' type="' + c.sourcemime + '"' : '') +
              ' />\n' +
              (c.altsource
                ? '<source src="' +
                  c.altsource +
    ...
    return c
      ? ((o = t),
        ...
        new re(function (t, e) {
          function r(e) {
            return (
              e.html && (ne[o.source] = e),
              t({ url: o.source, html: e.html || a(o) })
            );
          }
          ne[o.source] ? r(ne[o.source]) : i({ url: o.source }, r, e);
        }))
      : ((n = A(e)), re.resolve({ html: n((r = t)), url: r.source }));
  }
  function C(e, t) {
    var r,
      n,
        ...
        function (e) {
          ...
          function n(e) {
            return g(e, 'value').bind(function (e) {
              return 0 < e.length ? B.some(e) : B.none();
            });
          }
          var o = {};
          return (
    ...
    return p(
      p(p(p(p({}, s('source')), s('altsource')), s('poster')), s('embed')),
      ((r = o),
      (n = {}),
  ...
  function D(e) {
    var n = p(p({}, e), {
      source: { value: g(e, 'source').getOr('') },
      altsource: { value: g(e, 'altsource').getOr('') },
      poster: { value: g(e, 'poster').getOr('') },
    });
    return (
      h(['width', 'height'], function (r) {
  ...
  function F(e, t) {
    ...
    e.insertContent(t),
      (function (e, t) {
        for (
          var r = e.dom.select('*[data-mce-object]'), n = 0;
          n < t.length;
          n++
        )
  ...
  function z(m) {
    var e,
      ...
      o =
        ((n =
          (t = r = (e = m).selection.getNode()).hasAttribute(
            'data-mce-object',
          ) || t.hasAttribute('data-ephox-embed-iri')
    ...
    0 < c.length && s.push({ title: 'Advanced', name: 'advanced', items: c });
    var h = m.windowManager.open({
      title: 'Insert/Edit Media',
      size: 'normal',
      body: { type: 'tabpanel', tabs: s },
      buttons: [
      ...
      onSubmit: function (e) {
        ...
        (t = d.get()),
          (n = m),
          ((r = a).embed = S(r.embed, r)),
          r.embed && (t.source === r.source || ((o = r.source), H(ne, o)))
            ? F(n, r.embed)
            : T(n, r)
                .then(function (e) {
                  F(n, e.html);
      ...
      onChange: function (e, t) {
        switch (t.name) {
          case 'source':
            (u = d.get()),
              (l = C(e.getData(), 'source')),
              u.source !== l.source &&
                (M(h, m)({ url: l.source, html: '' }),
                T(m, l).then(M(h, m)).catch(P(m)));
            break;
          case 'embed':
            (c = C((i = e).getData())), (s = $(m, c.embed)), i.setData(D(s));
            break;
          case 'dimensions':
          case 'altsource':
          case 'poster':
            (n = t.name),
              (o = C((r = e).getData(), n)),
              (a = k(m, o)),
              r.setData(D(p(p({}, o), { embed: a })));
        }
        var r, n, o, a, i, c, s, u, l;
        d.set(C(e.getData()));
      },
      initialData: a,
    });
          ...
          start: function (e, t, r) {
            if (((i = !0), 'script' !== e && 'noscript' !== e && 'svg' !== e)) {
              for (var n = t.length - 1; 0 <= n; n--) {
                var o = t[n].name;
                0 === o.indexOf('on') && (delete t.map[o], t.splice(n, 1)),
                  'style' === o &&
  ...
  function E(e, t, r, n) {
    void 0 === n && (n = null);
    var o = e.attr(r);
    return s(o) ? o : H(t, r) ? null : n;
  }
  function N(e, t, r) {
    var n = 'img' === t.name || 'video' === e.name,
      o = 'audio' === e.name ? '30' : '150',
      a = n ? o : null;
    t.attr({
      width: E(e, r, 'width', n ? '300' : null),
      height: E(e, r, 'height', a),
    });
  }
  function R(o, t) {
    var e = t.name,
    ...
    r.attr({
      ...
      ce(o, t, r);
    var n,
      a = o.dom.parseStyle(t.attr('style')),
      i = new oe(e, 1);
    N(t, i, a),
      i.attr({
        src: t.attr('src'),
      ...
      'iframe' === e
        ...
        : (h(
          ...
          s((n = r.attr('data-mce-html'))) &&
            (function (e, t, r) {
              for (
                var n = ie(
                  { forced_root_block: !1, validate: !1 },
                  o.schema,
                ).parse(r, { context: e });
                n.firstChild;

              )
                t.append(n.firstChild);
            })(e, i, n));
    var c = new oe('span', 1);
  ...
  var I = function (r) {
    ...
    K = tinymce.util.Tools.resolve('tinymce.dom.DOMUtils'),
    Q = tinymce.util.Tools.resolve('tinymce.html.SaxParser'),
    V = K.DOM,
    X = tinymce.util.Tools.resolve('tinymce.html.Schema'),
    Y = tinymce.util.Tools.resolve('tinymce.html.Writer'),
    Z = K.DOM,
    ee = ['source', 'altsource'],
    te = [
      {
    ...
    ie = tinymce.util.Tools.resolve('tinymce.html.DomParser'),
    ce = function (e, t, r) {
      for (var n = t.attributes, o = n.length; o--; ) {
        ...
        'width' !== a &&
          'height' !== a &&
          'style' !== a &&
          (('data' !== a && 'src' !== a) || (i = e.convertURL(i, a)),
          r.attr('data-mce-p-' + a, i));
      }
  ...
  n.add('media', function (e) {
    ...
    return (
      ...
      (d = e).on('preInit', function () {
        ...
        J.each('video audio iframe object'.split(' '), function (e) {
          t[e] = new RegExp('</' + e + '[^>]*>', 'gi');
        });
        var u,
        ...
        J.each(
          ...
          d.parser.addNodeFilter(
            ...
            ((u = d),
            function (e) {
              for (var t, r, n, o, a, i, c, s = e.length; s--; )
                (t = e[s]).parent &&
                  (t.parent.attr('data-mce-object') ||
                    ('script' === t.name && !(r = b(v(u), t.attr('src')))) ||
                    (r &&
          ...
          d.serializer.addAttributeFilter('data-mce-object', function (e, t) {
            for (var r, n, o, a, i, c, s, u, l = e.length; l--; )
              if ((r = e[l]).parent) {
                for (
                  s = r.attr(t),
                    n = new oe(s, 1),
                    'audio' !== s &&
                      'script' !== s &&
                      ((u = r.attr('class')) &&
                      -1 !== u.indexOf('mce-preview-object')
                        ? n.attr({
                    ...
                    o = (a = r.attributes).length;
                  o--;

                ) {
                  var m = a[o].name;
                  0 === m.indexOf('data-mce-p-') &&
                    n.attr(m.substr(11), a[o].value);
                }
                'script' === s && n.attr('type', 'text/javascript'),
                  (i = r.attr('data-mce-html')) &&
                    (((c = new oe('#text', 3)).raw = !0),
      ...
      (a = e).on('click keyup touchend', function () {
        var e = a.selection.getNode();
        e &&
          a.dom.hasClass(e, 'mce-preview-object') &&
          a.dom.getAttrib(e, 'data-mce-selected') &&
          e.setAttribute('data-mce-selected', '2');
      }),
      a.on('ObjectSelected', function (e) {
        'script' === e.target.getAttribute('data-mce-object') &&
          e.preventDefault();
      }),
      a.on('ObjectResized', function (e) {
        var t,
          r = e.target;
        !r.getAttribute('data-mce-object') ||
          ((t = r.getAttribute('data-mce-html')) &&
            ...
            r.setAttribute(
              'data-mce-html',
              escape(
                S(t, { width: String(e.width), height: String(e.height) }),
              ),
            )));
      }),
      (i = e),
