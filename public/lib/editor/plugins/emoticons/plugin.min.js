...
!(function () {
      ...
      _.load(t, r).then(
        function (t) {
          var n,
            ...
            s,
            r =
              ((n = i.getParam('emoticons_append', {}, 'object')),
              (e = function (t) {
                return C({ keywords: [], category: 'user' }, t);
              }),
              A(n, function (t, n) {
                return { k: n, v: e(t) };
              }));
            ...
            d(o, function (t, n) {
              var e,
                ...
                c = {
                  ...
                  keywords: t.keywords,
                  char:
                    (i = (r = t).char).length >= (a = '<img').length &&
                    i.substr(0, 0 + a.length) === a
                      ? r.char.replace(/src="([^"]+)"/, function (t, n) {
                          return 'src="' + f + n + '"';
                        })
                      : r.char,
          ...
          : new x(function (t, n) {
              var e = 15,
                o = T.setInterval(function () {
                  u()
                    ? (T.clearInterval(o), t(!0))
                    : --e < 0 &&
                      (console.log('Could not load emojis from url: ' + r),
                      T.clearInterval(o),
                      n(!1));
                }, 100);
            });
  ...
  function y(t, n, e) {
    for (
      ...
      ((0 !== n.length &&
        ((o = t[u]),
        (r = a),
        !f(o.title.toLowerCase(), r) &&
          !(function (t) {
            for (var n = 0, e = t.length; n < e; n++)
              if (f(t[n].toLowerCase(), r)) return 1;
          })(o.keywords))) ||
        (i.push({ value: t[u].char, text: t[u].title, icon: t[u].char }),
        !c(i.length)));
      u++
    );
    return i;
  ...
  function p(o, i) {
    var e,
      r,
      t = { pattern: '', results: y(i.listAll(), '', O.some(300)) },
      a = g(P),
      c =
        ((e = function (t) {
          var n,
    ...
    function n() {
      return {
        ...
        onAction: function (t, n) {
          var e;
          'results' === n.name &&
            ((e = n.value), o.insertContent(e), t.close());
        },
        buttons: [{ type: 'cancel', text: 'Close', primary: !0 }],
      };
    }
    var l = { label: 'Search', type: 'input', name: S },
      s = { type: 'collection', name: 'results' },
      ...
      t.parser.addAttributeFilter('data-emoticon', function (t) {
        !(function (t) {
          for (var n, e = 0, o = t.length; e < o; e++)
            (n = t[e]).attr('data-mce-resize', 'false'),
              n.attr('data-mce-placeholder', '1');
        })(t);
      });
    });
  }
  ...
  e.add('emoticons', function (t, n) {
    var e,
      ...
      s =
        ((o = n),
        (r = (e = t).getParam('emoticons_database', 'emojis', 'string')),
        e.getParam(
    ...
    (a = m),
      (i = t).addCommand('mceEmoticons', function () {
        return p(i, a);
      }),
      ...
      (l = m),
      (u = t).ui.registry.addAutocompleter('emoticons', {
        ch: ':',
        columns: 'auto',
        minChars: 2,
        fetch: function (t, n) {
