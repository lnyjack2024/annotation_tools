...
!(function () {
      ...
      c =
        (function (t) {
          for (var e = 9, n = 0; n < t.length; n++)
            if (1 === (e = t[n].level < e ? t[n].level : e)) return e;
          return e;
        })(i) - 1;
    if (!i.length) return '';
    r +=
      ((e = s(t)),
      (n = v.translate('Table of Contents')),
      (o = '</' + e + '>'),
      '<' + e + ' contenteditable="true">' + m.DOM.encode(n) + o);
    for (var l = 0; l < i.length; l++) {
      var a = i[l];
      a.element.id = a.id;
      var u = i[l + 1] && i[l + 1].level;
      if (c === a.level) r += '<li>';
      else for (var d = c; d < a.level; d++) r += '<ul><li>';
      if (
        ((r += '<a href="#' + a.id + '">' + a.title + '</a>'),
        u !== a.level && u)
      )
        for (d = a.level; u < d; d--) r += '</li></ul><li>';
      else (r += '</li>'), u || (r += '</ul>');
      c = a.level;
    }
    return r;
  ...
  var t,
    ...
    l =
      ...
      function () {
        return (
          'mcetoc_' + new Date().getTime().toString(32) + (t++).toString(32)
        );
      }),
    g = function (n) {
      var t,
  ...
  e.add('toc', function (t) {
    var c, e, n, o, r, i;
    function l() {
      return r.execCommand('mceInsertToc');
    }
    (c = t).addCommand('mceInsertToc', function () {
      ...
      (o = a((t = c))),
        ...
        (i = t),
        !r.length ||
        0 < i.dom.getParents(r[0], '.mce-offscreen-selection').length
          ? t.insertContent(
              ((n = d((e = t))),
              '<div class="' +
                e.dom.encode(a(e)) +
      ...
      (r = t).ui.registry.addButton('toc', {
        icon: 'toc',
        tooltip: 'Table of contents',
        onAction: l,
        onSetup: u(r),
      }),
      r.ui.registry.addButton('tocupdate', {
        icon: 'reload',
        tooltip: 'Update',
        onAction: function () {
          return r.execCommand('mceUpdateToc');
        },
      }),
      r.ui.registry.addMenuItem('toc', {
        icon: 'toc',
        text: 'Table of contents',
        onAction: l,
        onSetup: u(r),
      }),
      r.ui.registry.addContextToolbar('toc', {
        items: 'tocupdate',
        predicate:
          ((i = r),
          function (t) {
            return t && i.dom.is(t, '.' + a(i)) && i.getBody().contains(t);
          }),
        scope: 'node',
        position: 'node',
      }),
