...
!(function () {
  ...
  var X,
    ...
    ne = 'Firefox',
    re = function () {
      return V({ current: void 0, version: G.unknown() });
    },
    oe = V,
    ie =
      (S('Edge'),
    ...
    ce = 'ChromeOS',
    fe = function () {
      return W({ current: void 0, version: G.unknown() });
    },
    de = W,
    le =
      (S(ie),
      ...
      (Y = !(q = function () {
        return (
          ...
          (t = E.from(navigator.userAgentData)),
          (n = $),
          (g = te.browsers()),
          (h = te.oses()),
          (v = t
            ...
            .fold(fe, de)),
          {
            ...
            deviceType:
              ...
              (a = e),
              (s = n),
              (u = (o = y).isiOS() && !0 === /ipad/i.test(a)),
              (c = o.isiOS() && !u),
              (d = (f = o.isiOS() || o.isAndroid()) || s('(pointer:coarse)')),
              (l = u || (!c && f && s('(min-device-width:768px)'))),
              (m = c || (f && !l)),
        ...
        var e, t, n, r, o, i, a, s, u, c, f, d, l, m, p, g, h, v, y;
      })),
      function () {
    ...
    he = tinymce.util.Tools.resolve('tinymce.dom.TreeWalker'),
  ...
  function He(e, t) {
    var n,
      ...
      u = a.createFragment(),
      c =
        !1 === (n = e.getParam('forced_root_block', 'p'))
          ? ''
          : !0 === n
          ? 'p'
          : n;
    if (
      (c &&
        ((o = a.create(c)).tagName === c.toUpperCase() &&
          a.setAttribs(o, e.getParam('forced_root_block_attrs', {})),
        _e(t.firstChild, s) || u.appendChild(o)),
      t)
    )
      for (; (r = t.firstChild); ) {
        var f = r.nodeName;
        i ||
          ...
          (i = !0),
          _e(r, s)
            ? (u.appendChild(r), (o = null))
            : c
            ? (o || ((o = a.create(c)), u.appendChild(o)), o.appendChild(r))
            : u.appendChild(r);
      }
    return (
      c
        ? i || o.appendChild(a.create('br', { 'data-mce-bogus': '1' }))
        : u.appendChild(a.create('br')),
      u
    );
  }
  function je(e) {
                ...
                : Qt(n) &&
                  Oe(n).each(function (e) {
                    return (function (e, t, n) {
                      ...
                      for (
                        var a, s = i.extractContents(), u = s.firstChild;
                        u;
                        u = u.firstChild
                      )
                      ...
                      e.dom.isEmpty(s) || Vt.insertAfter(s, t),
                        Vt.insertAfter(o, t),
                        $e(e.dom, n.parentNode) &&
                          ((a = n.parentNode),
                          Mt.each(r, function (e) {
                            a.parentNode.insertBefore(e, n.parentNode);
                          }),
                          Vt.remove(a)),
                        Vt.remove(n),
                        $e(e.dom, t) && Vt.remove(t);
                    })(t, e.dom, n.dom);
                  }),
              0
            );
  ...
  function Ve(e, t) {
    if (Me(e)) return { container: e, offset: t };
  ...
  function Ye(e, t, n) {
    return e.isSome() && t.isSome()
      ? E.some(n(e.getOrDie(), t.getOrDie()))
      : E.none();
  }
  function Ze(e, t, n) {
    return e.fire('ListMutation', { action: t, element: n });
  }
  function Ge(e, t) {
    we(e.item, t.list);
  }
  function Je(e, t) {
    for (var n = 0; n < e.length - 1; n++)
      (function (e, t, n) {
        ...
        void 0 !== e.style &&
          f(e.style.getPropertyValue) &&
          e.style.setProperty(t, n);
      })(e[n].item.dom, 'list-style-type', 'none');
    w(e).each(function (e) {
      be(e.list, t.listAttributes),
        be(e.item, t.itemAttributes),
        ke(e.item, t.content);
    });
  }
  function et(u, e, c) {
      ...
      w(t).each(function (e) {
        var t,
          ...
          s =
            ((t = c.itemAttributes),
            (n = c.content),
            be((r = me.fromTag('li', u)), t),
            ke(r, n),
            r);
        we((o = e).list, s),
          (o.item = s),
          (a = c),
          Se((i = e).list) !== a.listType && (i.list = Pe(i.list, a.listType)),
          be(i.list, a.listAttributes);
      }),
      t
    );
  }
      ...
      o = (function (e, t, n) {
        for (var r, o, i, a = [], s = 0; s < n; s++)
          a.push(
            ((o = t.listType),
            we(
              (i = { list: me.fromTag(o, (r = e)), item: me.fromTag('li', r) })
                .list,
              i.item,
            ),
            i),
        ...
        (i = (r = s)[(o = e)].depth),
          v(D(r.slice(0, o)), t, n)
            ...
            .fold(
              ...
              function (e) {
                var t = e;
                (a.listType = t.listType),
                  (a.listAttributes = B({}, t.listAttributes));
              },
            );
      }),
      s
              ...
              Oe(r)
                ...
                .map(function (e) {
                  return {
                    ...
                    content:
                      ((n = Le((t = r))),
                      C(xe(t).exists(nt) ? n.slice(0, -1) : n, Ie)),
                    itemAttributes: Ne(r),
                    listAttributes: Ne(e),
                    listType: Se(e),
                  };
  ...
  function dt(e, t) {
    var n,
      ...
      p,
      g = C(
        ((i = qe((o = r = e), o.selection.getStart())),
        (a = L(o.selection.getSelectedBlocks(), _t)),
        (s = i.toArray().concat(a)),
        zt(r, s)),
        me.fromDom,
      ),
      h = C(L(Xe(e), Ht), me.fromDom),
      v = !1;
    return (
      (g.length || h.length) &&
        ...
        b(
          ((f = g),
          (p = C(Xe((u = e)), me.fromDom)),
          (d = Ye(N(p, y(rt)), N(D(p), y(rt)), function (e, t) {
          ...
          C(f, function (e) {
            return { sourceList: e, entries: Yt(0, d, m, e) };
          })),
          function (e) {
            ft(e.entries, c);
            var t,
        ...
        e.selection.setRng(We(e.selection.getRng())),
        e.nodeChanged(),
        (v = !0)),
      v
    );
  ...
  function gt(o) {
    function e(e) {
      ...
      1 === n.nodeType &&
        ((t = Gt.create('span', { 'data-mce-type': 'bookmark' })),
        n.hasChildNodes()
          ? ((r = Math.min(r, n.childNodes.length - 1)),
            e
              ? n.insertBefore(t, n.childNodes[r])
              : Gt.insertAfter(t, n.childNodes[r]))
          : n.appendChild(t),
        (n = t),
        (r = 0)),
        (i[e ? 'startContainer' : 'endContainer'] = n),
  ...
  function ht(o) {
    ...
    var t = Gt.createRng();
    return (
      t.setStart(o.startContainer, o.startOffset),
      o.endContainer && t.setEnd(o.endContainer, o.endOffset),
      We(t)
    );
  }
  function vt(e) {
  ...
  function St(e, n, r) {
    ...
    return (
      t({ parents: e.dom.getParents(e.selection.getNode()) }),
      e.on('NodeChange', t),
      function () {
  ...
  function bt(e, t, n) {
    ...
    e.setStyle(t, 'list-style-type', a),
      (r = e),
      Ct((o = t), (i = n)['list-attributes']),
      Mt.each(r.select('li', o), function (e) {
  ...
  function Nt(e, t, n, r) {
    ...
    for (
      1 === o.nodeType &&
        ...
        !n && Kt(o.nextSibling) && (o = o.nextSibling);
      o.parentNode !== r;
  ...
  function Ot(u, c, f) {
    var e,
      ...
      l = u.dom;
    'false' !== l.getContentEditable(u.selection.getNode()) &&
      ('DL' === (c = c.toUpperCase()) && (d = 'DT'),
      (e = gt(n)),
      (t = (function (n, e, r) {
        for (
          var o,
        ...
        return (
          Mt.each(u, function (e) {
            if (Ue(n, e)) return i.push(e), void (o = null);
            if (a.isBlock(e) || Kt(e))
              return Kt(e) && a.remove(e), void (o = null);
            var t = e.nextSibling;
            Zt.isBookmarkNode(e) &&
            (Ut(t) || Ue(n, t) || (!t && e.parentNode === r))
              ? (o = null)
              : (o ||
                  ((o = a.create('p')),
      ...
      Mt.each(t, function (e) {
        ...
        Ft(s) ||
          ...
          a.nodeName === c &&
          ((o = f),
          l.getStyle(a, 'list-style-type') ===
            (i = null === (i = o ? o['list-style-type'] : '') ? '' : i))
            ? ((t = a), (e = l.rename(e, d)), a.appendChild(e))
            : ((t = l.create(c)),
  ...
  function Lt(e, t, n) {
    return (
      ...
      (i = t) &&
        a &&
        Ut(i) &&
        i.nodeName === a.nodeName &&
        ((o = n),
        (r = e).getStyle(t, 'list-style-type', !0) ===
          r.getStyle(o, 'list-style-type', !0)) &&
  ...
  function Tt(e, t, n) {
    var r,
      ...
      b =
        ((f = Qe((c = e))),
        (d = c.selection.getSelectedBlocks()),
        f && 1 === d.length && d[0] === f
          ? L(f.querySelectorAll('ol,ul,dl'), Ut)
          : L(d, function (e) {
              return Ut(e) && f !== e;
            })),
      N = O(n) ? n : {};
    0 < b.length
      ? ((l = e),
        ...
        (g = t),
        (h = N),
        (S = Ut((m = C))) && m.nodeName === g && !en(h)
          ? pt(l)
          : (Ot(l, g, h),
            (v = gt(l.selection.getRng())),
            (y = S
              ? (function (e, t) {
            ...
            Mt.each(y, function (e) {
              var t,
                ...
                i = h;
              (t = e).nodeName !== o
                ? ((n = r.dom.rename(t, o)), bt(r.dom, n, i), Ze(r, vt(o), n))
                : (bt(r.dom, t, i), Ze(r, vt(o), t));
            }),
            l.selection.setRng(ht(v))))
      : ((i = t),
        (a = N),
        (o = C) !== (r = e).getBody() &&
          (o
            ? o.nodeName !== i || en(a) || yt(o)
              ? ((s = gt(r.selection.getRng())),
                bt(r.dom, o, a),
                (u = r.dom.rename(o, i)),
                Jt(r.dom, u),
                r.selection.setRng(ht(s)),
                Ot(r, i, a),
                Ze(r, vt(i), u))
              : pt(r)
            : (Ot(r, i, a), Ze(r, vt(i), o))));
  }
  function Dt(e, t, n, r) {
    ...
    for (
      ...
      ((s = e.dom),
      Kt((u = o)) &&
        s.isBlock(u.nextSibling) &&
        !Kt(u.previousSibling) &&
        c.next());
      (o = c[n ? 'next' : 'prev2']());
  ...
  function At(t, e, n) {
    ...
    Fe(t, e) &&
      Fe(t, n) &&
      (Ut(n.lastChild) && (r = n.lastChild),
      a === n.lastChild && Kt(a.previousSibling) && t.remove(a.previousSibling),
      (o = n.lastChild) && Kt(o) && e.hasChildNodes() && t.remove(o),
      $e(t, n, !0) && t.$(n).empty(),
      (function (e, t, n) {
        var r,
          o,
        ...
        if ((xt((o = e), (i = t)) && o.remove(i.firstChild, !0), !$e(e, t, !0)))
          for (; (r = t.firstChild); ) a.appendChild(r);
      })(t, e, n),
      r && n.appendChild(r),
      (i = H(me.fromDom(n), me.fromDom(e)) ? t.getParents(e, Ut, n) : []),
      t.remove(e),
      b(i, function (e) {
  ...
  function wt(c, f) {
    ...
    if (d) {
              ...
              ? ((t = l),
                ...
                (u = (e = c).dom).isEmpty(r)
                  ? ((a = n),
                    (i = e).dom.$((s = r)).empty(),
                    At(i.dom, a, s),
                    i.selection.setCursorLocation(s, 0))
                  : ((o = gt(t)), At(u, n, r), e.selection.setRng(ht(o))))
              : d.parentNode.firstChild === d
              ? mt(c)
              : (function (e, t, n) {
                  var r = gt(l);
                  At(e.dom, t, n);
      ...
      if (!m && !f && 0 === l.startOffset && 0 === l.endOffset)
        return (
          c.undoManager.transact(function () {
            pt(c);
          }),
                ...
                return (
                  r.undoManager.transact(function () {
                    ...
                    e.remove(t),
                      ...
                      Jt(i, u.parentNode),
                      r.selection.select(u, !0),
                      r.selection.collapse(o);
                  }),
                  1
                );
            }
          })(i, a)
      : ((r = (n = e).selection.getStart()),
        (o = qt(n, r)),
        (n.dom.getParent(r, 'LI,DT,DD', o) || 0 < Xe(n).length) &&
          (n.undoManager.transact(function () {
            var i, e, t;
            n.execCommand('Delete'),
              (i = n.dom),
              (e = n.getBody()),
              (t = Mt.grep(i.select('ol,ul', e))),
              Mt.each(t, function (e) {
                var t,
                  n,
                  r,
                  o = i;
                'LI' === (r = (t = e).parentNode).nodeName &&
                  r.firstChild === t &&
                  ((n = r.previousSibling) && 'LI' === n.nodeName
                    ? (n.appendChild(t), $e(o, r) && tn.remove(r))
                    : tn.setStyle(r, 'listStyleType', 'none')),
                  Ut(r) &&
                    (n = r.previousSibling) &&
                    'LI' === n.nodeName &&
                    n.appendChild(t);
          ...
          t.windowManager.open({
            ...
            initialData: {
              start:
                ...
                ze(e.listStyleType, 'upper-alpha')
                  ? nn(n)
                  : ze(e.listStyleType, 'lower-alpha')
                  ? nn(n).toLowerCase()
                  : e.start),
            },
            buttons: [
            ...
            onSubmit: function (e) {
              !(function (e) {
                switch (
                  ...
                  case 2:
                    return E.some({ listStyleType: E.none(), start: e });
                  case 0:
                    return E.some({
                  ...
                  case 3:
                    return E.some({ listStyleType: E.none(), start: '' });
                  case 4:
                    return E.none();
                }
                var t;
  ...
  i.add('lists', function (e) {
    ...
    return (
      !1 === e.hasPlugin('rtc', !0)
        ? ((a = e).getParam('lists_indent_on_tab', !0) &&
            (s = a).on('keydown', function (e) {
              e.keyCode !== ve.TAB ||
                ve.metaKeyPressed(e) ||
          ...
          (u = a).on('keydown', function (e) {
            e.keyCode === ve.BACKSPACE
              ? kt(u, !1) && e.preventDefault()
              : e.keyCode === ve.DELETE && kt(u, !0) && e.preventDefault();
          }),
          ...
          Pt(i),
          i.addCommand('mceListUpdate', function (e, t) {
            var n, r, o;
            O(t) &&
              ((r = t),
              (o = Qe((n = i))),
              n.undoManager.transact(function () {
                O(r.styles) && n.dom.setStyles(o, r.styles),
                  O(r.attrs) &&
                    j(r.attrs, function (e, t) {
                      return n.dom.setAttrib(o, t, e);
                    });
              }));
          }),
          i.addQueryStateHandler('InsertUnorderedList', It(i, 'UL')),
          i.addQueryStateHandler('InsertOrderedList', It(i, 'OL')),
          i.addQueryStateHandler('InsertDefinitionList', It(i, 'DL')))
        : Pt(e),
      (o = e).hasPlugin('advlist') ||
        (o.ui.registry.addToggleButton('numlist', {
          icon: 'ordered-list',
          active: !1,
      ...
      (n = e).ui.registry.addMenuItem('listprops', t),
      n.ui.registry.addContextMenu('lists', {
        update: function (e) {
          var t = Qe(n, e);
