      ...
      if (C(u))
        (t = M.fromDom(u)),
          ...
          T(t)
            ...
            : ((r = e),
              (i = w((o = t), 'class').concat([r])),
              y(o, 'class', i.join(' ')));
      else {
        for (
          var c,
            a = f.dom.encode(p(n)).replace(F, A),
            s = f.dom.create('div', null, a);
          (c = s.lastChild);
  ...
  function D(r, n) {
    m(r.dom.select(I, n), function (n) {
      ...
      C(n)
        ? ((t = M.fromDom(n)),
          (e = U),
          T(t) ? t.dom.classList.remove(e) : k(t, e),
          0 === (T((o = t)) ? o.dom.classList : w(o, 'class')).length &&
            b(o, 'class'))
        : r.dom.remove(n, !0);
    });
  }
