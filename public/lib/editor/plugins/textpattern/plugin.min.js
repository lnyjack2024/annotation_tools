...
!(function () {
  ...
  function a(t, n, r) {
    if (r || 2 === arguments.length)
      for (var e, o = 0, a = n.length; o < a; o++)
        (!e && o in n) ||
          ((e = e || Array.prototype.slice.call(n, 0, o))[o] = n[o]);
  ...
  function S(o) {
    function a(t) {
      return ut.error({ message: t, pattern: o });
    }
    function t(t, n, r) {
      if (void 0 === o.format)
        return void 0 !== o.cmd
          ? f(o.cmd)
            ? ut.value(r(o.cmd, o.value))
            : a(t + ' pattern has non-string `cmd` parameter')
          : a(t + ' pattern is missing both `format` and `cmd` parameters');
      var e = void 0;
      if (s(o.format)) {
        if (!k(o.format, f))
          return a(t + ' pattern has non-string items in the `format` array');
        e = o.format;
      } else {
        if (!f(o.format))
    ...
    return (
      ...
      t(
        ...
        function (t, n) {
          return { type: 'inline-command', start: r, end: e, cmd: t, value: n };
        },
      )
    );
  }
  ...
  function U(t, n) {
    ...
    return (
      s(e) &&
      (0 < (r = e).length ? w.some(r[0]) : w.none()).exists(function (t) {
  ...
  function G(t, n, r, e, o) {
    return { start: F(t, n, r), end: F(t, e, o) };
  }
  function H(t, n) {
    var r = n.slice(),
      e = r.pop(),
    ...
    return (
      ...
      i.bind(function (t) {
        return j(t) && (e < 0 || e > t.data.length)
          ? w.none()
          : w.some({ node: t, offset: e });
      })
    );
  }
  function J(n, r) {
      ...
      .bind(function (n) {
        ...
        return (function (t, n, r) {
          ...
          return dt.trim(e).length === t.start.length
            ? []
            : [{ pattern: t, range: G(i.getRoot(), n, 0, n, 0) }];
        });
      })
      .getOr([]);
  }
        ...
        function (t) {
          ...
          L(t.pattern)
            ...
            : ((u = p),
              ...
              _(d, Q(d, c), l),
              _(d, m, l),
              $(u, f, Q(d, { prefix: c.prefix, start: c.end, end: s.start }))),
            Z(h, t.endMarker, n),
            Z(h, t.startMarker, n);
        },
      ),
                      ...
                      0 !== (t = u).length &&
                        ...
                        v(t, function (t) {
                          return (
                            (e = (n = i).dom),
                            (o = (r = t).pattern),
                            (a = J(e.getRoot(), r.range).getOrDie(
                              'Unable to resolve path range',
                            )),
                            V(n, a).each(function (t) {
                              'block-format' === o.type
                                ? U(o.format, n.formatter) &&
                    ...
                    o.execCommand('mceInsertNewLine'),
                      e.each(function (t) {
                        ...
                        '\ufeff' === n.data.charAt(t.offset - 1) &&
                          ...
                          pt(o.dom, n.parentNode, function (t) {
      ...
      u.push(o),
        (r[o] = function () {
          ...
          return {
            ...
            log: function (t) {
              console.log(t, { constructors: u, constructor: o, params: r });
            },
          };
        });
    });
  ...
  var at = function (r) {
    ...
    pt = function (t, n, r) {
      ...
      n &&
        t.isEmpty(n) &&
        !r(n) &&
        ((e = n.parentNode), t.remove(n), pt(t, e, r));
    },
    ht = mt.DOM,
    vt = function (t, r, e) {
      ...
      return (
        ...
        (s = gt(
          ...
          function (t) {
            return (
              c.isBlock(t) ||
              p(['BR', 'IMG', 'HR', 'INPUT'], t.nodeName) ||
              'false' === c.getContentEditable(t)
            );
          }),
        )),
        w.from(s.backwards(n, r, u, f)).bind(function (r) {
          if (r.offset >= l.length) {
            var t = e.createRng();
            return (
              t.setStart(r.container, r.offset - l.length),
              t.setEnd(r.container, r.offset),
              w.some(t)
            );
          }
          var n = r.offset - l.length;
          return vt(r.container, n, a)
            .map(function (t) {
              var n = e.createRng();
              return (
    ...
    Ot = function (l, d, m, g, p) {
      ...
      return q(m, g, h.getRoot()).bind(function (t) {
        ...
        for (var r, e = n.toString(), o = 0; o < d.length; o++) {
          ...
          i = r = void 0;
          if (
            ((a = (r = e).length - f.length),
            '' === (i = f) ||
              (r.length >= i.length && r.substr(a, a + i.length) === i))
          ) {
            var c = d.slice();
            c.splice(o, 1);
            var s = (function (a, i, u) {
              ...
              return vt(l, d - u.pattern.end.length, i).bind(function (t) {
                ...
                return (function (t, r, n, e, o, a) {
                ...
                })(f, s, o.container, o.offset, i, n.isNone()).map(function (
                  t,
                ) {
                  var n = G(
                    c,
                  ...
                  return {
                    matches: e.matches.concat([
                      { pattern: s, startRng: n, endRng: r },
                    ]),
                    position: I(t.startContainer, t.startOffset),
                  };
                });
              });
            })(l, p, { pattern: u, remainingPatterns: c, position: t });
    ...
    var t,
      ...
      o =
        ((t = (function () {
          ...
          if (!s(t))
            return (
              B('The setting textpattern_patterns should be an array'),
              { inlinePatterns: [], blockPatterns: [] }
            );
          var n = T(h(t, S));
          return (
            v(n.errors, function (t) {
    ...
    return (
      ...
      (e = o),
      {
        ...
        getPatterns: function () {
          return a(
            a([], h(e.get().inlinePatterns, M)),
            h(e.get().blockPatterns, M),
          );
        },
      }
    );
