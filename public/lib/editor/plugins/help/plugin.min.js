...
!(function () {
  ...
  function f(e) {
    var n = m.mac
      ...
      t = b(e.split('+'), function (e) {
        var t = e.toLowerCase().trim();
        return A(n, t) ? n[t] : e;
      });
    return m.mac ? t.join('').replace(/\s/, '') : t.join('+');
  }
  function k(e) {
    function a(e) {
      return (
          ...
          html: [
            null == e
              ...
              : '<div data-mce-tabstop="1" tabindex="-1">' +
                ((s = b(
                  ((i = w((n = o = e).plugins)),
                  void 0 === (r = n.getParam('forced_plugins'))
                    ? i
                    : (function (e) {
                    ...
                    return (
                      ...
                      (function (e, t, n) {
                        ...
                        function () {
                          ...
                          return 'function' == typeof e ? a(e()) : n;
                        },
                        function (e) {
                          return a({
                            name: e.name,
                ...
                (c = s.join('')),
                '<p><b>' +
                  C.translate(['Plugins installed ({0}):', l]) +
                  '</b></p><ul>' +
                  c +
                  '</ul>') +
                '</div>',
    ...
    return function () {
      var e,
        ...
        h =
            ...
            items: [
              {
                ...
                cells: b(x, function (e) {
                  var t = b(e.shortcuts, f).join(' or ');
                  return [e.action, t];
                }),
              },
            ],
            ...
            items: [
              {
                ...
                html:
                  ...
                  C.translate([
                    'You are using {0}',
                    '<a href="https://www.tiny.cloud/docs/changelog/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" target="_blank">TinyMCE ' +
                      i +
                      '</a>',
                  ]) +
                  '</p>',
          ...
          v.from(e.getParam('help_tabs')).fold(
            function () {
              return (
                -1 !== (n = (t = w((e = u))).indexOf('versions')) &&
        ...
        p = (function (e) {
          ...
          b(h.names, function (e) {
            return A((t = m), (n = e)) ? v.from(t[n]) : v.none();
            var t, n;
          }),
        );
  ...
  var c = function (n) {
    ...
    d = b(
      [
        ...
        { key: 'advcode', name: 'Advanced Code Editor*', type: p },
        { key: 'formatpainter', name: 'Format Painter*', type: p },
        { key: 'powerpaste', name: 'PowerPaste*', type: p },
        { key: 'tinydrive', name: 'Tiny Drive*', type: p },
        { key: 'tinymcespellchecker', name: 'Spell Checker Pro*', type: p },
        { key: 'a11ychecker', name: 'Accessibility Checker*', type: p },
        { key: 'linkchecker', name: 'Link Checker*', type: p },
        { key: 'mentions', name: 'Mentions*', type: p },
        { key: 'mediaembed', name: 'Enhanced Media Embed*', type: p },
        { key: 'checklist', name: 'Checklist*', type: p },
        { key: 'casechange', name: 'Case Change*', type: p },
        { key: 'permanentpen', name: 'Permanent Pen*', type: p },
        { key: 'pageembed', name: 'Page Embed*', type: p },
        {
          key: 'tinycomments',
          name: 'Tiny Comments*',
          type: p,
        ...
        { key: 'advtable', name: 'Advanced Tables*', type: p },
        { key: 'autocorrect', name: 'Autocorrect*', type: p },
        { key: 'export', name: 'Export*', type: p },
      ],
      function (e) {
        return y(y({}, e), {
