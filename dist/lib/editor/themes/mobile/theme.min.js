...
!(function () {
  ...
  function u(n, e, t) {
    if (t || 2 === arguments.length)
      for (var o, r = 0, i = e.length; r < i; r++)
        (!o && r in e) ||
          ((o = o || Array.prototype.slice.call(e, 0, r))[r] = e[r]);
  ...
  var ln,
    ...
    wn = {
      ...
      oses: w([
        ...
        { name: 'Linux', search: G('linux'), versionRegexes: [] },
        { name: 'Solaris', search: G('sunos'), versionRegexes: [] },
        { name: 'FreeBSD', search: G('freebsd'), versionRegexes: [] },
        {
          name: 'ChromeOS',
          search: G('cros'),
    ...
    Sn = 'Firefox',
    On = function () {
      return an({ current: void 0, version: yn.unknown() });
    },
    Tn = an,
    kn =
      (w('Edge'),
    ...
    Mn = 'ChromeOS',
    _n = function () {
      return sn({ current: void 0, version: yn.unknown() });
    },
    In = sn,
    Fn =
      (w(kn),
      ...
      T(function () {
        return (
          ...
          (e = mn.from(navigator.userAgentData)),
          (t = $),
          (p = wn.browsers()),
          (h = wn.oses()),
          (v = e
              ...
              return (
                ...
                P(n.brands, function (e) {
                  ...
                  return F(o, function (n) {
                    ...
                    return {
                      current: n.name,
                      version: yn.nu(parseInt(e.version, 10), 0),
                    };
                  });
                })
              );
            ...
            .orThunk(function () {
              return z(p, (t = n)).map(function (n) {
                var e = yn.detect(n.versionRegexes, t);
          ...
          (y = z(h, (o = n))
            .map(function (n) {
              var e = yn.detect(n.versionRegexes, o);
              return { current: n.name, version: e };
            })
            .fold(_n, In)),
          {
            ...
            deviceType:
              ...
              (u = n),
              (c = t),
              (a = (r = y).isiOS() && !0 === /ipad/i.test(u)),
              (s = r.isiOS() && !a),
              (l = (f = r.isiOS() || r.isAndroid()) || c('(pointer:coarse)')),
              (d = a || (!s && f && c('(min-device-width:768px)'))),
              (m = s || (f && !d)),
        ...
        var n, e, t, o, r, i, u, c, a, s, f, l, d, m, g, p, h, v, y;
      })),
    Rn = w,
    Vn = Rn('touchstart'),
    Bn = Rn('touchmove'),
  ...
  function ze(n, e) {
    var t, o, r;
    Pe(n)
      ? n.dom.classList.add(e)
      : ((o = e),
        (r = He((t = n), 'class').concat([o])),
        Re(t, 'class', r.join(' ')));
  }
  function Le(n, e) {
    var t, o, r, i;
    Pe(n)
      ? n.dom.classList.remove(e)
      : ((r = e),
        0 <
        (i = C(He((o = n), 'class'), function (n) {
          return n !== r;
        })).length
          ? Re(o, 'class', i.join(' '))
          : Ne(o, 'class')),
      0 === (Pe((t = n)) ? t.dom.classList : He(t, 'class')).length &&
        Ne(t, 'class');
  }
  function Ge(n, e) {
    return Pe(n) && n.dom.classList.contains(e);
  }
  function $e(n, e, t) {
    Le(n, t), ze(n, e);
  }
  ...
  var Ue,
    ...
    rt = function (n) {
      ...
      var t,
        ...
        i = fe.fromDom(e),
        u = tt(i);
      return (Se(u) ? mn.some(u) : mn.none()).fold(
        function () {
    ...
    mt = Object.freeze({
      ...
      toAlpha: function (n, e, t) {
        $e(n.element, e.alpha, e.omega);
      },
      toOmega: function (n, e, t) {
        $e(n.element, e.omega, e.alpha);
      },
      isAlpha: function (n, e, t) {
        return Ge(n.element, e.alpha);
      },
      isOmega: function (n, e, t) {
        return Ge(n.element, e.omega);
      },
  ...
  function yt(n) {
    return { stype: Ue.Value, svalue: n };
  }
  function bt(n) {
    return { stype: Ue.Error, serror: n };
  }
  function xt(n, e, t, o) {
    return { tag: 'field', key: n, newKey: e, presence: t, prop: o };
  }
  function wt(n, e, t) {
    switch (n.tag) {
      case 'field':
  ...
  function Tt(n) {
    return { tag: 'defaultedThunk', process: n };
  }
  function kt(n) {
    return Tt(w(n));
  }
  ...
  function Ct(n) {
    return { tag: 'mergeWithThunk', process: n };
  }
  function Dt(n) {
    return a(n) && 100 < st(n).length
      ? ' removed due to size'
      : JSON.stringify(n, null, 2);
  }
  function Mt(n, e) {
    return eo([{ path: n, getErrorInfo: e }]);
  }
  function _t(t) {
    return {
    ...
    switch (e.tag) {
      ...
      case 'defaultedOptionThunk':
        return (
          (a = e.process),
          n(
            _e((c = o), r).map(function (n) {
              return !0 === n ? a(c) : n;
            }),
          )
        );
      case 'mergeWithThunk':
        return It(o, r, w({}), function (n) {
      ...
      extract: function (n, e) {
        ...
        return 0 === a.length
          ...
          : ((t = a),
            Mt(n, function () {
              return (
                'There are unsupported fields: [' + t.join(', ') + '] specified'
              );
            }));
      },
      toString: s.toString,
  ...
  function Yt(n, e) {
    return ho(n, n, kt(e), mo());
  }
  function Kt(n, e, t) {
    return ho(n, n, kt(e), t);
  }
        ...
        c.push(r),
          (t[r] = function () {
            ...
            return {
              ...
              log: function (n) {
                console.log(n, { constructors: c, constructor: r, params: t });
              },
            };
          });
      }),
  ...
  var Qt,
    ...
    ro = function (n, e) {
      return n.stype === Ue.Value
        ? { stype: Ue.Value, svalue: e(n.svalue) }
        : n;
    },
    io = function (n, e) {
      return n.stype === Ue.Error
        ? { stype: Ue.Error, serror: e(n.serror) }
        : n;
    },
    uo = vt,
    co = St(function (n, e) {
    ...
    lo = function (t) {
      return {
        extract: function (i, u) {
          for (var c = {}, a = [], n = 0, e = t; n < e.length; n++)
            wt(
              e[n],
              function (n, e, t, o) {
                var r = Ft(t, i, u, n, o);
    ...
    ho = xt,
    vo = function (n, e) {
      return { tag: 'custom', newKey: n, instantiator: e };
    },
  ...
  function ko(n) {
    if (!Ie(n, 'can') && !Ie(n, 'abort') && !Ie(n, 'run'))
      throw new Error(
  ...
  function Eo(n, e) {
    return { key: n, value: ko({ abort: e }) };
  }
  function Co(n, e) {
    return { key: n, value: ko({ run: e }) };
  }
  function Do(n, t, o) {
    return {
      key: n,
  ...
  function Bo(n) {
    return { key: n, value: void 0 };
  }
  function Ao(n) {
    var e = Pt('Creating behaviour: ' + n.name, rr, n),
      t = e.fields,
      o = e.name,
      r = e.active,
      i = e.apis,
  ...
  function Po(n) {
    return (
      void 0 === n && (n = fe.fromDom(document)),
      mn.from(n.dom.activeElement).map(fe.fromDom)
    );
  }
  function zo(e) {
    return Po(tt(e)).filter(function (n) {
  ...
  var $o,
    ...
    Zo = function (n) {
      return Z(n, function (n) {
        return (
          0,
          (e = n.length - '/*'.length),
          n.length >= '/*'.length && '/*' === n.substr(e, e + '/*'.length)
    ...
    nr = function (t, n, l, i, e, o, r) {
      function u(n) {
        return Ie(n, l) ? n[l]() : mn.none();
      }
      var c = De(e, function (n, e) {
            ...
            (t = function (t) {
              ...
              return t.config({ name: w(r) }).fold(
                ...
                function (n) {
                  ...
                  return i.apply(void 0, [t, n.config, n.state].concat(e));
                },
              );
            }),
            (o = u = e),
        ...
        s = b(b(b({}, a), c), {
          revoke: J(Bo, l),
          config: function (n) {
            var e = Pt(l + '-config', t, n);
            return {
              key: l,
              value: {
                config: e,
                me: s,
                configAsRaw: T(function () {
                  return Pt(l + '-config', t, n);
                }),
                initialConfig: n,
                state: r,
              },
          ...
          exhibit: function (n, t) {
            return (
              ...
              (e.isSome() && o.isSome()
                ? mn.some(r(e.getOrDie(), o.getOrDie()))
                : mn.none()
              ).getOrThunk(function () {
                return Ro({});
              })
    ...
    er = {
      init: function () {
        return tr({ readState: w('No State required') });
      },
    },
    tr = function (n) {
      return n;
    ...
    ur = w(void 0),
    cr = Ao({ fields: yo, name: 'swapping', apis: mt }),
  ...
  function vr(e, n, t) {
    ...
    switch (
      _e(yr.get(), e)
        .orThunk(function () {
          return P(st(yr.get()), function (n) {
            return -1 < e.indexOf(n) ? mn.some(yr.get()[n]) : mn.none();
          });
        })
        .getOr(Uo.NORMAL)
    ) {
        ...
        var c =
            ...
            (u = new Date().getTime()),
            {
              ...
              write: function () {
                ...
                k(['mousemove', 'mouseover', 'mouseout', oe()], o) ||
                  console.log(o, {
                    event: o,
                    time: n - u,
                    target: r.dom,
                    sequence: Z(i, function (n) {
                      return k(['cut', 'stopped', 'response'], n.outcome)
                        ? '{' +
                            n.purpose +
                            '} ' +
                            n.outcome +
  ...
  ((Wo = Uo = {})[(Wo.STOP = 0)] = 'STOP'),
    (Wo[(Wo.NORMAL = 1)] = 'NORMAL'),
    (Wo[(Wo.LOGGING = 2)] = 'LOGGING');
  var yr = jo({}),
    br = ['alloy/data/Fields', 'alloy/debugging/Debugging'],
    xr = w({
      logEventCut: Y,
      logEventStopped: Y,
      logNoParent: Y,
  ...
  function Rr(n, e, t) {
    t.set(!0), Ir(n, e, t), _r(n, e, t);
  }
  function Vr(n, e, t) {
    t.set(!1), Ir(n, e, t), _r(n, e, t);
  }
  function Br(n, e, t) {
    Qr(n, e, t, e.selected);
  }
  ...
  function jr(n) {
    return ti.config({ channels: bo(mr, { onReceive: n }) });
  }
  function Nr(n, e) {
  ...
  function Hr() {
    ...
    return [Co(Un(), n), Co(ee(), n), Io(Vn()), Io(jn())];
  }
  function Pr(n, e) {
    e.ignore || (No(n.element), e.onFocus(n));
  }
  function zr(n) {
  ...
  function Xr(n, e) {
    var t,
      o = e;
    zr((t = n.dom)) && t.style.removeProperty(o),
      wo(Ae(n, 'style').map(bn), '') && Ne(n, 'style');
  }
  function qr(n) {
  ...
  function Yr(o, r) {
    ...
    return {
      set: function (n, e) {
        if (!g(e) && !e.match(/^[0-9]+$/))
          throw new Error(
            o + '.set accepts only positive integer values. Value was ' + e,
          );
        var t = n.dom;
        zr(t) && (t.style[o] = e + 'px');
      },
  ...
  function Zr(n, e, t) {
    Re(n.element, 'aria-expanded', t);
  }
  var ni = w(lo(Sr())),
    ei = w($t('initSize', [Lt('numColumns'), Lt('numRows')])),
    ti = Ao({
      fields: [
        Gt('channels', jt(ht.value, Rt([Er('onReceive'), Yt('schema', mo())]))),
      ],
      name: 'receiving',
      active: pr,
    }),
    ...
    ii = Ao({
      fields: [
        Yt('selected', !1),
        Ut('toggleClass'),
        Yt('toggleOnExecute', !0),
        Kt(
          'aria',
          { mode: 'none' },
          zt('mode', {
            pressed: [
              Yt('syncWithExpanded', !1),
              Dr('update', function (n, e, t) {
                Re(n.element, 'aria-pressed', t),
                  e.syncWithExpanded && Zr(n, 0, t);
              }),
            ],
            checked: [
              Dr('update', function (n, e, t) {
                Re(n.element, 'aria-checked', t);
              }),
            ],
            expanded: [Dr('update', Zr)],
            selected: [
              Dr('update', function (n, e, t) {
                Re(n.element, 'aria-selected', t);
              }),
            ],
            none: [Dr('update', Y)],
          }),
    ...
    si = Object.freeze({
      ...
      exhibit: function (n, e) {
        return Ro(e.ignore ? {} : { attributes: { tabindex: '-1' } });
      },
      events: function (t) {
        return qo(
          [
      ...
      fields: [Tr('onFocus'), Yt('stopMousedown', !1), Yt('ignore', !1)],
      name: 'focusing',
      active: si,
      apis: ai,
    }),
    li = function (n, e) {
      return zr(n) ? n.style.getPropertyValue(e) : '';
    },
  ...
  function _i(n, e, t, o) {
    Mi(n, e, 0, [o]),
      Bi(0, e, 0, o) ||
        (ze(o.element, e.highlightClass), e.onHighlight(n, o), W(o, ce()));
  }
  function Ii(t, e, n, o) {
    var r = Jr(t.element, '.' + e.itemClass);
    return R(r, function (n) {
      return Ge(n, e.highlightClass);
    }).bind(function (n) {
      var e = Ci(n, o, 0, r.length - 1);
  ...
  function Bi(n, e, t, o) {
    return Ge(o.element, e.highlightClass);
  }
  function Ai(e, n, t) {
  ...
  function ji(e, n, t) {
    ...
    return (0 < o.length ? mn.some(o[o.length - 1]) : mn.none()).bind(function (
      n,
    ) {
      return e.getSystem().getByDom(n).toOptional();
    });
  ...
  function Ni(e, n, t) {
    return So(
      Z(Jr(e.element, '.' + n.itemClass), function (n) {
        return e.getSystem().getByDom(n).toOptional();
      }),
    );
  }
  var Hi,
    ...
    Ji = Object.freeze({
      ...
      dehighlight: function (n, e, t, o) {
        Bi(0, e, 0, o) &&
          (Le(o.element, e.highlightClass), e.onDehighlight(n, o), W(o, ae()));
      },
      highlight: _i,
      highlightFirst: function (e, t, n) {
        Ai(e, t).each(function (n) {
          _i(e, t, 0, n);
        });
      },
      highlightLast: function (e, t, n) {
        ji(e, t).each(function (n) {
          _i(e, t, 0, n);
        });
      },
      highlightAt: function (e, t, n, o) {
        var r, i, u;
        (i = o),
          (u = Jr((r = e).element, '.' + t.itemClass)),
          mn
            .from(u[i])
            .fold(function () {
      ...
      highlightBy: function (e, t, n, o) {
        F(Ni(e, t), o).each(function (n) {
          _i(e, t, 0, n);
        });
      },
      isHighlighted: Bi,
  ...
  function Zi(n, e, t, o, c) {
    ...
    var r = {
          ...
          Kt(
            ...
            At(function (n) {
              return k(['onFocus', 'onEnterOrSpace', 'onApi'], n)
                ? ht.value(n)
                : ht.error('Invalid value for focusInside');
            }),
          ),
          Dr('handler', r),
          Dr('state', e),
      ...
      toEvents: function (i, u) {
        var n =
            i.focusInside !== Hi.OnFocusMode
              ? mn.none()
              : c(i).map(function (t) {
                  return Co(Yn(), function (n, e) {
                    t(n, i, u), e.stop();
                  });
                }),
          e = [
            Co(zn(), function (o, r) {
              a(o, r, t, i, u).fold(
                function () {
                  var e = o,
                    t = r,
                    n = Si(Ui.concat(Gi))(t.event);
                  i.focusInside === Hi.OnEnterOrSpaceMode &&
                    n &&
                    To(e, t) &&
                    c(i).each(function (n) {
                      n(e, i, u), t.stop();
  ...
  function nu(n) {
    ...
    function e(e, t, n) {
      var o = t,
        r = C(Jr(e.element, o.selector), function (n) {
          return c(o, n);
        });
    ...
    function o(t, n, r, i) {
      ...
      return (e = r).focusManager
        .get(t)
        .bind(function (n) {
          return vi(n, e.selector);
        })
        .bind(function (n) {
          return R(u, J(un, n)).bind(function (n) {
            return (
              (e = t),
              (o = r),
              i(u, n, function (n) {
    ...
    var t = [
        Ut('onEscape'),
        Ut('onEnter'),
        Yt('selector', '[data-alloy-tabstop="true"]:not(:disabled)'),
        Yt('firstTabstop', 0),
        Yt('useTabstopAt', x),
        Ut('visibilitySelector'),
      ].concat([n]),
      r = w([
        Ei(Oi([Ti, Si(Li)]), function (n, e, t) {
          return o(n, 0, t, t.cyclic ? yi : bi);
        }),
        Ei(Si(Li), function (n, e, t) {
          return o(n, 0, t, t.cyclic ? xi : wi);
        }),
        Ei(Si($i), function (e, t, n) {
          return n.onEscape.bind(function (n) {
            return n(e, t);
          });
        }),
        Ei(Oi([Ki, Si(Gi)]), function (e, t, n) {
  ...
  function eu(n) {
    return (
      ('input' === le(n) && 'radio' !== Be(n, 'type')) || 'textarea' === le(n)
    );
  }
  function tu(n, e, t) {
  ...
  function pu(n, e, t) {
    var o,
      r = C(Jr(n, t), gu);
    return R((o = r), function (n) {
      return un(n, e);
    }).map(function (n) {
      return { index: n, candidates: o };
    });
  }
  function hu(n, e) {
    ...
    return function (n, e, t, o) {
      return pu(n, e, t.selector).bind(function (n) {
        return r(
          n.candidates,
          n.index,
          o.getNumRows().getOr(t.initSize.numRows),
          o.getNumColumns().getOr(t.initSize.numColumns),
        );
      });
    };
  }
  ...
  function Ou(n, e, t, i) {
    var u = function (n, e, t) {
      var o,
        r = Ci(e, i, 0, t.length - 1);
      return r === n
        ? mn.none()
        : 'button' === le((o = t[r])) && 'disabled' === Be(o, 'disabled')
        ? u(n, r, t)
        : mn.from(t[r]);
    };
  ...
  function Du(r) {
    return function (n, e, t, o) {
      return r(n, e, t, o).bind(function () {
        return t.executeOnMove ? Tu(n, e, t) : mn.some(!0);
      });
    };
  }
  function Mu(n, e, t) {
  ...
  function Iu(n, e, t, o) {
    return _u(n, e, Ci(t, o, 0, n[e].length - 1));
  }
  function Fu(n, e, t, o) {
    var r = Ci(t, o, 0, n.length - 1);
  ...
  function zu(o, n) {
    return (
      ...
      (r = Z(n, function (n) {
        return (
          (e = n.name()),
          (t = 'Cannot configure ' + n.name() + ' for ' + o),
          ho(
            e,
            e,
            Et(),
  ...
  function Wu(t, o) {
    return function (n) {
      var e = Pt('Converting part type', o, n);
      return t(e);
    };
  }
  ((Pi = Hi = Hi || {}).OnFocusMode = 'onFocus'),
    (Pi.OnEnterOrSpaceMode = 'onEnterOrSpace'),
    (Pi.OnApiMode = 'onApi');
  var Xu,
    qu,
    Yu,
    ...
    ic = Zi(
      ...
      function (n, e, t, o) {
        var r = t.useSpace && !eu(n.element) ? Ui : [],
          i = t.useEnter ? Gi : [],
          u = t.useDown ? Yi : [];
        return [Ei(Si(r.concat(i).concat(u)), ru)].concat(
          t.useControlEnter ? [Ei(Oi([ki, Si(Gi)]), ru)] : [],
        );
      },
      function (n, e, t, o) {
        return t.useSpace && !eu(n.element) ? [Ei(Si(Ui), ou)] : [];
      },
      function () {
        return mn.none();
      },
    ...
    hc = Zi(
      ...
      w([
        ...
        Ei(Oi([Ti, Si(Li)]), Su),
        Ei(Oi([Ki, Si(Li)]), Su),
        Ei(Si($i), function (n, e, t) {
          return t.onEscape(n, e);
        }),
        Ei(Si(Ui.concat(Gi)), function (e, t, o, n) {
          return (r = o).focusManager
            .get(e)
            .bind(function (n) {
              return vi(n, r.selector);
    ...
    xc = [
      $t('selectors', [Lt('row'), Lt('cell')]),
      Yt('cycles', !0),
      Yt('previousSelector', mn.none),
      Yt('execute', tu),
    ],
    wc = Au(
      function (n, e, t) {
    ...
    kc = w([
      ...
      Ei(Si(Xi), sc(Oc)),
      Ei(Si(Yi), fc(Tc)),
      Ei(Si(Ui.concat(Gi)), function (e, t, o) {
        return zo(e.element).bind(function (n) {
          return o.execute(e, t, n);
        });
      }),
    ]),
    Ec = w([Ei(Si(Ui), ou)]),
    Cc = Zi(xc, er.init, kc, Ec, function () {
      return mn.some(Bu);
    }),
    ...
    Mc = w([
      Ei(Si(Xi), lc(Hu)),
      Ei(Si(Yi), lc(Pu)),
      Ei(Oi([Ti, Si(Li)]), function (n, e, t, o) {
        return t.moveOnTab ? lc(Hu)(n, e, t, o) : mn.none();
      }),
      Ei(Oi([Ki, Si(Li)]), function (n, e, t, o) {
    ...
    _c = w([Ei(Si(Ui), ou)]),
    Ic = Zi(Dc, er.init, Mc, _c, function () {
      return mn.some(Nu);
    }),
    Fc = Zi(
      [
      ...
      function (n, e, t) {
        return [
          Ei(Si(Ui), t.onSpace),
          Ei(Oi([Ki, Si(Gi)]), t.onEnter),
          Ei(Oi([Ti, Si(Gi)]), t.onShiftEnter),
          Ei(Oi([Ti, Si(Li)]), t.onShiftTab),
          Ei(Oi([Ki, Si(Li)]), t.onTab),
          Ei(Si(Xi), t.onUp),
          Ei(Si(Yi), t.onDown),
          Ei(Si(Wi), t.onLeft),
          Ei(Si(qi), t.onRight),
      ...
      function (n, e, t) {
        return t.stopSpaceKeyup ? [Ei(Si(Ui), ou)] : [];
      },
      function (n) {
        return n.focusIn;
      },
    ...
    zc =
          ...
          'Creating behaviour: ' +
            (Xu = {
              ...
              apis: {
                ...
                setGridSize: function (n, e, t, o, r) {
                  Ie(t, 'setGridSize')
                    ? t.setGridSize(o, r)
      ...
      (Qu = tc.extra),
      (Zu = tc.state),
      (ec = Xt(Yu, [Wt('config', (nc = qu))])),
      nr(nc, ec, Yu, Ku, Ju, Qu, Zu)),
    Lc = zu,
    Gc = Lu,
    $c = 'placeholder',
    Uc = Jt([
    ...
    Wc = function (r, i, u, c) {
      return (
        ...
        (Gu((e = u)) && e.uiType === $c
          ...
          function (n, e) {
            var t = Gu(u) ? e(i, u.config, u.validated) : e(i),
              o = B(_e(t, 'components').getOr([]), function (n) {
                return Wc(r, i, n, c);
              });
            return [b(b({}, t), { components: o })];
          },
          function (n, e) {
            if (Gu(u)) {
      ...
      M(t, function (n) {
        n.fold(
          ...
          function (n) {
            ...
            i[n.name] = w(n.factory.sketch(fa(o, n, e[Us()]), e));
          },
          function (o) {
            ...
            r[o.pname] = qc(!0, function (e, n, t) {
              return Z(e[o.name], function (n) {
                return o.factory.sketch(
                  co(o.defaults(e, n, t), n, o.overrides(e, n)),
                );
              });
            });
          },
    ...
    return (
      (n = function (n) {
        for (var e = [], t = 1; t < arguments.length; t++)
          e[t - 1] = arguments[t];
        return o.apply(void 0, u([n.getApis(), n], e));
      }),
      (t = (e = o.toString()).indexOf(')') + 1),
      (r = e.indexOf('(')),
      (i = e.substring(r + 1, t - 1).split(/,\s*/)),
      (n.toFunctionAnnotation = function () {
        return { name: 'OVERRIDE', parameters: Zo(i.slice(1)) };
      }),
      n
    );
    var n, e, t, r, i;
  ...
  function ya(n) {
    var e = Xe(n) ? n.dom[Js] : null;
    return mn.from(e);
  }
  function ba(n, e, t, o, r) {
    var i;
    return Pt(
      n + ' [SpecSchema]',
      Rt(
        ((i = r),
        (0 < o.length ? [$t('parts', o)] : [])
          .concat([
            Lt('uid'),
            Yt('dom', {}),
            Yt('components', []),
  ...
  function xa(n, e, t, o, r) {
    var i = nf(r),
      u = ba(
        ...
        B(t, function (n) {
          return n
            .fold(mn.none, mn.some, mn.none, mn.none)
            .map(function (n) {
              return $t(n.name, n.schema.concat([Mr(Us())]));
            })
            .toArray();
        }),
        [pa(t)],
  ...
  function wa(n) {
    var r = Pt('Sketcher for ' + n.name, ef, n),
      e = De(r.apis, va),
      t = De(r.extraApis, Fo);
    return b(
      b(
      ...
      o =
        ...
        M(e, function (n) {
          n.fold(mn.some, mn.none, mn.some, mn.some).each(function (t) {
            var o = Ws(r, t.pname);
            i[t.name] = function (n) {
              var e = Pt('Part: ' + t.name + ' in ' + r, lo(t.schema), n);
              return b(b({}, o), { config: n, validated: e });
            };
          });
        }),
        i),
    ...
    var r,
      ...
      c =
        ...
        n.replace(/\$\{([^{}]*)\}/g, function (n, e) {
          var t,
            o = r[e];
          return 'string' == (t = typeof o) || 'number' == t ? o.toString() : n;
        }));
    return (
      (e = fe.fromHtml(c)),
      (t = Je(e)),
      (o = I(
        void 0 !== e.dom.attributes ? e.dom.attributes : [],
        function (n, e) {
          var t;
          return 'class' === e.name
            ? n
            : b(b({}, n), (((t = {})[e.name] = e.value), t));
        },
        {},
      )),
      (i = Array.prototype.slice.call(e.dom.classList, 0)),
      (u = 0 === t.length ? {} : { innerHtml: Lo(e) }),
      b({ tag: le(e), classes: i, attributes: o }, u)
    );
  }
  function Ta(n) {
    return { dom: Oa(n) };
  ...
  function Aa(n) {
    ...
    return -1 === e.type.indexOf('touch')
      ? void 0 !== e.clientX
        ? mn.some(e).map(function (n) {
            return Tf(n.clientX, n.clientY);
          })
        : mn.none()
      : void 0 !== e.touches && 1 === e.touches.length
      ? mn.some(e.touches[0]).map(function (n) {
          return Tf(n.clientX, n.clientY);
        })
      : mn.none();
  }
  ...
  function ls(n) {
    ...
    return u && e <= w && w <= t
      ? ((h = w),
        ...
        c.fold(
          function () {
            var n = Math.round((h - v) / b) * b;
            return fs(v + n, v - 1, y + 1);
          },
          function (n) {
            var e = Math.round(((h - n) % b) / b),
              t = Math.floor((h - n) / b),
              o = Math.floor((y - n) / b),
              r = Math.min(o, t + e);
            return Math.max(n, n + r * b);
          },
        ))
      : a
      ? Math.round(w)
  ...
  function Ts(r) {
    return function (n, e) {
      return (
        Ss(n, {
          x: (o = (0 < r ? ss : as)(is((t = e)).x, ja(t), za(t), Ka(t))),
        }),
        mn.some(o).map(x)
      );
      var t, o;
  ...
  function Ds(r) {
    return function (n, e) {
      return (
        Es(n, {
          y: (o = (0 < r ? ss : as)(is((t = e)).y, Na(t), La(t), Ka(t))),
        }),
        mn.some(o).map(x)
      );
      var t, o;
    ...
    return function (n, e) {
      return (
        ...
        _s(
          n,
          Is(
            (i = (t = c) ? is(o).x : r(is(o).x, ja(o), za(o), Ka(o))),
            t ? r(is(o).y, Na(o), La(o), Ka(o)) : is(o).y,
          ),
        ),
        mn.some(i).map(x)
      );
    ...
    var e = {
      onChange: function (n, e, t) {
        o.undoManager.transact(function () {
          o.formatter.apply('forecolor', { value: t }), o.nodeChanged();
        });
      },
      getInitialValue: w(-1),
    };
      ...
      function () {
        return [
          ...
          qf.sketch({
            ...
            components: [
              qf.parts['left-edge'](
                Ta('<div class="${prefix}-hue-slider-black"></div>'),
              ),
              qf.parts.spectrum({
                dom: Oa(
                ...
                components: [
                  Ta('<div class="${prefix}-slider-gradient"></div>'),
                ],
                behaviours: or([
                  ii.config({ toggleClass: ci('thumb-active') }),
                ]),
              }),
              qf.parts['right-edge'](
                Ta('<div class="${prefix}-hue-slider-white"></div>'),
              ),
              qf.parts.thumb({
            ...
            onChange: function (n, e, t) {
              var o = i(t.x());
              Gr(e.element, 'background-color', o), r.onChange(n, e, o);
            },
            ...
            onInit: function (n, e, t, o) {
              var r = i(o.x());
              Gr(e.element, 'background-color', r);
            },
            stepSize: 10,
            model: {
              mode: 'x',
              ...
              getInitialValue: function () {
                return { x: r.getInitialValue() };
              },
            },
            sliderBehaviours: or([jr(qf.refresh)]),
          })),
        ];
        function i(n) {
          return n < 0
  ...
  function Bs(n) {
    var e,
      ...
      u =
        ...
        (Xe((t = r)) ? mn.some(t) : pe(t).filter(Xe))
          .map(function (n) {
            return mi(
              function (n, e) {
                return e(n);
  ...
  function As(n) {
    return [
      ...
      (r = Pt('SizeSlider', Jf, e)),
      qf.sketch({
        dom: {
          tag: 'div',
          classes: [
            ci('slider-' + r.category + '-size-container'),
            ci('slider'),
            ci('slider-size-container'),
          ],
        },
        onChange: function (n, e, t) {
          var o = t.x();
        ...
        components: [
          qf.parts.spectrum({
            ...
            components: [Ta('<div class="${prefix}-slider-size-line"></div>')],
          }),
          qf.parts.thumb({
            dom: Oa('<div class="${prefix}-slider-thumb"></div>'),
            behaviours: or([ii.config({ toggleClass: ci('thumb-active') })]),
          }),
        ],
      })),
      Ta(
  ...
  function js(n) {
    var e = void 0 !== n.uid && Ie(n, 'uid') ? n.uid : Zs('memento');
    return {
      get: function (n) {
  ...
  var Ns,
    ...
    zs,
    Ls,
    Gs = Wu(Jc.optional, ca),
    $s = Wu(Jc.group, aa),
    Us = w('entirety'),
    Ws = function (n, e) {
      return { uiType: Yc(), owner: n, name: e };
    },
    Xs = $u('alloy-premade'),
    qs = w('alloy-id-'),
    Ys = w('data-alloy-id'),
    ...
    Js = Ys(),
    Qs = function (n, e) {
      Object.defineProperty(n.dom, Js, { value: e, writable: !0 });
    },
    Zs = $u,
    nf = function (n) {
      return dt(n, 'uid') ? n : b(b({}, n), { uid: Zs('uid') });
    },
    ef = Rt([
      Lt('name'),
      Lt('factory'),
    ...
    of = wa({
      ...
      factory: function (n) {
        ...
        return {
          ...
          events: o,
          behaviours: Gc(n.buttonBehaviours, [
            fi.config({}),
            zc.config({ mode: 'execution', useSpace: !0, useEnter: !0 }),
          ]),
          domModification: {
            attributes: (function () {
              if ('button' !== r) return { role: t('role').getOr('button') };
    ...
    uf = function (n, e, t, o) {
      return of.sketch({
        dom: Ca(n, o),
        action: e,
        buttonBehaviours: co(or([rf.config({})]), t),
      });
    },
    cf = Gs({ schema: [Lt('dom')], name: 'label' }),
    af = Da('top-left'),
    sf = Da('top'),
    ff = Da('top-right'),
    lf = Da('right'),
    ...
    Ff = Object.freeze({
      ...
      setPositionFromValue: function (n, e, t, o) {
        var r = is(t),
          i = ks(
            n,
            o.getSpectrum(n),
    ...
    Uf = Object.freeze({
      __proto__: null,
      setValueFrom: function (n, e, t) {
        var o = Is(Os(n, e, t.left), Cs(n, e, t.top));
        return _s(n, o), o;
      },
      setToMin: function (n, e) {
        _s(n, Is(ja(e), Na(e)));
      ...
      setPositionFromValue: function (n, e, t, o) {
        var r = is(t),
          ...
          c = Ba(e.element) / 2,
          a = Kr(e.element) / 2;
        Gr(e.element, 'left', i - c + 'px'), Gr(e.element, 'top', u - a + 'px');
      },
      onLeft: Pf,
      onRight: zf,
      onUp: Lf,
      ...
      Gt(
        ...
        zt('mode', {
          ...
          xy: [
            ...
            Yt('maxY', 100),
            vo('value', function (n) {
              return jo({ x: n.mode.minX, y: n.mode.minY });
            }),
            Lt('getInitialValue'),
            Dr('manager', Uf),
          ],
    ...
    qf = Sa({
      ...
      factory: function (i, n, e, t) {
        ...
        return {
          ...
          dom: i.dom,
          components: n,
          behaviours: Lu(i.sliderBehaviours, [
            zc.config({
              mode: 'special',
              focusIn: function (n) {
                return ma(n, i, 'spectrum').map(zc.focusIn).map(x);
              },
            }),
            wf.config({
              store: {
            ...
            ti.config({ channels: (((p = {})[Xf()] = { onReceive: d }), p) }),
          ]),
          events: qo([
            Co(kf(), function (n, e) {
              !(function (n, e) {
    ...
    Zf =
      ...
      (Hs =
        nl.immediateFn ||
        ('function' == typeof Ns.setImmediate && Ns.setImmediate) ||
        function (n) {
      ...
      (nl.prototype.catch = function (n) {
        return this.then(null, n);
      }),
      (nl.prototype.then = function (t, o) {
        var r = this;
        return new nl(function (n, e) {
          el.call(r, new il(t, o, n, e));
        });
      }),
      (nl.all = function () {
        for (var n = [], e = 0; e < arguments.length; e++) n[e] = arguments[e];
        var c = Array.prototype.slice.call(
          1 === n.length && zs(n[0]) ? n[0] : n,
        );
        return new nl(function (o, r) {
      ...
      (nl.resolve = function (e) {
        return e && 'object' == typeof e && e.constructor === nl
          ? e
          : new nl(function (n) {
              n(e);
            });
      }),
      (nl.reject = function (t) {
        return new nl(function (n, e) {
          e(t);
        });
      }),
      (nl.race = function (r) {
        return new nl(function (n, e) {
          for (var t = 0, o = r; t < o.length; t++) o[t].then(n, e);
        });
      }),
      nl);
  function nl(n) {
  ...
  function el(t) {
    ...
    null !== this._state
      ? Hs(function () {
          var n,
            e = o._state ? t.onFulfilled : t.onRejected;
          if (null !== e) {
            try {
              n = e(o._value);
            } catch (n) {
            ...
            t.resolve(n);
          } else (o._state ? t.resolve : t.reject)(o._value);
        })
    ...
    try {
      ...
      if (n && ('object' == typeof n || 'function' == typeof n)) {
        ...
        if ('function' == typeof e)
          return void Ls(Ps(e, n), Ps(tl, this), Ps(ol, this));
      }
      (this._state = !0), (this._value = n), rl.call(this);
    } catch (n) {
      ol.call(this, n);
    }
  }
  function ol(n) {
    (this._state = !1), (this._value = n), rl.call(this);
  }
  function rl() {
                ...
                .then(function (o) {
                  i.undoManager.transact(function () {
                    var n = i.editorUpload.blobCache,
                      e = n.create($u('mceu'), r, o);
                    n.add(e);
                    var t = i.dom.createHTML('img', { src: e.blobUri() });
                    i.insertContent(t);
                  });
                });
          });
    ...
    u.url
      ...
      .fold(
        ...
        function (r) {
          ...
          u.link.bind(K).fold(
            function () {
              var n = u.text.toOptional().filter(al).getOr(r);
    ...
    return {
      ...
      value: {
        ...
        me:
          ((t = n),
          (o = qo(e)),
          Ao({ fields: [Lt('enabled')], name: t, active: { events: w(o) } })),
        configAsRaw: w({}),
        initialConfig: {},
        state: er,
      },
  ...
  function gl(n, e) {
    var t = js(
        md.sketch({
          inputAttributes: { placeholder: hd.translate(e) },
          onSetValue: function (n, e) {
            W(n, Gn());
          },
          inputBehaviours: or([
            fd.config({ find: mn.some }),
            pd.config({}),
            zc.config({ mode: 'execution' }),
          ]),
          selectOnFocus: !1,
        }),
      ),
    ...
    return {
      ...
      spec: ld.sketch({
        ...
        containerBehaviours: or([
          ii.config({ toggleClass: ci('input-container-empty') }),
          fd.config({
            find: function (n) {
          ...
          ll('input-clearing', [
            Co(Gn(), function (n) {
              var e = t.get(n);
              (0 < wf.getValue(e).length ? ii.off : ii.on)(n);
            }),
          ]),
        ]),
      }),
  ...
  function pl(n, e, t) {
    (e.disabled() ? yd : bd)(n, e);
  }
  function hl(n, e) {
    return !0 === e.useNative && k(vd, le(n.element));
  }
  function vl(n, e) {
    return hl(n, e)
      ? je(n.element, 'disabled')
      : 'true' === Be(n.element, 'aria-disabled');
  }
  function yl(n) {
    return '<alloy.field.' + n + '>';
  }
  function bl(o, r) {
    return Ea(r, 'link', 'link', function () {
      var n,
        e,
        t = kd(o, r);
      o.setContextToolbar(t),
        (n = r),
        (e = function () {
          o.focusToolbar();
        }),
  ...
  function xl(e) {
    function t(n) {
      return (
        ...
        n +
        (e ? '\n' + Go(e().element) + ' is not in context.' : '')
      );
    }
    function n(n) {
      return function () {
  ...
  function Cl(n) {
    ...
    return (
      ...
      })),
      {
        list: o,
        data: De(
          Nt('component.behaviours', lo(r), t.behaviours).fold(function (n) {
            throw new Error(
      ...
      c =
        0 < e.length
          ? (function (e, n, t, o) {
            ...
            })(t, { 'alloy.base.modification': u }, e, i)
          : u;
    return b(b({}, (r = i)), {
      attributes: b(b({}, r.attributes), c.attributes),
      styles: b(b({}, r.styles), c.styles),
  ...
  function Ml(n, e, t) {
    var o,
      ...
      u,
      c,
      a = { 'alloy.base.behaviour': n.events },
      s = n.eventOrder;
    return (
      (r = t),
      (i = e),
  ...
  function _l(t) {
    ...
    var e = jo(Md),
      o = Ht(Nt('custom.definition', Fd, t)),
      r = Cl(t),
      i = r.list,
      u = r.data,
      c = (function (n) {
        ...
        Ve(c, n.attributes),
          ...
          n.innerHtml.each(function (n) {
            return (
              ...
              (i = me((e = c)).dom),
              xe(
                (u = fe.fromDom(i.createDocumentFragment())),
                ((o = t),
                ((r = (i || document).createElement('div')).innerHTML = o),
                Je(fe.fromDom(r))),
              ),
              we(e),
              void Qe(e, u)
  ...
  function Il(n) {
    return (function (n) {
      var e = Pt('external.component', Rt([Lt('element'), Ut('uid')]), n),
        t = jo(xl()),
  ...
  function Fl(n) {
    (zo(n.element).isNone() || fi.isFocused(n)) &&
      (fi.isFocused(n) || fi.focus(n), X(n, Ad, { item: n }));
  }
  function Rl(n) {
    X(n, jd, { item: n });
  }
  ...
  function Nl(t, o, n) {
    ...
    om((e = t), (r = o))
      ...
      .each(function (n) {
        var e = n.transition;
        Le(t.element, e.transitionClass), Ne(t.element, o.destinationAttr);
      });
  }
  function Hl(n, e, t, o) {
    Nl(n, e, t),
      je(n.element, e.stateAttr) &&
        Be(n.element, e.stateAttr) !== o &&
        e.onFinish(n, o),
      Re(n.element, e.stateAttr, o);
  }
  function Pl(n) {
    ze(n, cm);
  }
  ...
  function Gl(n) {
    return Ie(n, 'items')
      ? ((r = co(
        ...
        {
          item: r,
          menus: co(i.menus, bo(e.title, i.items)),
          expansions: co(i.expansions, bo(e.title, e.title)),
        })
  ...
  function $l(t, n, o) {
      ...
      g =
        ...
        (i = (r = function (n) {
          return B(n, function (n) {
            return void 0 === n.items
              ? !Ie(n, 'format') || e.formatter.canApply(n.format)
                ? [n]
                : []
              : 0 < r(n.items).length
              ? [n]
    ...
    return (
      ...
      (s = fm(
        'Styles',
        [].concat(
          Z(c.items, function (n) {
            return sm(
              Ll(n),
              n.title,
              n.isSelected(),
              n.getPreview(),
              Ie(c.expansions, Ll(n)),
            );
          }),
        ),
        a,
      ...
      (f = De(c.menus, function (n, e) {
        var t = Z(n, function (n) {
          return sm(
            Ll(n),
            n.title,
            void 0 !== n.isSelected && n.isSelected(),
            void 0 !== n.getPreview ? n.getPreview() : '',
            Ie(c.expansions, Ll(n)),
          );
        });
        return fm(e, t, a, !0);
      ...
      (l = co(f, bo('styles', s))),
      (d = { tmenu: em.tieredData('styles', l, c.expansions) }),
      (m = js(
        em.sketch({
          dom: { tag: 'div', classes: [ci('styles-menu')] },
          components: [],
          fakeFocus: !0,
          stayInDom: !0,
          ...
          onOpenMenu: function (n, e) {
            var t = Ba(n.element);
            Va(e.element, t), um.jumpTo(e, 'current');
          },
    ...
    var c,
      ...
      y = (a = function (n) {
        return Z(n, function (n) {
          if (Ie(n, 'items')) {
            var e = a(n.items);
            return co(co(n, { isSelected: S, getPreview: w('') }), {
              items: e,
            });
          }
          return Ie(n, 'format')
            ? co(n, { isSelected: b(n.format), getPreview: x(n.format) })
            : ((o = $u((t = n).title)),
              (r = co(t, { format: o, isSelected: b(o), getPreview: x(o) })),
              c.formatter.register(o, r),
              r);
          var t, o, r;
        });
      ...
      styleselect: u(mn.none(), function () {
        return uf(
          ...
          or([
            ...
            ti.config({ channels: xo([Nr(mr, ii.off), Nr(gr, ii.off)]) }),
          ]),
          r,
        );
      }),
  ...
  function ql(n, e, t, o, r) {
    ...
    return n.dom.addEventListener(e, c, r), { unbind: J(mm, n, e, c, r) };
  }
  function Yl(n, e, t) {
    return ql(n, e, gm, t, !1);
  }
  function Kl(n, e, t) {
    return ql(n, e, gm, t, !0);
  }
  function Jl(n) {
    return { isPortrait: w(n.matchMedia('(orientation: portrait)').matches) };
  }
  function Ql(o, e) {
    var n = fe.fromDom(o),
      r = null,
      t = Yl(n, 'orientationchange', function () {
        pm.clearInterval(r);
        var n = Jl(o);
        e.onChange(n),
          i(function () {
      ...
      i = function (n) {
        ...
        var e = o.innerHeight,
          t = 0;
        r = pm.setInterval(function () {
          e !== o.innerHeight
            ? (pm.clearInterval(r), n(mn.some(o.innerHeight)))
            : 20 < t && (pm.clearInterval(r), n(mn.none())),
            t++;
        }, 50);
      };
    return {
        ...
        e.match({
          ...
          relative: function (n, e) {
            return {
              ...
              rtl: T(function () {
                return mn.some(Zl(r, e, n));
              }),
            };
          },
          exact: function (n, e, t, o) {
            return {
              ltr: T(function () {
                return nd(r, n, e, t, o);
              }),
              rtl: T(function () {
                return mn.some(nd(r, t, o, n, e));
              }),
            };
          },
        }));
    return (o = (t = i).ltr()).collapsed
      ? t
          .rtl()
          .filter(function (n) {
  ...
  function rd(r, n) {
    return {
      ...
      dom: r.dom,
      components: n,
      behaviours: Lu(r.formBehaviours, [
        wf.config({
          store: {
            mode: 'manual',
            getValue: function (n) {
              var e,
                ...
                o =
                  ((e = r),
                  (t = n.getSystem()),
                  De(e.partUids, function (n, e) {
                    return w(t.getByUid(n));
                  }));
              return De(o, function (n, o) {
                return n()
                  .bind(function (n) {
                    var e = fd.getCurrent(n),
                      t = new Error(
            ...
            setValue: function (t, n) {
              Ce(n, function (e, n) {
                ma(t, r, n).each(function (n) {
                  fd.getCurrent(n).each(function (n) {
                    wf.setValue(n, e);
                  });
                });
              });
      ...
      apis: {
        getField: function (n, e) {
          return ma(n, r, e).bind(fd.getCurrent);
        },
      },
    };
  }
  ...
  var ud,
    ...
    fd = Ao({ fields: [Lt('find')], name: 'composing', apis: sd }),
    ld = wa({
      name: 'Container',
      factory: function (n) {
        var e = n.dom,
        ...
        return {
          uid: n.uid,
          dom: b({ tag: 'div', attributes: b({ role: 'presentation' }, t) }, o),
          components: n.components,
    ...
    dd = wa({
      ...
      factory: function (t) {
        return {
          uid: t.uid,
          dom: t.dom,
          behaviours: Gc(t.dataBehaviours, [
            wf.config({
          ...
          events: qo([
            Yo(function (n, e) {
              wf.setValue(n, t.getInitialValue());
            }),
          ]),
        };
      },
    ...
    md = wa({
      ...
      factory: function (n, e) {
        return {
          ...
          dom: {
            tag: (o = n).tag,
            attributes: b({ type: 'text' }, o.inputAttributes),
    ...
    gd = Object.freeze({
      __proto__: null,
      exhibit: function (n, e) {
        return Ro({ attributes: xo([{ key: e.tabAttr, value: 'true' }]) });
      },
    }),
    pd = Ao({
    ...
    hd = tinymce.util.Tools.resolve('tinymce.util.I18n'),
    vd = ['input', 'button', 'textarea', 'select'],
    yd = function (e, n, t) {
      n.disableClass.each(function (n) {
        ...
        (hl(e, n)
          ? function (n) {
              Re(n.element, 'disabled', 'disabled');
            }
          : function (n) {
              Re(n.element, 'aria-disabled', 'true');
            })(e),
        n.onDisabled(e);
    },
    bd = function (e, n, t) {
      n.disableClass.each(function (n) {
        ...
        (hl(e, n)
          ? function (n) {
              Ne(n.element, 'disabled');
            }
          : function (n) {
              Re(n.element, 'aria-disabled', 'false');
            })(e),
        n.onEnabled(e);
    },
    xd = Object.freeze({
    ...
    wd = Object.freeze({
      __proto__: null,
      exhibit: function (n, e) {
        return Ro({ classes: e.disabled() ? e.disableClass.toArray() : [] });
      },
      events: function (t, n) {
        return qo([
          Eo(Zn(), function (n, e) {
      ...
      function (n) {
        var r,
          ...
          o = Z(e.record(), function (n) {
            return sa({ name: n, pname: yl(n) });
          });
        return xa('form', Od, o, rd, t);
      }),
    kd = T(function (o, r) {
      return [
        {
          ...
          items: [
            ((n = {
              fields: [
                gl('url', 'Type or paste URL'),
                gl('text', 'Link text'),
                gl('title', 'Link title'),
                gl('target', 'Link target'),
                {
                  name: 'link',
                  spec: dd.sketch({
              ...
              onExecute: function (n, e) {
                var t = wf.getValue(n);
                fl(r, t), o.restoreToolbar(), r.focus();
              },
            }),
            (a = 'navigateEvent'),
            (s = Pt(
              ...
              lo([
                Lt('fields'),
                Yt('maxFieldIndex', n.fields.length - 1),
                Lt('onExecute'),
                Lt('getInitialValue'),
                vo('state', function () {
                  return { dialogSwipeState: cu(), currentScreen: jo(0) };
                }),
              ]),
              n,
            )),
              ...
              Td(function (t) {
                return {
                  ...
                  formBehaviours: or([
                    jr(function (n, e) {
                      var t = e;
                      hi(n.element, '.' + ci('serialised-dialog-chain')).each(
                        function (n) {
                          Gr(
                            n,
                            'left',
                            -s.state.currentScreen.get() * t.width + 'px',
                          );
                        },
                      );
                    }),
                    ...
                    ll('form-events', [
                      Yo(function (e, n) {
                        s.state.currentScreen.set(0),
                          s.state.dialogSwipeState.clear();
                        var t = l.get(e);
                        Qi.highlightFirst(t),
                          s.getInitialValue(e).each(function (n) {
                            wf.setValue(e, n);
                          });
                      }),
                      Qo(s.onExecute),
      ...
      function u(n, r) {
        ...
        hi(n.element, '.' + ci('serialised-dialog-chain')).each(function (o) {
          0 <= s.state.currentScreen.get() + r &&
            s.state.currentScreen.get() + r < i.length &&
            (Wr(o, 'left').each(function (n) {
              var e = parseInt(n, 10),
                t = Ba(i[0]);
              Gr(o, 'left', e - r * t + 'px');
            }),
    ...
    Cd = Object.freeze({ __proto__: null, events: Ed }),
    Dd = K,
    Md = xl(),
    _d = function (n, c) {
      var e,
        ...
        u,
        a = Me(n, function (r, u) {
          return (1 === r.length ? ht.value(r[0].handler) : Tl(r, c, u)).map(
            function (n) {
              var e,
                i,
                t =
                  ((i = m((e = n)) ? { can: x, abort: S, run: e } : e),
                  function (n, e) {
                ...
                o =
                  1 < r.length
                    ...
                    : r[0].name;
              return bo(u, { handler: t, purpose: o });
            },
          );
        });
      return (
        ...
        0 < (u = { errors: t, values: o }).errors.length
          ? ht.error(V(u.errors))
          : ((i = e),
            0 === (r = u.values).length
              ? ht.value(i)
              : ht.value(co(i, ao.apply(void 0, r))))
      );
    },
    Id = 'alloy.base.behaviour',
    Fd = lo([
      ho(
        'dom',
        'dom',
      ...
      ho(
        'eventOrder',
        'eventOrder',
        (((ud = {})[Zn()] = ['disabling', Id, 'toggling', 'typeaheadevents']),
        (ud[Yn()] = [Id, 'focusing', 'keying']),
        (ud[oe()] = [Id, 'disabling', 'toggling', 'representing']),
        (ud[Gn()] = [Id, 'representing', 'streaming', 'invalidating']),
        (ud[ie()] = [Id, 'representing', 'item-events', 'tooltipping']),
        (ud[jn()] = ['focusing', Id, 'item-type-events']),
        (ud[Vn()] = ['focusing', Id, 'item-type-events']),
        (ud[Pn()] = ['item-type-events', 'tooltipping']),
        (ud[Qn()] = ['receiving', 'reflecting', 'tooltipping']),
        Ct(w(ud))),
        mo(),
      ),
      Ut('domModification'),
    ...
    Rd = Zs,
    Vd = function (u) {
      return _e(u, Xs).getOrThunk(function () {
        var n,
          e,
          t,
          o,
          r,
          i = dt(u, 'uid') ? u : b({ uid: Rd('') }, u);
        return (
          (n = Dd(i)),
          (e = n.events),
          (t = c(n, ['events'])),
          (o = Z(_e(t, 'components').getOr([]), Vd)),
          (r = b(b({}, t), { events: b(b({}, Cd), e), components: o })),
          ht.value(_l(r)).getOrDie()
        );
      });
    },
    Bd = ha,
    ...
    Pd = [
      ...
      Yt('hasSubmenu', !1),
      Ut('toggling'),
      Lc('itemBehaviours', [ii, fi, zc, wf]),
      Yt('ignoreFocus', !1),
      Yt('domModification', {}),
      Dr('builder', function (n) {
        return {
          dom: n.dom,
          domModification: b(b({}, n.domModification), {
            attributes: b(
              b(
                b(
                  {
          ...
          behaviours: Gc(n.itemBehaviours, [
            n.toggling.fold(ii.revoke, function (n) {
              return ii.config(b({ aria: { mode: 'checked' } }, n));
            }),
            fi.config({
            ...
            zc.config({ mode: 'execution' }),
            wf.config({ store: { mode: 'memory', initialValue: n.data } }),
            ll(
              'item-type-events',
              u(u([], Hr()), [Co(Pn(), Fl), Co(ne(), fi.focus)]),
            ),
          ]),
          components: n.components,
          eventOrder: n.eventOrder,
    ...
    $d = zt('type', {
      widget: [
        ...
        Yt('autofocus', !1),
        Yt('ignoreFocus', !1),
        Lc('widgetBehaviours', [wf, fi, zc]),
        Yt('domModification', {}),
        pa(Gd()),
        Dr('builder', function (t) {
          function o(n) {
            return ma(n, t, 'widget').map(function (n) {
              return zc.focusIn(n), n;
            });
          }
          function n(n, e) {
            return (
              eu(e.event.target) || (t.autofocus && e.setSource(n.element)),
              mn.none()
            );
          }
          var e = la(Ld(), t, Gd()),
            r = da(Ld(), t, e.internals());
          return {
            dom: t.dom,
            components: r,
            ...
            behaviours: Gc(t.widgetBehaviours, [
              wf.config({ store: { mode: 'memory', initialValue: t.data } }),
              fi.config({
              ...
              zc.config({
                ...
                onEscape: function (n, e) {
                  return fi.isFocused(n) || t.autofocus
                    ? (t.autofocus && e.setSource(n.element), mn.none())
                    : (fi.focus(n), mn.some(!0));
                },
              }),
            ]),
          };
    ...
    Ud = w([
      $s({
        ...
        defaults: function (n, e) {
          return dt(e, 'uid') ? e : b(b({}, e), { uid: Zs('item') });
        },
    ...
    Xd = w('alloy.menu-focus'),
    qd = Sa({
      name: 'Menu',
      configFields: Wd(),
      partFields: Ud(),
      factory: function (n, e, t, o) {
        return {
          uid: n.uid,
          dom: n.dom,
          markers: n.markers,
          behaviours: Lu(n.menuBehaviours, [
            Qi.config({
              highlightClass: n.markers.selectedItem,
              itemClass: n.markers.item,
              onHighlight: n.onHighlight,
            }),
            wf.config({ store: { mode: 'memory', initialValue: n.value } }),
            fd.config({ find: mn.some }),
            zc.config(n.movement.config(n, n.movement)),
          ]),
          events: qo([
            Co(Hd(), function (e, t) {
              var n = t.event;
    ...
    Kd = Ao({
      ...
      apis: Object.freeze({
        __proto__: null,
        append: function (n, e, t, o) {
          Vl(n, 0, Qe, o);
        },
        prepend: function (n, e, t, o) {
          Vl(n, 0, be, o);
        },
        remove: Bl,
        replaceAt: Al,
        replaceBy: function (e, n, t, o, r) {
          return R(Yd(e), o).bind(function (n) {
            return Al(e, 0, 0, n, r);
          });
        },
        set: function (i, n, e, u) {
          var t, o, r, c;
          (t = function () {
            var e,
              n,
    ...
    Qd = function () {
      ...
      return {
        ...
        getTriggeringPath: function (n, u) {
          var e = C(t(n).toArray(), function (n) {
            return a(n).isSome();
          });
          return _e(s.get(), n).bind(function (n) {
            var i = j(e.concat(n));
    ...
    em = wa({
      ...
      configFields: [
        ...
        Tr('onRepositionMenu'),
        Tr('onCollapseMenu'),
        Yt('highlightImmediately', !0),
        $t('data', [Lt('primary'), Lt('menus'), Lt('expansions')]),
        Yt('fakeFocus', !1),
        Tr('onHighlight'),
        Tr('onHover'),
        $t('markers', [Lt('backgroundMenu')].concat(wr()).concat(Sr())),
        Lt('dom'),
        Yt('navigateOnHover', !0),
        Yt('stayInDom', !1),
        zu('tmenuBehaviours', [zc, Qi, fd, Kd]),
        Yt('eventOrder', {}),
      ],
      apis: {
      ...
      factory: function (c, n) {
        function t(n) {
                ...
                function t() {
                  return qd.sketch(
                    b(b({}, n), {
                      ...
                      focusManager: (c.fakeFocus ? Vi : Ri)(),
                    }),
                  );
                }
                return e === r
                  ? { type: 'prepared', menu: o.getSystem().build(t()) }
          ...
          return (
            m.setContents(c.data.primary, e, c.data.expansions, t),
            m.getPrimary()
          );
        }
        function a(n) {
          return wf.getValue(n).value;
        }
        function i(e, n) {
          Qi.highlight(e, n),
            Qi.getHighlighted(n)
        ...
        function s(e, n, t) {
          M(u(n, n.otherMenus(t)), function (n) {
            El(n.element, [c.markers.backgroundMenu]),
              c.stayInDom || Kd.remove(e, n);
          });
        }
        function f(n, o) {
          var e;
          Ce(
            ...
            r.get().getOrThunk(function () {
              ...
              return (
                M(
                  C(Jr(e.element, '.' + c.markers.item), function (n) {
        ...
        function l(t, o, r) {
          return mn.from(r[0]).bind(function (n) {
            return o.lookupMenu(n).bind(function (n) {
              ...
              var e = n.menu;
              return (
                M(u(o, r.slice(1)), function (n) {
                  ze(n.element, c.markers.backgroundMenu);
                }),
                rt(e.element) || Kd.append(t, Bd(e)),
                El(e.element, [c.markers.backgroundMenu]),
                i(t, e),
                s(t, o, r),
                mn.some(e)
              );
        ...
        function g(r, i, u) {
          if (
            (void 0 === u && (u = d.HighlightSubmenu),
            i.hasConfigured(Sd) && Sd.isDisabled(i))
          )
            return mn.some(i);
          var n = a(i);
            ...
            return (
              ...
              mn.from(o[0]).bind(function (t) {
                return m.lookupMenu(t).bind(function (n) {
                  ...
                  return (
                    rt(e.element) || Kd.append(r, Bd(e)),
                    c.onOpenSubmenu(r, i, e, j(o)),
                    u === d.HighlightSubmenu
                      ? (Qi.highlightFirst(e), l(r, m, o))
                      : (Qi.dehighlightAll(e), mn.some(i))
                  );
                });
              })
            );
        ...
        ((e = d = {})[(e.HighlightSubmenu = 0)] = 'HighlightSubmenu'),
            ...
            [
              ...
              Qo(function (e, n) {
                ...
                e.getSystem()
                  .getByDom(t)
                  .each(function (n) {
                    0 === a(n).indexOf('collapse-item') && o(e, n),
                      g(e, n, d.HighlightSubmenu).fold(function () {
                        c.onExecute(e, n);
                      }, Y);
                  });
              }),
      ...
      extraApis: {
        ...
        singleData: function (n, e) {
          return { primary: n, menus: bo(n, e), expansions: {} };
        },
        collapseItem: function (n) {
          return { value: $u(nm()), meta: { text: n } };
        },
      },
    }),
    tm = function (n, e, t, o) {
      return jl(0, e, 0, o).bind(function (e) {
    ...
    om = function (e, t, n) {
      return Ae(e.element, t.destinationAttr).map(function (n) {
        return { start: Be(e.element, t.stateAttr), destination: n };
      });
    },
    rm = Object.freeze({
      __proto__: null,
      findRoute: jl,
      disableTransition: Nl,
      getCurrentRoute: om,
      jumpTo: Hl,
      progressTo: function (t, o, r, i) {
        var e,
          u = o;
        je((e = t).element, u.destinationAttr) &&
          (Ae(e.element, u.destinationAttr).each(function (n) {
            Re(e.element, u.stateAttr, n);
          }),
          Ne(e.element, u.destinationAttr));
        var n,
          c = ((n = i), { start: Be(t.element, o.stateAttr), destination: n });
        tm(t, o, r, c).fold(
          function () {
            Hl(t, o, r, i);
          },
          function (n) {
            Nl(t, o, r);
            var e = n.transition;
            ze(t.element, e.transitionClass),
              Re(t.element, o.destinationAttr, i);
          },
        );
      },
      getState: function (n, e, t) {
    ...
    im = Object.freeze({
      ...
      events: function (r, i) {
        return qo([
          Co(Wn(), function (t, n) {
            var o = n.event.raw;
            om(t, r).each(function (e) {
              jl(0, r, 0, e).each(function (n) {
                n.transition.each(function (n) {
                  o.propertyName === n.property &&
                    (Hl(t, r, i, e.destination), r.onTransition(t, e));
                });
              });
            });
          }),
          Yo(function (n, e) {
            Hl(n, r, i, r.initialState);
          }),
        ]);
      },
    }),
    um = Ao({
      fields: [
        Yt('destinationAttr', 'data-transitioning-destination'),
        Yt('stateAttr', 'data-transitioning-state'),
        Lt('initialState'),
        Tr('onTransition'),
        Tr('onFinish'),
        Gt(
          ...
          jt(
            ...
            jt(
              ht.value,
              Rt([qt('transition', [Lt('property'), Lt('transitionClass')])]),
            ),
          ),
        ),
      ],
      ...
      extra: {
        ...
        createTristate: function (n, e, t, o) {
          return xo([
            {
              key: n,
              value: xo([
    ...
    cm = ci('scrollable'),
    am = cm,
    sm = function (n, e, t, o, r) {
      return {
        data: { value: n, text: e },
        type: 'item',
        dom: { tag: 'div', classes: r ? [ci('styles-item-is-menu')] : [] },
        toggling: {
          toggleOnExecute: !1,
        ...
        components: [
          { dom: { tag: 'div', attributes: { style: o }, innerHtml: e } },
        ],
      };
    },
    fm = function (n, e, t, o) {
      return {
        ...
        components: [
          of.sketch({
            dom: { tag: 'div', classes: [ci('styles-collapser')] },
            components: o
              ? [
                  {
                    dom: { tag: 'span', classes: [ci('styles-collapse-icon')] },
                  },
                  Il(n),
                ]
              : [Il(n)],
            action: function (n) {
              var e;
              o && ((e = t().get(n)), em.collapseMenu(e));
            },
          }),
          {
            dom: { tag: 'div', classes: [ci('styles-menu-items-container')] },
            components: [qd.parts.items({})],
            behaviours: or([
              ll('adhoc-scrollable-menu', [
                Yo(function (n, e) {
                  Gr(n.element, 'overflow-y', 'auto'),
                    Gr(n.element, '-webkit-overflow-scrolling', 'touch'),
                    Pl(n.element);
                }),
                Ko(function (n) {
                  Xr(n.element, 'overflow-y'),
                    Xr(n.element, '-webkit-overflow-scrolling'),
                    zl(n.element);
                }),
              ]),
            ]),
        ...
        menuBehaviours: or([
          um.config({
            initialState: 'after',
            routes: um.createTristate('before', 'current', 'after', {
              transition: {
                property: 'transform',
    ...
    gm = x,
    pm = tinymce.util.Tools.resolve('tinymce.util.Delay'),
    hm = Jt([
  ...
  function bm(n, e, t, o, r) {
    var i = nd(n, e, t, o, r);
    ym(n).each(function (n) {
      n.removeAllRanges(), n.addRange(i);
    });
  }
  function xm(n, e, t, o, r) {
    var i,
      u,
      c,
      a,
      s,
      f = ((i = o), (u = r), (c = vm(e, t)), (a = vm(i, u)), Tg.relative(c, a));
    od((s = n), f).match({
      ltr: function (n, e, t, o) {
        bm(s, n, e, t, o);
      },
      rtl: function (r, i, u, c) {
        ym(s).each(function (n) {
          if (n.setBaseAndExtent) n.setBaseAndExtent(r.dom, i, u.dom, c);
          else if (n.extend)
            try {
  ...
  function Sm(n) {
    if (null === n.anchorNode || null === n.focusNode) return wm(n);
    var e,
      t,
      o,
      r,
    ...
    return (
      ...
      (c = o),
      (a = r),
      (s = me((i = e)).dom.createRange()).setStart(i.dom, u),
      s.setEnd(c.dom, a),
      (f = s),
      (l = un(e, o) && t === r),
      f.collapsed && !l
        ? mn.some(bg(d, n.anchorOffset, m, n.focusOffset))
        : wm(n)
    );
  }
  function Om(n) {
  ...
  function Tm(n, e) {
    var i,
      ...
      r = (t = od((i = n), e).match({
        ...
        rtl: function (n, e, t, o) {
          var r = i.document.createRange();
          return r.setStart(t.dom, o), r.setEnd(n.dom, e), r;
        },
      })).getClientRects();
    return 0 < (o = 0 < r.length ? r[0] : t.getBoundingClientRect()).width ||
      0 < o.height
      ? mn.some(o).map(ed)
      : mn.none();
  }
  ...
  function Mm(c) {
    var a = Cm(c);
    return mn
      .some(fe.fromDom(a.dom.contentWindow.document.body))
      .bind(function (u) {
        return mn
          .some(fe.fromDom(a.dom.contentWindow.document))
          .bind(function (i) {
            return km(a).map(function (r) {
                ...
                e = c.getCursorBox.getOrThunk(function () {
                  return function () {
                    return Om(r)
                      ...
                      .bind(function (n) {
                        return Tm(r, n).orThunk(function () {
                          return Om(r)
                            .filter(function (n) {
                              return (
                                un(n.start, n.finish) && n.soffset === n.foffset
                              );
                            })
                            .bind(function (n) {
              ...
              return {
                ...
                clearSelection: o,
                frame: a,
                onKeyup: Dm(c, i, 'onKeyup', 'keyup'),
                onNodeChanged: Dm(c, i, 'onNodeChanged', 'SelectionChange'),
  ...
  function _m() {
    var e = rn('head').getOrDie(),
      n = rn('meta[name="viewport"]').getOrThunk(function () {
        ...
        return Re(n, 'name', 'viewport'), Qe(e, n), n;
      }),
      t = Be(n, 'content');
    return {
      maximize: function () {
      ...
      restore: function () {
        null != t && 0 < t.length
          ? Re(n, 'content', t)
          : Re(n, 'content', 'user-scalable=yes');
      },
    };
  }
  function Im(n, e) {
    ...
    var o,
      ...
      i =
        ...
        C(
          (function (n, e) {
            for (
              var t = m(e) ? e : S, o = n.dom, r = [];
              null !== o.parentNode && void 0 !== o.parentNode;
      ...
      c =
        void 0 !== (o = Ur(e, 'background-color')) && '' !== o
          ? 'background-color:' + o + '!important'
          : 'background-color:rgb(255,255,255)!important;';
    M(u, t('display:none!important;')),
      M(i, t(Cg + Dg + c)),
      t((!0 === Mg ? '' : Cg) + Dg + c)(n);
  }
  function Fm() {
    M(on('[' + Eg + ']'), function (n) {
      var e = Be(n, Eg);
      'no-styles' !== e ? Re(n, 'style', e) : Ne(n, 'style'), Ne(n, Eg);
    });
  }
  function Rm(n) {
    var e = n.raw;
  ...
  function Bm(t) {
    ...
    return {
      ...
      onTouchend: function () {
        return Yl(t.body, 'touchend', function (n) {
          e.fireIfReady(n, 'touchend');
        });
      },
      onTouchmove: function () {
        return Yl(t.body, 'touchmove', function (n) {
          ...
          if (o.collapsed) {
            ...
            return pe(r)
              .bind(function (n) {
                ...
                return Tm(o.startContainer.ownerDocument.defaultView, t)
                  .map(jm)
                  .map(H);
              })
              .getOr([]);
          }
          return Z(o.getClientRects(), Nm);
        })(e.getRangeAt(0))
      : [];
  }
  function Pm(n, e) {
  ...
  function Lm(o, r) {
    var i = fe.fromDom(r.document.body),
      n = Yl(fe.fromDom(o), 'resize', function () {
        var n, e, t;
        (n = o),
          (e = Am(i, Ig)),
          ((t = n.innerHeight) < e ? mn.some(e - t) : mn.none()).each(function (
            t,
          ) {
            var n;
            (0 < (n = Hm(r)).length ? mn.some(n[0]).map(zm) : mn.none()).each(
              function (n) {
                var e =
                  n.top > r.innerHeight || n.bottom > r.innerHeight
                    ? Math.min(t, n.bottom - r.innerHeight + 50)
                    : 0;
      ...
      Pm(i, o.innerHeight),
      {
        toEditing: function () {
          !(function (n) {
            ...
            (Po().exists(function (n) {
              return k(['input', 'textarea'], le(n));
            })
              ? function (n) {
        ...
        ld.sketch({
          ...
          components: [
            of.sketch({
              ...
              buttonBehaviours: or([
                ii.config({ toggleClass: ci('mask-tap-icon-selected') }),
              ]),
            }),
          ],
        }),
  ...
  function Um(n) {
    var e = Pt('Getting AndroidWebapp schema', Rg, n);
    Gr(e.toolstrip, 'width', '100%');
    var t = Vd(
      $m(function () {
    ...
    var s,
      ...
      c =
        ...
        (f = uu()),
        {
          enter: function () {
            r.hide(),
              ze(s.container, ci('fullscreen-maximized')),
              ze(s.container, ci('android-maximized')),
              i.maximize(),
              ze(s.body, ci('android-scroll-reload')),
              u.set(Lm(s.win, kg(s.editor).getOrDie('no'))),
              Mm(s.editor).each(function (n) {
                function e(n) {
                ...
                Im(s.container, n.body),
                  f.set(
                    ...
                    (c = me(r)),
                    (a = [
                      Yl(o.body, 'touchstart', function (n) {
                        o.onTouchContent(), u.fireTouchstart(n);
                      }),
                      u.onTouchmove(),
                      u.onTouchend(),
                      Yl(r, 'touchstart', function (n) {
                        o.onTouchToolstrip();
                      }),
                      ...
                      o.onToEditing(Y),
                      o.onScrollToCursor(function (n) {
                        n.preventDefault(),
                          o.getCursorBox().each(function (n) {
                            var e = o.win,
                              t =
                                n.top > e.innerHeight ||
                                n.bottom > e.innerHeight
                                  ...
                                  : 0;
                            0 != t &&
                              e.scrollTo(e.pageXOffset, e.pageYOffset + t);
                          });
                      }),
                    ].concat(
                      1 == _g
                        ? []
                        : [
                            Yl(fe.fromDom(o.win), 'blur', function () {
                              i.getByDom(r).each(ii.off);
                            }),
                            Yl(c, 'select', t),
                            Yl(o.doc, 'selectionchange', t),
                          ],
                    )),
                    {
                      destroy: function () {
          ...
          exit: function () {
            i.restore(),
              r.show(),
              Le(s.container, ci('fullscreen-maximized')),
              Le(s.container, ci('android-maximized')),
              Fm(),
              Le(s.body, ci('android-scroll-reload')),
              f.clear(),
              u.clear();
          },
        });
  ...
  function Xm() {
    function e(n) {
      ...
      return {
        ...
        tgroupBehaviours: or([
          ll(
            ...
            !0 === n.scrollable
              ? [
                  Jo(function (n, e) {
                    Gr(n.element, 'overflow-x', 'auto'),
                      Re(n.element, Pg, 'true'),
                      Pl(n.element);
                  }),
                ]
              : [],
        ...
        components: [ld.sketch({ components: [Hg.parts.items({})] })],
        markers: { itemSelector: '.' + ci('toolbar-group-item') },
        items: n.items,
      };
    }
    function t() {
      Ag.setGroups(o, r.get()), ii.off(o);
    }
    var o = Vd(
        Ag.sketch({
          dom: Oa('<div class="${prefix}-toolbar"></div>'),
          components: [Ag.parts.groups({})],
          toolbarBehaviours: or([
            ii.config({
              toggleClass: ci('context-toolbar'),
              toggleOnExecute: !1,
              aria: { mode: 'none' },
            }),
            zc.config({ mode: 'cyclic' }),
          ]),
          shell: !0,
        }),
      ),
    ...
    return {
      ...
      createGroups: function (n) {
        return Z(n, i(Hg.sketch, e));
      },
      setGroups: function (n) {
        r.set(n), t();
      },
      setContextToolbar: function (n) {
        ii.on(o), Ag.setGroups(o, n);
      },
  ...
  function Ym() {
    return Vd(
      ld.sketch({
        ...
        components: [],
        containerBehaviours: or([Kd.config({})]),
      }),
    );
  }
  function Km(n, e, t, o) {
    (!0 === t ? cr.toAlpha : cr.toOmega)(o),
      (t
        ? function (n, e) {
            Kd.append(n, Bd(e));
          }
  ...
  function ng(n, e) {
    El(Jm(n, e), [e.shrinkingClass, e.growingClass]);
  }
  function eg(n, e) {
    Le(n.element, e.openClass),
      ze(n.element, e.closedClass),
      Gr(n.element, Qm(e), '0px'),
      qr(n.element);
  }
  function tg(n, e) {
    Le(n.element, e.closedClass),
      ze(n.element, e.openClass),
      Xr(n.element, Qm(e));
  }
  function og(n, e, t, o) {
    t.setCollapsed(),
      Gr(n.element, Qm(e), Zm(e, n.element)),
      qr(n.element),
      ng(n, e),
      eg(n, e),
      e.onStartShrink(n),
  ...
  function rg(n, e, t) {
    var o = Zm(e, n.element);
    ('0px' === o
      ? og
      : function (n, e, t, o) {
          var r = o.getOrThunk(function () {
            return Zm(e, n.element);
          });
          t.setCollapsed(), Gr(n.element, Qm(e), r), qr(n.element);
          var i = Jm(n, e);
          Le(i, e.growingClass),
            ze(i, e.shrinkingClass),
            eg(n, e),
            e.onStartShrink(n);
        })(n, e, t, mn.some(o));
  }
  function ig(n, e, t) {
    var o = Jm(n, e),
      r = Ge(o, e.shrinkingClass),
      i = Zm(e, n.element);
    tg(n, e);
    var u = Zm(e, n.element);
    (r
      ? function () {
          Gr(n.element, Qm(e), i), qr(n.element);
        }
      : function () {
          eg(n, e);
        })(),
      Le(o, e.shrinkingClass),
      ze(o, e.growingClass),
      tg(n, e),
      Gr(n.element, Qm(e), u),
      t.setExpanded(),
  ...
  function ug(n, e, t) {
    return !0 === Ge(Jm(n, e), e.growingClass);
  }
  function cg(n, e, t) {
    return !0 === Ge(Jm(n, e), e.shrinkingClass);
  }
  function ag(e, t) {
    var o = Vd(
        ld.sketch({
          dom: { tag: 'div', classes: [ci('dropup')] },
          components: [],
          containerBehaviours: or([
            Kd.config({}),
            Gg.config({
    ...
    return {
      appear: function (n, e, t) {
        !0 === Gg.hasShrunk(o) &&
          !1 === Gg.isTransitioning(o) &&
          window.requestAnimationFrame(function () {
            e(t), Kd.set(o, [n()]), Gg.grow(o);
          });
      },
      disappear: r,
      component: o,
  ...
  function fg(e, n) {
    var t,
      ...
      r,
      i,
      u = Pt('Getting GUI events settings', $g, n),
      c = Vm(u),
      a = Z(
        [
          'touchstart',
      ...
      l = Yl(e, 'keydown', function (n) {
        var e;
        u.triggerEvent('keydown', n)
          ? n.kill()
          : !0 !== u.stopBackspace ||
            (e = n).raw.which !== zi[0] ||
            k(['input', 'textarea'], le(e.target)) ||
            vi(e.target, '[contenteditable="true"]', void 0).isSome() ||
            n.prevent();
      }),
      d =
        ((t = e),
        ...
        sg() ? Kl(t, 'focus', o) : Yl(t, 'focusin', o)),
      m = cu(),
      g =
        ((r = e),
        (i = function (n) {
        ...
        sg() ? Kl(r, 'blur', i) : Yl(r, 'focusout', i));
    return {
      unbind: function () {
        M(a, function (n) {
          n.unbind();
  ...
  function lg(n, e) {
    return jo(_e(n, 'target').getOr(e));
  }
  function dg(n, o, e, t, r, i) {
    var u,
      c,
      a = n(o, t),
      s =
    ...
    return a.fold(
      function () {
        return i.logEventNoHandlers(o, t), Ug.complete();
      },
      function (e) {
        var t = e.descHandler;
        return (
          Sl(t)(s),
          s.isStopped()
            ? (i.logEventStopped(o, e.element, t.purpose), Ug.stopped())
            : s.isCut()
            ? (i.logEventCut(o, e.element, t.purpose), Ug.complete())
            : pe(e.element).fold(
                function () {
                  return i.logNoParent(o, e.element, t.purpose), Ug.complete();
                },
                function (n) {
                  return (
                    i.logEventResponse(o, e.element, t.purpose), Ug.resume(n)
                  );
                },
              )
        );
        ...
        return (
              ...
              ya((o = n)).fold(
                ...
                function (e) {
                  return t
                    ...
                    .map(function (n) {
                      return { element: o, descHandler: n };
                    });
                },
              )
            );
          ...
          u.orThunk(function () {
            return c(i)
              ? mn.none()
              : (function (n) {
                  for (var e = i.dom, t = Oo(c); e.parentNode; ) {
                    var e = e.parentNode,
                      o = fe.fromDom(e),
                      r = n(o);
  ...
  function gg() {
    ...
    return {
      ...
      register: function (n) {
        var t,
          o = ya((t = n).element).getOrThunk(function () {
            return (n = t.element), (e = $u(Ks + 'uid-')), Qs(n, e), e;
            var n, e;
          });
        Ie(u, o) &&
          (function (n) {
  ...
  hm.ltr, hm.rtl;
  function pg(n, e, t, o, r) {
    var i = lg(t, o);
    return Wg(n, e, t, o, i, r);
  }
  var hg,
    vg,
    yg,
    bg = function (n, e, t, o) {
      return { start: n, soffset: e, finish: t, foffset: o };
    },
    xg =
      ((hg = qe),
      {
        get: function (n) {
          if (!hg(n)) throw new Error('Can only get text value of a text node');
          return vg(n).getOr('');
        },
        getOption: (vg = function (n) {
          return hg(n) ? mn.from(n.dom.nodeValue) : mn.none();
        }),
        set: function (n, e) {
          if (!hg(n))
    ...
    Tg = {
      domRange: Og.domRange,
      relative: Og.relative,
      exact: Og.exact,
      exactFromRange: function (n) {
        return Og.exact(n.start, n.soffset, n.finish, n.foffset);
      },
      getWin: function (n) {
        var e = n.match({
          domRange: function (n) {
    ...
    Eg = 'data-ephox-mobile-fullscreen-style',
    Cg = 'position:absolute!important;',
    Dg =
    ...
    Mg = Fn().os.isAndroid(),
    _g = 6 <= Fn().os.version.major,
    Ig = 'data-' + ci('last-outer-height'),
    Fg = w({ unbind: Y }),
    Rg = lo([
      $t('editor', [
        Lt('getFrame'),
        ...
        Yt('onTouchContent', Y),
        Yt('onTapContent', Y),
        Yt('onTouchToolstrip', Y),
        Yt('onScrollToCursor', Fg),
        Yt('onScrollToElement', Fg),
        Yt('onToEditing', Fg),
        Yt('onToReading', Fg),
        Yt('onToolbarScrollStart', K),
      ]),
      Lt('socket'),
      Lt('toolstrip'),
      Lt('dropup'),
    ...
    Vg = w([Lt('dom'), Yt('shell', !0), zu('toolbarBehaviours', [Kd])]),
    Bg = w([
      Gs({
        name: 'groups',
        overrides: function () {
          return { behaviours: or([Kd.config({})]) };
        },
      }),
    ]),
    Ag = Sa({
      ...
      configFields: Vg(),
      partFields: Bg(),
      factory: function (o, n, e, t) {
        var r = o.shell
          ? { behaviours: [Kd.config({})], components: [] }
        ...
        return {
          ...
          apis: {
            setGroups: function (n, e) {
              var t;
              (t = n),
                (o.shell ? mn.some(t) : ma(t, o, 'groups')).fold(
                  function () {
                    throw (
                      (console.error(
    ...
    jg = w([
      Lt('items'),
      $t('markers', Z(['itemSelector'], Lt)),
      zu('tgroupBehaviours', [zc]),
    ]),
    Ng = w([$s({ name: 'items', unit: 'item' })]),
    Hg = Sa({
      name: 'ToolbarGroup',
      configFields: jg(),
      partFields: Ng(),
      factory: function (n, e, t, o) {
        return {
          ...
          dom: n.dom,
          components: e,
          behaviours: Lu(n.tgroupBehaviours, [
            zc.config({ mode: 'flow', selector: n.markers.itemSelector }),
          ]),
          domModification: { attributes: { role: 'toolbar' } },
        };
      },
    }),
    Pg = 'data-' + ci('horizontal-scroll'),
    zg = Object.freeze({
      __proto__: null,
      ...
      grow: function (n, e, t) {
        t.isExpanded() || ig(n, e, t);
      },
      shrink: function (n, e, t) {
        t.isExpanded() && rg(n, e, t);
      },
      immediateShrink: function (n, e, t) {
        t.isExpanded() && og(n, e, t);
      },
      ...
      isTransitioning: function (n, e, t) {
        return ug(n, e) || cg(n, e);
      },
      toggleGrow: function (n, e, t) {
        (t.isExpanded() ? rg : ig)(n, e, t);
      },
      disableTransitions: ng,
    }),
    Lg = Object.freeze({
      __proto__: null,
        ...
        return Ro(
          e.expanded
            ...
            : {
                ...
                styles: bo(e.dimension.property, '0px'),
              },
        );
      },
      events: function (t, o) {
        return qo([
          Mo(Wn())(function (n, e) {
            e.event.raw.propertyName === t.dimension.property &&
              (ng(n, t),
              o.isExpanded() && Xr(n.element, t.dimension.property),
              (o.isExpanded() ? t.onGrown : t.onShrunk)(n));
          }),
        ]);
      },
    }),
    ...
    $g = Rt([Gt('triggerEvent', go), Yt('stopBackspace', !0)]),
    Ug = Jt([{ stopped: [] }, { resume: ['element'] }, { complete: [] }]),
    Wg = function (e, t, o, n, r, i) {
      return dg(e, t, o, n, r, i).fold(
        x,
        function (n) {
          return Wg(e, t, o, n, r, i);
        },
        S,
      );
    },
    Xg = function (t) {
      ...
      var i = gg(),
              ...
              function (n) {
                vr(Yn(), c, function (n) {
                  var e,
                    ...
                    i = n,
                    u = lg(
                      (e = { originator: a, kill: Y, prevent: Y, target: c }),
                      (t = c),
                    );
                  return dg(o, r, e, t, u, i), !1;
                });
              },
            );
          },
        ...
        e = function (n) {
          n.connect(u),
            qe(n.element) ||
              (i.register(n),
              M(n.components(), e),
              u.triggerEvent(oe(), n.element, { target: n.element }));
        },
        c = function (n) {
          qe(n.element) || (M(n.components(), c), i.unregister(n)),
            n.disconnect();
        },
        a = function (n) {
          at(t, n, Qe);
        ...
        l = function (n) {
          r({ universal: !0, data: n });
        },
        d = function (n, e) {
          r({ universal: !1, channels: n, data: e });
        },
        m = function (n, e) {
          var t,
            o,
  ...
  function Kg(n) {
    var e = Vd(
      ld.sketch({
        dom: { classes: [ci('outer-container')].concat(n.classes) },
        containerBehaviours: or([cr.config({ alpha: qg, omega: Yg })]),
      }),
    );
    return Xg(e);
  }
  ...
  function Qg(n) {
    ...
    0 < o.rangeCount &&
      ((e = o.getRangeAt(0)),
      (t = n.document.createRange()).setStart(e.startContainer, e.startOffset),
  ...
  function np(n, e, t, o) {
    ...
    var i = Yl(t, 'keydown', function (n) {
      k(['input', 'textarea'], le(n.target)) || r();
    });
    return {
      toReading: function () {
        Jg(n, Ho);
  ...
  function lp(n, e) {
    var t = Be(n, Dp);
    return Ep.fixed(n, t, e);
  }
  function dp(n, e) {
    return Ep.scroller(n, e);
  }
  function mp(n) {
    var e = fp(n);
    return ('true' === Be(n, Mp) ? dp : lp)(n, e);
  }
  function gp(n, e, t) {
    var o = me(n).dom.defaultView.innerHeight;
    return Re(n, _p, o + 'px'), o - e - t;
  }
  function pp(n) {
  ...
  function vp(r, i) {
    return Tp(function (n) {
      ...
      Ip.animate(
        ...
        o,
        function (n, e) {
          Am(r, Fp) !== r.dom.scrollTop
            ? e(r.dom.scrollTop)
            : ((r.dom.scrollTop = n), Re(r, Fp, n));
        },
        function () {
          (r.dom.scrollTop = i), Re(r, Fp, i), n(i);
        },
        10,
      );
    });
  ...
  (ep = rp),
    ...
    (function (n) {
      ...
      return (function i(u, c, a) {
        ...
        for (var f = 'function' == typeof op, n = 0; n < a.length; n++) s(a[n]);
        return s;
      })(
        {
          1: [
              ...
              (i.nextTick = function (n) {
                ...
                if (1 < arguments.length)
                  for (var t = 1; t < arguments.length; t++)
                    e[t - 1] = arguments[t];
                f.push(new p(n, e)), 1 !== f.length || l || a(g);
              }),
              ...
              !function (e) {
                    ...
                    ? ((t._handled = !0),
                      i._immediateFn(function () {
                        ...
                        if (null !== e) {
                          ...
                          u(o.promise, n);
                        } else (1 === t._state ? u : c)(o.promise, t._value);
                      }))
                    : t._deferreds.push(o);
                }
                function u(e, n) {
                ...
                (i.prototype.catch = function (n) {
                  ...
                  (i.prototype.then = function (n, e) {
                    ...
                    return r(this, new s(n, e, t)), t;
                  }),
                  (i.all = function (n) {
                    var c = Array.prototype.slice.call(n);
                    return new i(function (r, i) {
                      if (0 === c.length) return r([]);
                      for (var u = c.length, n = 0; n < c.length; n++)
                        !(function e(t, n) {
                          try {
                            if (
                              n &&
          ...
          4: [
            function (n, e, t) {
              ...
              e.exports = { boltExport: r.Promise || o };
            },
            { 'promise-polyfill': 2 },
          ],
        },
  ...
  var bp,
    ...
    Cp = 'data-' + ci('position-y-fixed'),
    Dp = 'data-' + ci('y-property'),
    Mp = 'data-' + ci('scrolling'),
    _p = 'data-' + ci('last-window-height'),
    Ip =
      ((bp = null),
      {
        animate: function (r, i, u, c, e, n) {
          function a(n) {
            (s = !0), e(n);
          }
          var s = !1;
          function f(n) {
            pm.clearInterval(bp), a(n);
          }
          pm.clearInterval(bp),
            (bp = pm.setInterval(function () {
              var t = r(),
                n = t,
                e = i,
                o = u;
              (Math.abs(n - e) <= o
                ...
                function () {
                  pm.clearInterval(bp), a(i);
                },
                function (n) {
                  var e;
                  c(n, f),
                    s ||
                      (((e = r()) !== n || Math.abs(e - i) > Math.abs(t - i)) &&
                        (pm.clearInterval(bp), a(i)));
                },
              );
            }, n));
    ...
    Fp = 'data-' + ci('last-scroll-top');
  function Rp(n, l) {
    return n.fold(
      function (n, e, t) {
        return Gr(n, e, l + (o = t) + 'px'), kp(o);
        var o;
      },
      function (n, e) {
        return (
          (r = l + (o = e)),
          (i = Wr((t = n), 'top').getOr(o)),
          (u = r - parseInt(i, 10)),
          (c = t.dom.scrollTop + u),
          (a = t),
          (s = c),
          ...
          Tp(function (n) {
            ...
            Ip.animate(
              ...
              15,
              function (n) {
                (a.dom.scrollTop = n), Gr(a, 'top', pp(a) + 15 + 'px');
              },
              function () {
                (a.dom.scrollTop = s), Gr(a, 'top', f + 'px'), n(s);
              },
              10,
            );
          })
  ...
  function Bp(n) {
    var o,
      ...
      M =
        ...
        (i = O),
        (u = C),
        (m = me((o = S)).dom.defaultView),
        (d = Be((l = i), 'style')),
        $r(l, { position: 'absolute', top: '0px' }),
        Re(l, Cp, '0px'),
        Re(l, Dp, 'top'),
        (g = {
          restore: function () {
            Re(l, 'style', d || ''), Ne(l, Cp), Ne(l, Dp);
          },
        }),
        (p = Kr(i)),
        (h = Kr(u)),
        ...
        (v = {
          restore: function () {
            zl(s), Re(s, 'style', f || ''), Ne(s, Cp), Ne(s, Mp), Ne(s, Dp);
          },
        }),
        (t = Be((e = u), 'style')),
        $r(e, { position: 'absolute', bottom: '0px' }),
        Re(e, Cp, '0px'),
        Re(e, Dp, 'bottom'),
        (y = {
          restore: function () {
            Re(e, 'style', t || ''), Ne(e, Cp), Ne(e, Dp);
          },
        }),
        (b = !0),
        sp(r, o, u),
        {
          ...
          refresh: R,
          restore: function () {
            (b = !1), g.restore(), v.restore(), y.restore();
          },
        }),
      _ = k(D, x, Te(), T),
      I = Ql(E, { onChange: Y, onReady: M.refresh });
    function F() {
      var n = m.innerHeight;
      return Am(o, _p) < n;
    }
    ...
    var B,
      ...
      $,
      U,
      W = Yl(fe.fromDom(E), 'resize', function () {
      ...
      X =
        ...
        (z = function (n) {
          return (
            (t = A),
            (o = n),
            (r = me((e = B)).dom.defaultView),
            Tp(function (n) {
              yp(e, o), yp(t, o), r.scrollTo(0, o), n(o);
            })
          );
          var e, t, o, r;
        }),
        ...
        ($ = Gm(function () {
          G.idle(function () {
            Vp(j, N.pageYOffset).get(function () {
              var n = Hm(P);
              mn
                .from(n[0])
                .bind(function (n) {
                  var e = n.top - A.dom.scrollTop;
                  return e > N.innerHeight + 5 || e < -5
                    ? mn.some({ top: e, bottom: e + n.height })
                    : mn.none();
                })
                .each(function (n) {
        ...
        (U = Yl(fe.fromDom(N), 'scroll', function () {
          N.pageYOffset < 0 || $.throttle();
        })),
        Vp(j, N.pageYOffset).get(K),
        { unbind: U.unbind }),
      q = (function (e, t) {
        var n = e.document,
          o = fe.fromTag('div');
        function r(n) {
          ...
          return (
            kl(e, [ci('layer-editor'), ci('unfocused-selection')]),
            $r(e, {
              left: n.left + 'px',
              top: n.top + 'px',
              width: n.width + 'px',
        ...
        ze(o, ci('unfocused-selections')), Qe(fe.fromDom(n.documentElement), o);
        var i = Yl(o, 'touchstart', function (n) {
            n.prevent(), Zg(e, t), u();
          }),
          u = function () {
            we(o);
    ...
    return {
      ...
      scrollIntoView: function (n, e) {
        var t,
          ...
          c = J(Qg, o);
        u < r || u < i
          ? vp(t, t.dom.scrollTop - u + i).get(c)
          : r < 0 && vp(t, t.dom.scrollTop + r).get(c);
      },
      updateToolbarPadding: Y,
      setViewportOffset: function (n) {
        var i, u;
        M.setViewportOffset(n),
          (i = S),
          (u = n),
          Tp(function (n) {
            function e(n) {
      ...
      syncHeight: function () {
        Gr(T, 'height', T.dom.contentWindow.document.body.scrollHeight + 'px');
      },
      ...
      enter: function () {
        ...
        Mm(g.editor).each(function (n) {
          ...
          h.set({
            ...
            ze(g.container, ci('fullscreen-maximized')),
            Im(g.container, n.body),
            p.maximize(),
            Gr(g.socket, 'overflow', 'scroll'),
            Gr(g.socket, '-webkit-overflow-scrolling', 'touch'),
            No(n.body),
            y.set(
              Bp({
                cWin: n.win,
            ...
            b.set(
              ...
              (a = [
                ...
                Yl(t.doc, 'touchend', function (n) {
                  un(t.html, n.target) || un(t.body, n.target);
                }),
                Yl(r, 'transitionend', function (n) {
                  var e;
                ...
                Yl(t.body, 'touchstart', function (n) {
                  l(), t.onTouchContent(), u.fireTouchstart(n);
                }),
                u.onTouchmove(),
                u.onTouchend(),
                Yl(t.body, 'click', function (n) {
                  n.kill();
                }),
                Yl(r, 'touchmove', function () {
        ...
        p.restore(),
          ...
          h.on(function (n) {
            n.socketHeight.each(function (n) {
              Gr(g.socket, 'height', n);
            }),
              n.iframeHeight.each(function (n) {
                Gr(g.editor.getFrame(), 'height', n);
              }),
          ...
          v.clear(),
          Le(g.container, ci('fullscreen-maximized')),
          Fm(),
          zl(g.toolbar),
          Xr(g.socket, 'overflow'),
          Xr(g.socket, '-webkit-overflow-scrolling'),
          Ho(g.editor.getFrame()),
          Mm(g.editor).each(function (n) {
            n.clearSelection();
          });
      },
  ...
  function jp(n, e, t) {
    n.system.broadcastOn([dr], { command: e, state: t });
  }
  function Np(e) {
    return function () {
      function n() {
  ...
  var Hp = tinymce.util.Tools.resolve('tinymce.EditorManager'),
    Pp = 'toReading',
    zp = 'toEditing';
  sr.add('mobile', function (C) {
    return {
      ...
      renderUI: function () {
        var n,
          ...
          o = {
            content:
              (n = mn.from(C.getParam('skin_url')).getOrThunk(function () {
                return Hp.baseURL + '/skins/ui/oxide';
        ...
        (!1 === C.getParam('skin')) == 0
          ? ((e = ar.DOM.styleSheetLoader),
            C.contentCSS.push(o.content),
            e.load(o.ui, Np(C)),
        ...
        var i,
          ...
          w = Fn().os.isAndroid()
            ? ((i = r),
              (u = Kg({ classes: [ci('android-container')] })),
              (c = Xm()),
              (a = uu()),
              (s = qm(a)),
              (f = Ym()),
            ...
            : ((m = r),
              ...
              g.add(b.component),
              {
                ...
                init: function (r) {
                  h.set(
                    (function () {
                      var n = Pt('Getting IosWebapp schema', Rg, r);
                      Gr(n.toolstrip, 'width', '100%'),
                        Gr(n.container, 'position', 'relative');
                      var e = Vd(
                        $m(function () {
        ...
        function O(n, e, t, o) {
          ...
          w.setToolbarGroups(!0 === o ? c.readOnly : c.main),
            C.setMode(!0 === o ? 'readonly' : 'design'),
            C.fire(!0 === o ? Pp : zp),
            w.updateMode(o);
        }
        function T(n, e) {
          ...
          C.on('init', function () {
            w.init({
              editor: {
                getFrame: function () {
                  return fe.fromDom(
                    C.contentAreaContainer.querySelector('iframe'),
                  );
                },
                ...
                onScrollToCursor: function (e) {
                  return (
                    C.on('ScrollIntoView', function (n) {
                      e(n);
                    }),
                    {
                      unbind: function () {
                        C.off('ScrollIntoView'), E.destroy();
                      },
                    }
                  );
                },
                ...
                onTouchContent: function () {
                  zo(
                    fe.fromDom(
                      C.editorContainer.querySelector('.' + ci('toolbar')),
                    ),
                  )
                    .bind(function (n) {
                ...
                onTapContent: function (n) {
                  var e = n.target;
                  'img' === le(e)
                    ? (C.selection.select(e.dom), n.kill())
                    : 'a' === le(e) &&
                      w.system
                        .getByDom(fe.fromDom(C.editorContainer))
                        .each(function (n) {
                          cr.isAlpha(n) &&
                            (function (n) {
              ...
              toolstrip: fe.fromDom(
                C.editorContainer.querySelector('.' + ci('toolstrip')),
              ),
              toolbar: fe.fromDom(
                C.editorContainer.querySelector('.' + ci('toolbar')),
              ),
            ...
            var t,
              ...
              a = Wl(w, C),
              s = { label: 'The extra group', scrollable: !1, items: [] },
              f = jo([
                {
                  ...
                  items:
                    ((t = a),
                    (e = C.getParam('toolbar', lr, 'array')),
                    (n = (D(e) ? dm : Ul)(e)),
                    (o = {}),
                    B(n, function (n) {
                      var e =
                        !Ie(o, n) && Ie(t, n) && t[n].isSupported()
                          ? [t[n].sketch()]
                          : [];
                      return (o[n] = !0), e;
                    })),
              ...
              d = jo({ backToMask: [u], backToReadOnly: [c] }),
              m = w;
            M(st((r = C).formatter.get()), function (e) {
