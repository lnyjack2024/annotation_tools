...
!(function () {
  ...
  function p(e, t, n) {
    ...
    return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
      (t = t.replace('%D', '%m/%d/%Y')).replace('%r', '%I:%M:%S %p')).replace(
      '%Y',
      '' + n.getFullYear(),
    )).replace('%y', '' + n.getYear())).replace(
      '%m',
      f(n.getMonth() + 1, 2),
    )).replace('%d', f(n.getDate(), 2))).replace(
      '%H',
      '' + f(n.getHours(), 2),
    )).replace('%M', '' + f(n.getMinutes(), 2))).replace(
      '%S',
      '' + f(n.getSeconds(), 2),
  ...
  function y(t, e, n) {
    ...
    c &&
      0 < c.length &&
      (o = r.create('div', null)).appendChild(c[0].cloneNode(!0)),
      O.each(r.select('*', o), function (e) {
        g(
          e,
          t.getParam('template_cdate_classes', 'cdate').replace(/\s+/g, '|'),
        ) &&
          (e.innerHTML = p(
            t,
            t.getParam('template_cdate_format', t.translate('%Y-%m-%d')),
          )),
          g(e, s(t).replace(/\s+/g, '|')) && (e.innerHTML = p(t, m(t))),
          g(
            e,
            t
      ...
      d(t, o),
      t.execCommand('mceInsertContent', !1, o.innerHTML),
      t.addVisual();
  }
  function r() {
    return b;
  ...
  function T(M, t) {
    ...
    !(function () {
      ...
      return M.notificationManager.open({ text: e, type: 'info' }), P.none();
    })().each(function (o) {
      function b(e, t) {
        return {
          ...
          var r,
            ...
            y =
              ...
              -1 === (a = n).indexOf('<html>') &&
                ...
                (l = r.getParam('content_css_cors', !1, 'boolean')
                  ? ' crossorigin="anonymous"'
                  : ''),
                O.each(r.contentCSS, function (e) {
                  o +=
                ...
                c && (o += '<style type="text/css">' + c + '</style>'),
                (i =
                  -1 ===
                ...
                (f = (m = r.getBody().dir) ? ' dir="' + u(m) + '"' : ''),
                (a =
                  '<!DOCTYPE html><html><head><base href="' +
                  u(r.documentBaseURI.getURI()) +
                  '">' +
                  o +
                  s +
                  '</head><body class="' +
            ...
            v = [
              ...
              },
              {
                ...
                html:
                  '<p aria-live="polite">' +
                  t.value.description.replace(/["'<>&]/g, function (e) {
                    return (
                      C((t = A), (n = e)) ? P.from(t[n]) : P.none()
                    ).getOr(e);
                    var t, n;
                  }) +
                  '</p>',
            ...
            h = { template: t.text, preview: y };
          e.unblock(), e.redial(b(v, h)), e.focus('template');
        },
        t = M.windowManager.open(b([], { template: '', preview: '' }));
      t.block('Loading...'),
        u(o[0])
          .then(function (e) {
            c(t, o[0], e);
      ...
      (r = e).on('PreProcess', function (e) {
        ...
        O.each(t.select('div', e.node), function (e) {
          t.hasClass(e, 'mceTmpl') &&
            (O.each(t.select('*', e), function (e) {
              t.hasClass(e, s(r).replace(/\s+/g, '|')) &&
                (e.innerHTML = p(r, n));
            }),
            d(r, e));
        });
