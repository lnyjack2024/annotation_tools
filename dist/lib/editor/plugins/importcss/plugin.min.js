    ...
    v.on('init', function () {
      function o(t, e) {
        if (((f = t), (p = g), !(d(v, (m = e)) ? f in p : f in m.selectors))) {
          ...
          if (r) {
            ...
            return v.formatter.register(n, r), { title: r.title, format: n };
          }
        }
      ...
      x.each(
        (function (c, t, s) {
              ...
              if (
                ...
                x.each(r, function (t) {
                  t.styleSheet
                    ? u(t.styleSheet, !0)
                    : t.selectorText &&
                      x.each(t.selectorText.split(','), function (t) {
                        a.push(x.trim(t));
                      });
                });
              }
          ...
          return a;
        })(v, v.getDoc(), u(v.getParam('importcss_file_filter'))),
        function (r) {
          var t, e, n;
          -1 === r.indexOf('.mce-') &&
            ((c && !c(r)) ||
