...
!(function () {
  ...
  function l(e, t, n) {
    return (
      ...
      (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
        ...
        '%m',
        r(n.getMonth() + 1, 2),
      )).replace('%d', r(n.getDate(), 2))).replace(
        '%H',
        '' + r(n.getHours(), 2),
      )).replace('%M', '' + r(n.getMinutes(), 2))).replace(
        '%S',
        '' + r(n.getSeconds(), 2),
      ...
      )).replace('%A', '' + e.translate(i[n.getDay()]))).replace(
        '%a',
  ...
  function d(e, t) {
    ...
    e.getParam('insertdatetime_element', !1)
      ? ((n = l(e, t)),
        (r = /%[HMSIp]/.test(t) ? l(e, '%Y-%m-%dT%H:%M') : l(e, '%Y-%m-%d')),
        (a = e.dom.getParent(e.selection.getStart(), 'time'))
          ? ((o = a),
            (u = (i = e).dom.create('time', { datetime: r }, n)),
            o.parentNode.insertBefore(u, o),
            i.dom.remove(o),
            i.selection.select(u, !0),
            i.selection.collapse(!1))
          : e.insertContent('<time datetime="' + r + '">' + n + '</time>'))
      : e.insertContent(l(e, t));
  }
  ...
  e.add('insertdatetime', function (e) {
    var t, n, r, a, i, o, u, c;
    (t = e).addCommand('mceInsertDate', function () {
      d(t, t.getParam('insertdatetime_dateformat', t.translate('%Y-%m-%d')));
    }),
      t.addCommand('mceInsertTime', function () {
        d(t, m(t));
      }),
      (u = s((n = e))),
      (r = 0 < (o = s((i = n))).length ? o[0] : m(i)),
      (a = r),
      (c = {
        get: function () {
          return a;
      ...
      n.ui.registry.addSplitButton('insertdatetime', {
        ...
        fetch: function (e) {
          e(
            p.map(u, function (e) {
              return { type: 'choiceitem', text: l(n, e), value: e };
            }),
          );
        },
        onAction: function (e) {
