...
!(function () {
  ...
  function u(t) {
    var e = parseInt(v.getItem(n(t) + 'time'), 10) || 0;
    return !(
      new Date().getTime() - e > o(t.getParam('autosave_retention'), '20m') &&
      (g(t, !1), 1)
    );
  }
  function s(t) {
    ...
    !i(t) &&
      t.isDirty() &&
      (v.setItem(e + 'draft', t.getContent({ format: 'raw', no_events: !0 })),
      v.setItem(e + 'time', new Date().getTime().toString()),
      t.fire('StoreDraft'));
  }
  function f(t) {
    var e = n(t);
    u(t) &&
      (t.setContent(v.getItem(e + 'draft'), { format: 'raw' }),
      t.fire('RestoreDraft'));
  }
  function c(t) {
  ...
  var t = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    v = tinymce.util.Tools.resolve('tinymce.util.LocalStorage'),
    d = tinymce.util.Tools.resolve('tinymce.util.Tools'),
    g = function (t, e) {
      var r = n(t);
      v.removeItem(r + 'draft'),
        v.removeItem(r + 'time'),
        !1 !== e && t.fire('RemoveDraft');
    },
    y = tinymce.util.Tools.resolve('tinymce.EditorManager');
  t.add('autosave', function (t) {
    var e, r, n, a;
    return (
      t.editorManager.on('BeforeUnload', function (t) {
        var e;
        d.each(y.get(), function (t) {
      ...
      (n = e = t),
      (a = o(n.getParam('autosave_interval'), '30s')),
      l.setEditorInterval(
        n,
        function () {
          s(n);
