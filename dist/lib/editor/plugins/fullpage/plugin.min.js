...
!(function () {
  ...
  function c(u, m) {
    u.addCommand('mceFullPageProperties', function () {
      ...
      (t = l = u),
        ...
        w.each(c.getAll('meta'), function (e) {
          var t,
            n = e.attr('name'),
            l = e.attr('http-equiv');
          n
        ...
        (s.stylesheets = []),
        w.each(c.getAll('link'), function (e) {
          'stylesheet' === e.attr('rel') && s.stylesheets.push(e.attr('href'));
        }),
        (r = c.getAll('body')[0]) &&
          ((s.langdir = d(r, 'dir')),
          (s.style = d(r, 'style')),
            ...
            var t = e.getData(),
              n = (function (e, o, t) {
                ...
                w.each(c.getAll('link'), function (e) {
                  ...
                  w.each(o.stylesheets, function (e) {
                    d[e] ||
                      ((a = new f('link', 1)).attr({
                        rel: 'stylesheet',
                        text: 'text/css',
  ...
  function s(e, t, n, l) {
    ...
    l.selection ||
      ...
      ('raw' === l.format && t.get()) ||
        ...
        (m = {}),
        w.each(u.getElementsByTagName('link'), function (e) {
          'stylesheet' === e.rel &&
            e.getAttribute('data-mce-fullpage') &&
            (m[e.href] = e);
        }),
        w.each(s.getAll('link'), function (e) {
          var t = e.attr('href');
          if (!t) return !0;
          m[t] ||
  ...
  e.add('fullpage', function (e) {
    console.warn(
      'The fullpage plugin has been deprecated and marked for removal in TinyMCE 6.0',
    );
    var t,
      o,
      r,
    ...
    c(e, n),
      ...
      (r = n),
      (a = l),
      (o = e).on('BeforeSetContent', function (e) {
        s(o, r, a, e);
      }),
