...
!(function () {
  ...
  function S(n) {
    return void 0 !== n.style && h(n.style.getPropertyValue);
  }
  function E(n) {
  ...
  var T = function (t) {
    ...
    M = {
      ...
      fromPoint: function (n, e, t) {
        return C.from(n.dom.elementFromPoint(e, t)).map(E);
      },
    };
  function k(e) {
    return function (n) {
  ...
  function L(n) {
    var e,
      t = on(n);
    return nn((e = t)) && l(e.dom.host) ? C.some(t) : C.none();
  }
  function H(n) {
  ...
  function j(n, e) {
    var i = n.dom;
    !(function (n) {
      for (var e, t = D(n), r = 0, o = t.length; r < o; r++) {
        var u = t[r];
        (e = n[u]),
          (function (n, e, t) {
            if (!a(t))
      ...
      u = M.fromDom(
        (function (n) {
          if (rn() && l(n.target)) {
            ...
            if (Q(e) && un(e) && n.composed && n.composedPath) {
              var t = n.composedPath();
              if (t) return 0 < (r = t).length ? C.some(r[0]) : C.none();
            }
          }
          var r;
          return C.from(n.target);
        })(n).getOr(n.target),
      ),
      i =
        ((r = t),
  ...
  function B(n, e, t) {
    return (
      ...
      (r = n).dom.addEventListener(o, c, u),
      {
        unbind: (function (r) {
  ...
  function z(n) {
    var e = void 0 === n ? window : n;
    return C.from(e.visualViewport);
  }
  function I(n, e, t, r) {
  ...
  function Y(n) {
    return (
      n.dom ===
      (void 0 !== (e = P(n).dom).fullscreenElement
        ? e.fullscreenElement
        : void 0 !== e.msFullscreenElement
        ? e.msFullscreenElement
        : void 0 !== e.webkitFullscreenElement
  ...
  function G(o, n, e) {
    function t(r) {
      return function (n) {
        ...
        t === r || (q(n, pn, t), j(n, o.parseStyle(r)));
      };
    }
    var r,
      u,
      ...
      s = (function (n) {
        ...
        O(a, function (n) {
          return _(n, '*:not(.tox-silver-sink)');
        }),
      ),
      m =
        ((u = 'background-color'),
        ...
        void 0 !==
          (c =
            '' !== (l = window.getComputedStyle(i).getPropertyValue(u)) || ln(r)
              ? l
              : cn(i, u)) && '' !== c
          ? 'background-color:' + c + '!important'
          : 'background-color:rgb(255,255,255)!important;');
    A(s, t('display:none!important;')),
      A(a, t(vn + yn + m)),
      t((!0 === wn ? '' : vn) + yn + m)(n);
  }
  function J(t, r) {
  ...
  var Q = k(1),
    ...
    nn = k(11),
    en = function (n) {
      return O(n.dom.childNodes, M.fromDom);
    },
    tn = h(Element.prototype.attachShadow) && h(Node.prototype.getRootNode),
    rn = u(tn),
    on = tn
      ? function (n) {
    ...
    ln = function (n) {
      var e = Z(n) ? n.dom.parentNode : n.dom;
      if (null == e || null === e.ownerDocument) return !1;
      var t,
        r,
        o = e.ownerDocument;
      return L(M.fromDom(e)).fold(
        function () {
    ...
    cn = function (n, e) {
      return S(n) ? n.style.getPropertyValue(e) : '';
    },
    fn = function (n, e, t, r) {
    ...
    mn = sn,
    dn = tinymce.util.Tools.resolve('tinymce.dom.DOMUtils'),
    hn = tinymce.util.Tools.resolve('tinymce.Env'),
    gn = tinymce.util.Tools.resolve('tinymce.util.Delay'),
    pn = 'data-ephox-mobile-fullscreen-style',
    vn = 'position:absolute!important;',
    yn =
    ...
    Sn = z().fold(
      ...
      function (e) {
        ...
        return {
          bind: function (n) {
            r.set(n), i(), o.set(U('resize', i)), u.set(U('scroll', i));
          },
          unbind: function () {
            r.on(function () {
              o.clear(), u.clear();
    ...
    En = function (o, u) {
      ...
      function n() {
        ...
        x &&
          ...
          (n = '[' + pn + ']'),
          A(
            (1 !== (e = r = document).nodeType &&
              9 !== e.nodeType &&
              11 !== e.nodeType) ||
              0 === e.childElementCount
              ? []
              : O(r.querySelectorAll(n), M.fromDom),
            function (n) {
              var e = R(n, pn);
              'no-styles' !== e ? j(n, t.parseStyle(e)) : V(n, 'style'),
                V(n, pn);
            },
          )),
          i(bn.removeClass),
          Sn.unbind(),
          C.from(u.get()).each(function (n) {
      ...
      var e,
        ...
        T = u.get(),
        F = M.fromDom(o.getBody()),
        x = hn.deviceType.isTouch(),
        D = b.style,
        k = o.iframeElement.style;
      T
        ? (T.fullscreenChangeHandler.unbind(),
          X(o) &&
            Y(E) &&
            ((l = P(E).dom).exitFullscreen
              ? l.exitFullscreen()
              : l.msExitFullscreen
              ? l.msExitFullscreen()
              : l.webkitCancelFullScreen && l.webkitCancelFullScreen()),
          (k.width = T.iframeWidth),
          (k.height = T.iframeHeight),
          (D.width = T.containerWidth),
          (D.height = T.containerHeight),
          (D.top = T.containerTop),
          (D.left = T.containerLeft),
          (r = T.scrollPos),
        ...
        : ((e = B(
          ...
          (t = {
            scrollPos:
              ...
              (p = g.document),
              (d =
                (m = void 0 !== (s = M.fromDom(p)) ? s.dom : document).body
                  .scrollLeft || m.documentElement.scrollLeft),
              (h = m.body.scrollTop || m.documentElement.scrollTop),
              (v = mn(d, h)),
              z(g).fold(
                function () {
                  var n = g.document.documentElement,
                    e = n.clientWidth,
                    t = n.clientHeight;
                  return I(v.left, v.top, e, t);
                },
                function (n) {
                  return I(
                    Math.max(n.pageLeft, v.left),
                    Math.max(n.pageTop, v.top),
                    n.width,
                    n.height,
                  );
                },
