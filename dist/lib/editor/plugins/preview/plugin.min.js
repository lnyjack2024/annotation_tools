  ...
  e.add('preview', function (e) {
    ...
    (n = e).addCommand('mcePreview', function () {
      ...
      (t = (function (t) {
        ...
        var o = t.getParam('content_css_cors', !1, 'boolean')
        ...
        var a,
          ...
          y =
            -1 ===
            (c = (a = t).getParam('body_id', 'tinymce', 'string')).indexOf('=')
              ? c
              : (s = (r = a).getParam('body_id', '', 'hash'))[r.id] || s,
          u =
            -1 ===
            (m = (d = t).getParam('body_class', '', 'string')).indexOf('=')
              ? m
              : (l = d).getParam('body_class', '', 'hash')[l.id] || '',
          v =
            ...
            (f.mac ? 'e.metaKey' : 'e.ctrlKey && !e.altKey') +
