...
!(function () {
  ...
  function M(e, t) {
    for (var n = 0, r = e.length; n < r; n++) if (t(e[n], n)) return he.some(n);
    return he.none();
  }
  function z(e, t) {
    return (function (e) {
  ...
  var Ke = function (e, t) {
    ...
    et = {
      browsers: J([
        ...
        },
        {
          ...
          search: function (e) {
            return (
              (Re(e, 'safari') || Re(e, 'mobile/')) && Re(e, 'applewebkit')
            );
          },
        },
      ]),
      oses: J([
        ...
        { name: 'Linux', search: Pe('linux'), versionRegexes: [] },
        { name: 'Solaris', search: Pe('sunos'), versionRegexes: [] },
        { name: 'FreeBSD', search: Pe('freebsd'), versionRegexes: [] },
        {
          name: 'ChromeOS',
          search: Pe('cros'),
    ...
    tt = 'Firefox',
    nt = function () {
      return qe({ current: void 0, version: Xe.unknown() });
    },
    rt = qe,
    ot =
      (J('Edge'),
    ...
    st = 'ChromeOS',
    ct = function () {
      return $e({ current: void 0, version: Xe.unknown() });
    },
    lt = $e,
    ft =
      (J(ot),
      ...
      Ae(function () {
        return (
          ...
          (t = he.from(navigator.userAgentData)),
          (n = Le),
          (p = et.browsers()),
          (h = et.oses()),
          (v = t
  ...
  function Qt(e, t) {
    ft().browser.isSafari() && y(e.dom.scrollIntoViewIfNeeded)
  ...
  function en(e) {
    var r = void 0 === e ? window : e,
      ...
      o = Gt(Et.fromDom(t)),
      n = void 0 === r ? window : r;
    return he.from(n.visualViewport).fold(
      function () {
  ...
  function fn(e, t, n) {
    return e.isSome() && t.isSome()
      ? he.some(n(e.getOrDie(), t.getOrDie()))
      : he.none();
  }
  function dn(e) {
  ...
  var Nn,
    ...
    jn = function (e) {
      ...
      return r === n
        ? zn(r.offsetLeft, r.offsetTop)
        : Fn(e)
        ? ((t = n.getBoundingClientRect()), zn(t.left, t.top))
        : zn(0, 0);
    },
    Hn = tn(1),
  ...
  function yr(e, t) {
    return (
      (n = t),
      ze((r = void 0 === e ? document : e.dom))
        ? he.none()
        : he.from(r.querySelector(n)).map(Et.fromDom)
    );
    var n, r;
  }
  function Cr(e, t, n) {
  ...
  var wr,
    ...
    _r =
      ...
      (Ar.resolve = function (t) {
        return t && 'object' == typeof t && t.constructor === Ar
          ? t
          : new Ar(function (e) {
              e(t);
            });
    ...
    try {
      ...
      if (e && ('object' == typeof e || 'function' == typeof e)) {
        ...
        if ('function' == typeof t)
          return void Er(wr(t, e), wr(Rr, this), wr(Dr, this));
      }
  ...
  function Mr(m, g) {
      ...
      t && i.passed.push(t),
        ...
        1 !== i.status &&
          (2 !== i.status
            ? 3 !== i.status
              ? ((i.status = 1),
                pn((c = Et.fromTag('link', b.dom)), {
                  rel: 'stylesheet',
                  type: 'text/css',
                  id: i.id,
                }),
                (l = Date.now()),
                g.contentCssCors && gn(c, 'crossOrigin', 'anonymous'),
                g.referrerPolicy && gn(c, 'referrerpolicy', g.referrerPolicy),
                ((r = c.dom).onload = d),
                (r.onerror = s),
                (f = c),
                In(jt(v), f),
    ...
    function t(e) {
      ...
      ae(h, n).each(function (e) {
        var t;
        0 == --e.count &&
          (delete h[n], (t = e.id), yr(jt(v), '#' + t).each(Mn));
      });
    }
    void 0 === g && (g = {});
    var p = 0,
  ...
  function Wr(e) {
    return (
      Io(e) && (e = e.parentNode), Lo(e) && e.hasAttribute('data-mce-caret')
    );
  }
  function Kr(e) {
  ...
  function Gr(e) {
    ...
    return (
      !!qn(t) &&
      (t.data.charAt(e.offset()) === Oo ||
        (e.isAtStart() && Kr(t.previousSibling)))
    );
  }
  function Jr(e) {
    var t = e.container();
    return (
      !!qn(t) &&
      (t.data.charAt(e.offset() - 1) === Oo ||
        (e.isAtEnd() && Kr(t.nextSibling)))
    );
  }
  function Qr(e) {
    return e && e.hasAttribute('data-mce-caret')
      ? (un((n = (t = e.getElementsByTagName('br'))[t.length - 1])) &&
  ...
  function eo(e) {
    return (
      !Wo(e) && (Ho(e) ? !Vo(e.parentNode) : qo(e) || jo(e) || $o(e) || Ko(e))
    );
  }
  function to(e, t) {
    return (
        ...
        !1 ===
          ...
          qn((i = e)) &&
            ...
            !1 ===
              ((n = i),
              (r = Et.fromDom(a)),
              br(Et.fromDom(n), 'pre,code', A(je, r)).isSome()))) ||
      (Hn((o = e)) &&
        'A' === o.nodeName &&
        !o.hasAttribute('href') &&
  ...
  function mo(e, n) {
    ...
    return (
      e &&
        ((r = {}),
        di((e = 'string' == typeof e ? { '*': e } : e), function (e, t) {
  ...
  function go(i) {
    function e(e, t, n) {
      ...
      return (
        r
          ? (r = fi(r, /[, ]/, fi(r.toUpperCase(), /[, ]/)))
          : (r = ci[e]) ||
            ((r = fi(t, ' ', fi(t.toUpperCase(), ' '))),
            (r = mi(r, n)),
            (ci[e] = r)),
        r
      );
    ...
    var t,
      ...
      m =
        ...
        ci[t] ||
          ...
          di(fo('a form meter progress dfn'), function (e) {
    ...
    function P(e) {
      var a = /^(~)?(.+)$/;
      e &&
        ((ci.text_block_elements = ci.block_elements = null),
        di(fo(e, ','), function (e) {
          var t,
            n = a.exec(e),
            r = '~' === n[1],
          ...
          (l[i] = l[o]),
            (f[i] = o),
            r || ((T[i.toUpperCase()] = {}), (T[i] = {})),
            S[i] ||
              ((t = S[o]),
              delete (t = mi({}, t)).removeEmptyAttrs,
    ...
    di(
      ...
      i.valid_elements
        ...
        : (di(m, function (e, t) {
          ...
          'html5' !== i.schema &&
            di(fo('strong/b em/i'), function (e) {
              var t = fo(e, '/');
          ...
          di(
            fo('p h1 h2 h3 h4 h5 h6 th td pre div address caption li'),
            function (e) {
              S[e].paddEmpty = !0;
            },
          ),
      ...
      i.invalid_elements &&
        di(gi(i.invalid_elements), function (e) {
          S[e] && delete S[e];
        }),
      ...
      parse: function (e) {
        ...
        if (e) {
          for (
            ...
            (x.lastIndex = s.index + s[0].length),
                ...
                -1 === c.indexOf(N) &&
                  ...
                  ('font-weight' === c && '700' === l
                    ...
                    : ('color' !== c && 'background-color' !== c) ||
                      (l = l.toLowerCase()),
                  (l = (l = l.replace(C, po)).replace(w, a)),
                  (p[c] = f ? u(l, !0) : l)));
          t('border', '', !0),
            t('border', '-width'),
            t('border', '-color'),
  ...
  function bo(e, t, n, r) {
    ...
    return (
      ...
      (re((i = t).preventDefault) || vo(i)) &&
        ((a.preventDefault = function () {
          (a.defaultPrevented = !0),
            (a.isDefaultPrevented = x),
            y(t.preventDefault)
              ? t.preventDefault()
              : vo(t) && (t.returnValue = !1);
        }),
        (a.stopPropagation = function () {
          (a.cancelBubble = !0),
            (a.isPropagationStopped = x),
            y(t.stopPropagation)
              ? t.stopPropagation()
              : vo(t) && (t.cancelBubble = !0);
        }),
        (a.stopImmediatePropagation = function () {
          (a.isImmediatePropagationStopped = x), a.stopPropagation();
        }),
        a.isDefaultPrevented !== x &&
          a.isDefaultPrevented !== T &&
          ((a.isDefaultPrevented = !0 === a.defaultPrevented ? x : T),
          (a.isPropagationStopped = !0 === a.cancelBubble ? x : T),
  ...
  var xo = Vr(['h1', 'h2', 'h3', 'h4', 'h5', 'h6']),
    ...
    Ko = function (e) {
      return (
        !1 === (Hn((t = e)) && 'true' === t.getAttribute('unselectable')) &&
        zo(e)
      );
      var t;
    },
        ...
        return e.replace(ri, function (e, t) {
          return t
            ? 65535 <
              ...
              : oi[t] || String.fromCharCode(t)
            : ai[e] ||
                ui[e] ||
                ((n = e),
                ((r = Et.fromTag('div').dom).innerHTML = n),
    ...
    bi =
      ((yi.prototype.bind = function (e, t, n, r) {
        function o(e) {
                            ...
                            n.domLoaded
                              ...
                              : ((r = function () {
                                ...
                                ('interactive' === o.readyState && o.body)
                                  ? r()
                                  : yo(e, 'DOMContentLoaded', r),
                                n.domLoaded || yo(e, 'load', r));
                          })(e, c, f)
                        : yo(e, s || u, c, l)));
          return (e = a = null), n;
        }
  ...
  try {
    Ji.apply((Xi = Qi.call(Ui.childNodes)), Ui.childNodes),
      Xi[Ui.childNodes.length].nodeType;
  } catch (e) {
    Ji = {
      apply: Xi.length
        ? function (e, t) {
  ...
  var ba = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Ui) !== Oi && Di(t),
      (n = n || []),
      !e || 'string' != typeof e)
    )
      return n;
    ...
    if (Pi && !r) {
      if ((o = ga.exec(e)))
        if ((a = o[1])) {
          ...
          if ((a = o[3]) && wi.getElementsByClassName)
            return Ji.apply(n, t.getElementsByClassName(a)), n;
        }
  ...
  function ya() {
    ...
    function r(e, t) {
      return (
        n.push(e + ' ') > xi.cacheLength && delete r[n.shift()],
        (r[e + ' '] = t)
      );
    }
    return r;
  ...
  function Sa(e) {
    return e && typeof e.getElementsByTagName != Wi && e;
  }
  function Ea() {}
  function Na(e) {
  ...
  (wi = ba.support = {}),
    ...
    (Di = ba.setDocument =
      function (e) {
        var t,
          ...
          n = s.defaultView;
        return s !== Oi && 9 === s.nodeType && s.documentElement
          ? ((Bi = (Oi = s).documentElement),
            (Pi = !Ei(s)),
            n &&
              n !==
                (function (e) {
            ...
            (wi.attributes = !0),
            (wi.getElementsByTagName = !0),
            (wi.getElementsByClassName = ma.test(s.getElementsByClassName)),
            (wi.getById = !0),
            (xi.find.ID = function (e, t) {
              if (typeof t.getElementById != Wi && Pi) {
            ...
            (xi.find.TAG = wi.getElementsByTagName
              ? function (e, t) {
                  if (typeof t.getElementsByTagName != Wi)
            ...
            (xi.find.CLASS =
              wi.getElementsByClassName &&
              function (e, t) {
                if (Pi) return t.getElementsByClassName(e);
              }),
            (Ii = []),
            (Li = []),
            (wi.disconnectedMatch = !0),
            (Li = Li.length && new RegExp(Li.join('|'))),
            (Ii = Ii.length && new RegExp(Ii.join('|'))),
            (t = ma.test(Bi.compareDocumentPosition)),
            (Mi =
              t || ma.test(Bi.contains)
                ? function (e, t) {
                        ...
                        (1 &
                          (n =
                            (e.ownerDocument || e) === (t.ownerDocument || t)
                              ...
                              : 1) ||
                        (!wi.sortDetached && t.compareDocumentPosition(e) === n)
                          ? e === s || (e.ownerDocument === Ui && Mi(Ui, e))
                            ? -1
                            : t === s || (t.ownerDocument === Ui && Mi(Ui, t))
                            ? 1
                            : Ti
                            ? Zi.call(Ti, e) - Zi.call(Ti, t)
                            : 0
                          : 4 & n
                          ? -1
                          : 1);
    ...
    (ba.attr = function (e, t) {
      ...
      var n = xi.attrHandle[t.toLowerCase()],
        r =
          n && Ki.call(xi.attrHandle, t.toLowerCase()) ? n(e, t, !Pi) : void 0;
      return void 0 !== r
        ? r
        : wi.attributes || !Pi
        ? e.getAttribute(t)
    ...
    (ba.uniqueSort = function (e) {
      var t,
        ...
        o = 0;
      if (
        ((Ri = !wi.detectDuplicates),
        (Ti = !wi.sortStable && e.slice(0)),
        e.sort($i),
        Ri)
      ) {
      ...
      function (e) {
        ...
        if (o) {
          if (1 === o || 9 === o || 11 === o) {
            ...
            for (e = e.firstChild; e; e = e.nextSibling) n += Si(e);
          } else if (3 === o || 4 === o) return e.nodeValue;
        } else for (; (t = e[r++]); ) n += Si(t);
        return n;
      }),
    ((xi = ba.selectors =
      {
        ...
        preFilter: {
          ATTR: function (e) {
            return (
              (e[1] = e[1].replace(va, Ci)),
              (e[3] = (e[3] || e[4] || e[5] || '').replace(va, Ci)),
              '~=' === e[2] && (e[3] = ' ' + e[3] + ' '),
              e.slice(0, 4)
            );
          },
        ...
        filter: {
          ...
          CLASS: function (e) {
            ...
            return (
              t ||
              ((t = new RegExp('(^|' + ea + ')' + e + '(' + ea + '|$)')) &&
                Hi(e, function (e) {
                  return t.test(
                    ('string' == typeof e.className && e.className) ||
                      (typeof e.getAttribute != Wi &&
          ...
          PSEUDO: function (e, i) {
            var t,
              a =
                xi.pseudos[e] ||
                xi.setFilters[e.toLowerCase()] ||
                ba.error('unsupported pseudo: ' + e);
            return a[Fi]
              ? a(i)
              : 1 < a.length
              ? ((t = [e, e, '', i]),
                xi.setFilters.hasOwnProperty(e.toLowerCase())
                  ? Ca(function (e, t) {
        ...
        pseudos: {
          ...
          lang: Ca(function (n) {
            return (
              ca.test(n || '') || ba.error('unsupported lang: ' + n),
              (n = n.replace(va, Ci).toLowerCase()),
              function (e) {
                var t;
                do {
                  if (
      ...
      }).pseudos.nth = xi.pseudos.eq),
    X(['radio', 'checkbox', 'file', 'password', 'image'], function (e) {
      var t;
      xi.pseudos[e] =
        ((t = e),
        function (e) {
    ...
    (Ea.prototype = xi.filters = xi.pseudos),
    (xi.setFilters = new Ea()),
    (Ni = ba.tokenize =
      function (e, t) {
        var n,
          r,
        ...
        for (a = e, u = [], s = xi.preFilter; a; ) {
          for (i in ((n && !(r = ia.exec(a))) ||
            (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
          (n = !1),
          (r = aa.exec(a)) &&
            ((n = r.shift()),
            o.push({ value: n, type: r[0].replace(oa, ' ') }),
            (a = a.slice(n.length))),
          xi.filter))
            xi.filter.hasOwnProperty(i) &&
              (!(r = la[i].exec(a)) ||
                (s[i] && !(r = s[i](r))) ||
                ((n = r.shift()),
      ...
      function (e, t) {
            ...
            ((i = (function e(t) {
              for (
                ...
                if ((n = xi.relative[t[s].type])) f = [ka(_a(f), n)];
                  ...
                  if (
                    (n = xi.filter[t[s].type].apply(null, t[s].matches))[Fi]
                  ) {
        ...
        function a(e, t, n, r, o) {
          ...
          if (((s += c), b && c !== s)) {
            ...
            if (e) {
              if (0 < s) for (; c--; ) l[c] || f[c] || (f[c] = Yi.call(r));
              f = Aa(f);
            }
            Ji.apply(r, f),
              o && !e && 0 < f.length && 1 < s + v.length && ba.uniqueSort(r);
          }
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          if (
            ...
            9 === t.nodeType &&
            Pi &&
            xi.relative[i[1].type]
          ) {
            if (!(t = (xi.find.ID(a.matches[0].replace(va, Ci), t) || [])[0]))
              return n;
            c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
          }
          for (
            o = la.needsContext.test(e) ? 0 : i.length;
            o-- && ((a = i[o]), !xi.relative[(u = a.type)]);

          )
            if (
              (s = xi.find[u]) &&
              (r = s(
                a.matches[0].replace(va, Ci),
                (pa.test(i[0].type) && Sa(t.parentNode)) || t,
              ))
            ) {
              if ((i.splice(o, 1), !(e = r.length && Na(i))))
                return Ji.apply(n, r), n;
              break;
            }
        }
        return (
          (c || ki(e, l))(r, t, !Pi, n, (pa.test(e) && Sa(t.parentNode)) || t),
          n
        );
      }),
    (wi.sortStable = Fi.split('').sort($i).join('') === Fi),
    (wi.detectDuplicates = !!Ri),
    Di(),
    (wi.sortDetached = !0);
  var Fa = document,
    ...
    qa = function (e, t, n, r) {
      ...
      if (Ra(t)) t = Da(t, Qa(e[0]));
        ...
        else for (o = 0; o < t.length; o++) qa(e, t[o], n, r);
        return e;
      }
  ...
  function Za(e, t, n) {
    var r = [],
      o = e[t];
    for (
      'string' != typeof n && n instanceof ou && (n = n[0]);
      o && 9 !== o.nodeType;
  ...
  (Pa.fn = Pa.prototype =
    {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t)
          for (
            n = ou.unique(this.toArray().concat(ou.makeArray(e))),
      ...
      css: function (t, n) {
        ...
        if ('object' == typeof t)
          ...
          (t = e(t)),
            'number' != typeof n || $a[t] || (n = n.toString() + 'px'),
            a.each(function () {
              var e = this.style;
      ...
      trigger: function (e) {
        return this.each(function () {
          'object' == typeof e ? Ha.fire(this, e.type, e) : Ha.fire(this, e);
        });
      },
      show: function () {
    ...
    (Pa.overrideDefaults = function (n) {
      var r,
        o = function (e, t) {
          return (
            (r = r || n()),
  ...
  var ou = Pa,
    ...
    cu = function (a, u) {
        ...
        return (function (e, t, n) {
          ...
          if (((n = n || e), t)) {
            if (
              n === e &&
              t.getBoundingClientRect &&
              'static' === Cn(Et.fromDom(e), 'position')
            ) {
        ...
        return n
          ...
          : ('float' ===
              (t = t.replace(/-(\D)/g, function (e, t) {
                return t.toUpperCase();
              })) && (t = Ct.browser.isIE() ? 'styleFloat' : 'cssFloat'),
      ...
      function h(e, n, r) {
        ...
        return (
          !!t &&
          (St.isArray(t) && (t.length || 0 === t.length)
            ? ((o = []),
              iu(t, function (e, t) {
      ...
      function S(t, e, n) {
        return h(e, function (e) {
          return (
            St.is(e, 'array') && (t = t.cloneNode(!0)),
            n &&
              iu(au(e.childNodes), function (e) {
                t.appendChild(e);
              }),
      ...
      var _,
        ...
        $ = {
          ...
          getOuterHTML: function (e) {
            ...
            return Hn(t)
              ? t.outerHTML
              : ou('<div></div>').append(ou(t).clone()).html();
          },
          ...
          split: function (e, t, n) {
            ...
            if (e && t)
              return (
                a.setStart(e.parentNode, ru(e)),
                a.setEnd(t.parentNode, ru(t)),
                (r = a.extractContents()),
                (a = N()).setStart(t.parentNode, ru(t) + 1),
                a.setEnd(e.parentNode, ru(e) + 1),
                (o = a.extractContents()),
                (i = e.parentNode).insertBefore(Qo($, r), e),
                n ? i.insertBefore(n, e) : i.insertBefore(t, e),
                i.insertBefore(Qo($, o), e),
                w(e),
                n || t
              );
          },
        ...
        W =
          ...
          (R = (A = u).keep_values) && (t.href = t.src = e),
          t);
      return $;
    };
  ...
  var lu = cu.DOM,
    ...
    du = St.grep,
    mu =
      ((gu.prototype._setReferrerPolicy = function (e) {
  ...
  var vu = {},
    ...
    Cu = function () {
      ...
      function e(e, t, n) {
        void 0 === n && (n = 'added'),
          (Ee(f, e) && 'added' === n) || (Ee(l, e) && 'loaded' === n)
            ? t()
            ...
            e(
              ...
              function () {
                ...
                !e ||
                  (n &&
                    -1 === (',' + (n || '') + ',').indexOf(',' + e + ',')) ||
                  mu.ScriptLoader.add(l[t] + '/langs/' + e + '.js');
              },
              'loaded',
            );
        },
  ...
  function Au(e, t) {
    return ze((n = void 0 === e ? document : e.dom))
      ? []
      : R(n.querySelectorAll(t), Et.fromDom);
    var n;
  }
  function Tu(r, e) {
    function t(e, t) {
  ...
  function Mu(t, e) {
    var i =
      ...
      a = function (e, t, n, r) {
        if (qn(e)) {
          var o = r(e, t, e.data);
          if (-1 !== o) return he.some({ container: e, offset: o });
        }
  ...
  function ju(e, t) {
    ...
    return (
      e.bottom - n < t.top ||
      (!(e.top > t.bottom) && zu(t.top - e.bottom, e, t))
    );
  }
  function Hu(e, t) {
    return (
      e.top > t.bottom || (!(e.bottom < t.top) && zu(t.bottom - e.top, e, t))
    );
  }
  function Vu(e, t, n) {
          ...
          (function (e) {
            ...
            function t(e, t) {
              ...
              if (t < e.data.length) {
                ...
                if (
                  Wu(e.data[t - 1]) &&
                  (n.setStart(e, t), n.setEnd(e, t + 1), !Gu(n))
                )
                  return r(Qu(vs(n), !1)), o;
              }
              0 < t &&
                (n.setStart(e, t - 1),
                n.setEnd(e, t),
            ...
            if (us(n))
              if (e.isAtEnd()) {
                var a = hs(n, i);
                ms(a) && t(a, a.data.length),
                  fs(a) && !gs(a) && r(Qu(vs(a), !1));
              } else {
                if (((a = hs(n, i)), ms(a) && t(a, 0), fs(a) && e.isAtEnd()))
                  return r(Qu(vs(a), !1)), o;
                var u = hs(e.container(), e.offset() - 1);
                fs(u) &&
                  !gs(u) &&
                  ((!cs(u) && !cs(a) && fs(a)) || r(Qu(vs(u), !1))),
                  fs(a) && r(Qu(vs(a), !0));
              }
            return o;
          })(bs(t, n)));
  ...
  function Cs(e, t, n) {
    ...
    Kn(n)
      ? ((i = e),
        (a = t),
        (s = he.from((u = n).firstChild)),
        (c = he.from(u.lastChild)),
        a.insertNode(u),
        s.each(function (e) {
  ...
  function xs(e) {
    var t, r, n, o;
    return (
      (yc(e) ? 'text()' : e.nodeName.toLowerCase()) +
      '[' +
      ((r = Sc(xc((t = e)))),
      (n = me(r, ws(t), t)),
      (o = de(
      ...
      me((r = le(r, rn([t.nodeName]))), ws(t), t) - o) +
      ']'
    );
  }
  function Ss(e, t) {
    ...
    return (
      yc(a)
        ? (n = (function (e, t) {
            for (; (e = e.previousSibling) && yc(e); ) t += e.data.length;
            return t;
          })(a, u))
      ...
      (i = i.concat(ce(o, xs))).reverse().join('/') + ',' + n
    );
  }
  function Es(e, t) {
    if (!t) return null;
    ...
    return i
      ? yc(i)
        ...
        : ((o = 'after' === o ? wc(i) + 1 : wc(i)), bs(i.parentNode, o))
      : null;
  }
  ...
  function Ts(e, t) {
    var n;
    return Hn(e) && ((e = $u(e, t)), Ec(e))
      ? e
      : Xr(e)
      ? ((n = (e = qn(e) && Wr(e) ? e.parentNode : e).previousSibling),
        Ec(n) ? n : ((n = e.nextSibling), Ec(n) ? n : void 0))
      : void 0;
  }
  function Rs(e, t, n) {
    var r = n.getNode(),
    ...
    var a,
      ...
      d,
      m =
        Ts((a = i).startContainer, a.startOffset) ||
        Ts(a.endContainer, a.endOffset);
    return m
      ? { name: (o = m.tagName), index: ks(n.dom, o, m) }
      : ((f = (s = n).dom),
        ((d = {}).start = Ns(f, (u = e), (c = t), (l = i), !0)),
        s.isCollapsed() || (d.end = Ns(f, u, c, l, !1)),
        Zr(l) && (d.isFakeCaret = !0),
        d);
  }
  function Ds(e, t, n) {
    var r = {
  ...
  function Os(e, t) {
    ...
    return (
      i || (s.collapse(!1), Cs(n, s, Ds(n, o + '_end', t))),
      (r = As(r)).collapse(!0),
      Cs(n, r, Ds(n, o + '_start', t)),
  ...
  function Bs(e, t, n) {
    ...
    return -1 === r.indexOf('=')
      ? r
      : ae(e.getParam(t, '', 'hash'), e.id).getOr(n);
  }
  function Ps(e) {
  ...
  function Vs(e) {
    ...
    return (
      !1 !== t &&
      !Ct.iOS &&
      (K(t) ? t : 'table,img,figure.image,div,video,iframe')
    );
  }
  function qs(e) {
  ...
  function Gs(e) {
    for (var t; -1 !== (t = e.data.lastIndexOf(Oo)); ) e.deleteData(t, 1);
  }
  function Js(e, t) {
    return Tc(e), t;
  }
  function Qs(e, t) {
    var n,
      r = t.container(),
      o = (-1 === (n = _(Ce(r.childNodes), e)) ? he.none() : he.some(n))
        .map(function (e) {
  ...
  function Zs(e, t) {
    return bs.isTextPosition(t)
      ? ((r = t),
        Ac((n = e)) && r.container() === n
          ? ((a = Ys((o = n).data.substr(0, (i = r).offset()))),
            (u = Ys(o.data.substr(i.offset()))),
            0 < (a.text + u.text).length
              ? (Gs(o), bs(o, i.offset() - a.count))
              : i)
          : Js(n, r))
      : ((s = e), ((c = t).container() === s.parentNode ? Qs : Js)(s, c));
    var n, r, o, i, a, u, s, c;
  }
  function ec(e, t, n) {
    var r,
  ...
  function tc(e, i, a, u) {
    ...
    return {
      show: function (e, t) {
        ...
        var r = ec(i, t, e);
        ou(l).css('top', r.top);
        var o = ou('<div class="mce-visual-caret" data-mce-bogus="all"></div>')
          .css(ke({}, r))
          .appendTo(i)[0];
        return (
          f.set({ caret: o, element: t, before: e }),
          e && ou(o).addClass('mce-visual-caret-before'),
          (c = Ur.setInterval(function () {
            u()
              ? ou('div.mce-visual-caret', i).toggleClass(
                  'mce-visual-caret-hidden',
                )
              : ou('div.mce-visual-caret', i).addClass(
                  'mce-visual-caret-hidden',
                );
          }, 500)),
  ...
  function oc(e, t) {
    for (var n; (n = e(t)); ) if (!Uc(n)) return n;
    return null;
  }
  function ic(e, t, n, r, o) {
    ...
    if (t < 0) {
      ...
      for (; (e = oc(i.prev.bind(i), o)); ) if (n(e)) return e;
    }
    if (0 < t) {
      if (a && n((e = oc(i.next.bind(i), !0)))) return e;
      for (; (e = oc(i.next.bind(i), o)); ) if (n(e)) return e;
    }
    return null;
  }
  function ac(e, t) {
  ...
  function fc(e, t, n) {
    ...
    if (qn(a)) {
      ...
      if (Fo(a) && u >= a.data.length - 1)
        return 1 === e && (r = i(a)) ? Hc(r) : n;
  ...
  var vc,
    ...
    Ac = qn,
    Tc = function (e) {
      _c(e) && Xr(e) && (Yr(e) ? e.removeAttribute('data-mce-caret') : Xs(e)),
        Ac(e) && (Gs(e), 0 === e.data.length && Xs(e));
    },
    Rc = ft().browser,
    Dc = Jn,
    Oc = Zn,
  ...
  function Gc(o, i, a) {
    return cf(o, i, a).bind(function (e) {
      return uc(a, e, i) &&
        ...
        o
          ? !Yc(t, n) &&
            (bs.isTextPosition((r = t)) || !Xn(r.getNode())) &&
            Xc(t) &&
            Kc(n)
          : !Yc(n, t) && Kc(t) && Xc(n))
        ? cf(o, i, e)
  ...
  function Jc(e, t) {
    ...
    return qn(u)
      ? he.some(bs(u, e ? 0 : u.data.length))
      : u
      ? eo(u)
        ? he.some(e ? bs.before(u) : Xn((a = u)) ? bs.before(a) : bs.after(a))
        : ((r = t),
          (o = u),
          (i = (n = e) ? bs.before(o) : bs.after(o)),
          cf(n, r, i))
      : he.none();
  }
  function Qc(e) {
  ...
  function nl(e, t, n) {
    return (
      ...
      Zc(e, t) &&
      ((o = n),
      (i = (r = t).ownerDocument.createTextNode(Oo)),
      r.appendChild(i),
      o.setStart(i, 0),
      o.setEnd(i, 0),
      1)
    ...
    if (c) {
      if (
        ...
        for (
          a = c.previousSibling,
            i = c.nextSibling,
            St.each(St.grep(c.childNodes), function (e) {
      ...
      if (t) {
        if (el(t))
          return (
            (d = t),
            (m = (f = g).createRng()),
            rl(f, !0, d, m) && rl(f, !1, d, m) ? he.some(m) : he.none()
          );
        if (K(t.start))
          return he.some(
            ((s = t),
            (c = (u = g).createRng()),
            (l = Es(u.getRoot(), s.start)),
            c.setStart(l.container(), l.offset()),
            (l = Es(u.getRoot(), s.end)),
        ...
        if (Ee(t, 'id'))
          return fn(
            ...
            function (e, t) {
              var n = o.createRng();
              return (
                n.setStart(tl(o, e.container()), e.offset()),
        ...
        if (Ee(t, 'name'))
          return (
            (n = g),
            he.from(n.select((r = t).name)[r.index]).map(function (e) {
              var t = n.createRng();
  ...
  function fl(e, t, n) {
    ...
    if (
      ...
      var a = i.childNodes,
        u = void 0;
      o < a.length
        ? ((i = a[o]), (u = new jr(i, e.getParent(i, e.isBlock))))
        : ((i = a[a.length - 1]),
          (u = new jr(i, e.getParent(i, e.isBlock))).next(!0));
  ...
  function dl(e, t, n) {
    if (e) {
      ...
      for (e = n ? e : e[r]; e; e = e[r]) if (Hn(e) || !bf(e)) return e;
    }
  }
  function ml(e, t) {
    return (
  ...
  function kl(e, t) {
    for (var n = t; n; ) {
      if (Hn(n) && e.getContentEditable(n))
  ...
  function Rl(i, e, t, n, a, r) {
    ...
    return o(t, n, Al)
      ...
      .orThunk(function () {
        return u
          ? he.some({ container: u, offset: a ? 0 : u.length })
          : he.none();
      });
  }
  ...
  function Ol(t, e, n, r) {
    var o,
      ...
      s = e[0];
    if (
      ((i = xl(s) && !s.wrapper ? a.getParent(n, s.block, u) : i) ||
      ...
      !(i = (i && xl(s) && s.wrapper && Cf(a, i, 'ul,ol').reverse()[0]) || i))
    )
  ...
  function Ll(e, t, n, r) {
    ...
    var o = t.startContainer,
      ...
      c = n[0];
    return (
      Hn(o) && o.hasChildNodes() && ((o = $u(o, i)), qn(o) && (i = 0)),
      Hn(a) &&
        a.hasChildNodes() &&
        ((a = $u(a, t.collapsed ? u : u - 1)),
        qn(a) && (u = a.nodeValue.length)),
      (o = kl(s, o)),
      (a = kl(s, a)),
      Pl(o) &&
        ((o = yf(o) ? o : o.parentNode),
        (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o),
        qn(o) && (i = t.collapsed ? o.length : 0)),
      Pl(a) &&
        ((a = yf(a) ? a : a.parentNode),
        (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a),
        qn(a) && (u = t.collapsed ? 0 : a.length)),
      t.collapsed &&
        (Rl(s, e.getBody(), o, i, !0, r).each(function (e) {
          var t = e.container,
            n = e.offset;
          (o = t), (i = n);
        }),
      ...
      (El(c) || c.block_expand) &&
        ((El(c) && qn(o) && 0 !== i) || (o = Bl(s, n, o, i, !0)),
        (El(c) && qn(a) && u !== a.nodeValue.length) ||
          (a = Bl(s, n, a, u, !1))),
      Nl(c) &&
        ((o = Dl(s, n, t, o, 'previousSibling')),
        (a = Dl(s, n, t, a, 'nextSibling'))),
      (xl(c) || Sl(c)) &&
        ((o = Ol(e, n, o, 'previousSibling')),
        (a = Ol(e, n, a, 'nextSibling')),
        xl(c) &&
          (s.isBlock(o) || (o = Bl(s, n, o, i, !0)),
          s.isBlock(a) || (a = Bl(s, n, a, u, !1)))),
  ...
  function jl(o, e) {
    return fn(
      ...
      qn(r)
        ? 0 === i
          ? he.some(Et.fromDom(r))
          : he.none()
        : he.from(r.childNodes[i]).map(Et.fromDom)),
      ((t = e.endContainer),
      (n = e.endOffset),
      qn(t)
        ? n === t.data.length
          ? he.some(Et.fromDom(t))
          : he.none()
        : he.from(t.childNodes[n - 1]).map(Et.fromDom)),
      function (e, t) {
        var n = I(Ef(o), A(je, e)),
          r = I(Nf(o), A(je, t));
  ...
  function Hl(e, t, n, r) {
    ...
    do {
      if (qn(n) && 0 !== St.trim(n.nodeValue).length)
      ...
      o = function (e) {
        ...
        switch (
          ...
          Dt(o).fold(
            ...
            function (e) {
              return 'br' === a || (Tn((n = o)) && Wl(n) === Oo)
                ? 'valid'
                : An((t = o)) && _u(t, es())
                ? 'existing'
                : Qc(o.dom)
                ? 'caret'
                : gl(r, i, a) && gl(r, Nt(e), i)
                ? 'valid'
                : 'invalid-child';
              var t, n;
            },
  ...
  function Yl(o) {
    ...
    return {
      ...
      getAll: function (e) {
        ...
        return Z(
          ((t = e),
          (n = Au(Et.fromDom(o.getBody()), '[' + ts() + '="' + t + '"]')),
          (r = {}),
          X(n, function (e) {
            var t = hn(e, ns()),
              n = ae(r, t).getOr([]);
  ...
  function Gl(e) {
    return { getBookmark: A(hf, e), moveToBookmark: A(al, e) };
  }
  ((bc = vc = vc || {})[(bc.Backwards = -1)] = 'Backwards'),
    (bc[(bc.Forwards = 1)] = 'Forwards');
  function Jl(e) {
    return (
      qo(e) ||
      (!!Ko((t = e)) &&
  ...
  var Ql,
    ...
    sf = function (e, t, n) {
      ...
      if (t.isEqual(bs.after(n)) && n.lastChild) {
        if (
          ((i = bs.after(n.lastChild)),
          e < 0 && af(n.lastChild) && rf(n.lastChild))
        )
          return of(n.lastChild) ? bs.before(n.lastChild) : i;
      } else i = t;
      var a,
        u,
        s,
      ...
      if (nf(c)) {
        ...
        if (e < 0 && 0 < l && ((f = qc(c, l - 1)), af(f)))
          return !Jl(f) && (o = ic(f, e, uf, f))
            ? nf(o)
              ? bs(o, o.data.length)
              : bs.after(o)
            : nf(f)
            ? bs(f, f.data.length)
            : bs.before(f);
        if (0 < e && l < c.childNodes.length && ((f = qc(c, l)), af(f)))
          return of(f)
            ? ((a = n),
              (s = (u = f).nextSibling) && af(s)
                ? nf(s)
                  ? bs(s, 0)
                  : bs.before(s)
                : sf(vc.Forwards, bs.after(u), a))
            : !Jl(f) && (o = ic(f, e, uf, f))
            ? nf(o)
              ? bs(o, 0)
              : bs.before(o)
    ...
    bf = function (e, t) {
      return (
        void 0 === t && (t = !1),
        !(!V(e) || !qn(e)) && no(t ? e.data.replace(/ /g, '\xa0') : e.data)
      );
    },
    yf = ul,
    Cf = Cl,
    ...
    Sf = function (e, t, n, r) {
      var o = n.parentNode;
      return (
        !V(n[r]) && (!(o !== t && !re(o) && !e.isBlock(o)) || Sf(e, t, o, r))
      );
    },
    Ef = function (t) {
  ...
  function Of(r, l) {
    ...
    function n(e) {
      ...
      !(function (e, t) {
        if ('longpress' !== e.type && 0 !== e.type.indexOf('touch'))
          return c(e.target) && !Af(e.clientX, e.clientY, t);
        var n = e.touches[0];
    ...
    function d(e) {
      return D.is(e, 'figure.image')
        ? [e.querySelector('img')]
        : D.hasClass(e, 'mce-preview-object') && V(e.firstElementChild)
    ...
    function i(e) {
      ...
      return (
        ...
        e !== l.getBody() &&
        (D.hasClass(e, 'mce-preview-object')
          ? Ue(Et.fromDom(e.firstElementChild), t)
          : Ue(Et.fromDom(e), t))
      );
    }
    function a(e, t, n) {
    ...
    function g(e) {
      ...
      (k = u * b[2] + x),
        ...
        b[2] < 0 &&
          h.clientWidth <= k &&
          D.setStyle(h, 'left', void 0 + (x - k)),
        b[3] < 0 &&
          h.clientHeight <= _ &&
          D.setStyle(h, 'top', void 0 + (S - _)),
        (u = M.scrollWidth - A) + (s = M.scrollHeight - T) != 0 &&
          D.setStyles(v, { left: t - u, top: n - s }),
        N ||
          ((r = p),
          (o = x),
          (i = S),
    ...
    function o(e) {
      ...
      N ||
        l.removed ||
        (O(
          D.select('img[data-mce-selected],hr[data-mce-selected]'),
          function (e) {
            e.removeAttribute(R);
          },
        ),
    ...
    var p,
      ...
      U = function () {
        ...
        (N = !1),
          ...
          D.unbind(B, 'mousemove', g),
          D.unbind(B, 'mouseup', U),
          P !== B && (D.unbind(P, 'mousemove', g), D.unbind(P, 'mouseup', U)),
          D.remove(h),
          D.remove(v),
          D.remove(y),
          z(p),
          o &&
            ...
            D.setAttrib(p, 'style', D.getAttrib(p, 'style'))),
          l.nodeChanged();
      },
      z = function (e) {
        H();
        ...
        i(e) && !r.isDefaultPrevented()
          ? O(F, function (o, i) {
              ...
              e && D.remove(e),
                ...
                11 === Ct.ie && (e.contentEditable = !1),
                D.bind(e, 'mousedown', function (e) {
                  var t, n, r;
                  e.stopImmediatePropagation(),
                    ...
                    (A = M.scrollWidth),
                    (T = M.scrollHeight),
                    (y = D.add(M, 'div', { class: 'mce-resize-backdrop' })),
                    D.setStyles(y, {
                      position: 'fixed',
                      left: '0',
                      top: '0',
                    ...
                    (h = f((n = p))
                      ? D.create('img', { src: Ct.transparentSrc })
                      : n.cloneNode(!0)),
                    D.addClass(h, 'mce-clonedresizable'),
                    D.setAttrib(h, 'data-mce-bogus', 'all'),
                    (h.contentEditable = 'false'),
                    D.setStyles(h, { left: a, top: u, margin: 0 }),
                    m(h, s, c),
                    h.removeAttribute(R),
                    M.appendChild(h),
                    D.bind(B, 'mousemove', g),
                    D.bind(B, 'mouseup', U),
                    P !== B &&
                      (D.bind(P, 'mousemove', g), D.bind(P, 'mouseup', U)),
                    (v = D.add(
                      M,
                      'div',
          ...
          : j(),
          D.getAttrib(p, R) || p.setAttribute(R, o);
      },
      j = function () {
        H(),
          p && p.removeAttribute(R),
          Q(F, function (e, t) {
    ...
    return (
      l.on('init', function () {
        var e;
        s(),
          (Ct.browser.isIE() || Ct.browser.isEdge()) &&
      ...
      try {
        ...
        o = (function (e, n, t) {
          ...
          if (
            ...
            0 <
              (r = (r = St.toArray(i.getClientRects())).sort(function (e, t) {
                return (
  ...
  function Ff(e, t, n) {
    for (
      var r = new jr(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot());
      (t = r[n ? 'prev' : 'next']());
  ...
  function Uf(e, t, n, r, o) {
    ...
    if (r && Xn(o) && t && e.isEmpty(c))
      return he.some(bs(o.parentNode, e.nodeIndex(o)));
    for (var l, f, d = new jr(o, c); (a = d[r ? 'prev' : 'next']()); ) {
      if (
        'false' === e.getContentEditableParent(a) ||
        ((f = u), Xr((l = a)) && !1 === If(l, f, Qc))
      )
        return he.none();
      if (qn(a) && 0 < a.nodeValue.length)
        return !1 ===
          If(a, u, function (e) {
            return 'A' === e.nodeName;
          })
          ? he.some(bs(a, r ? a.nodeValue.length : 0))
          : he.none();
  ...
  function zf(e, t, n, r) {
    ...
    if (
      (Hn(u) && s > u.childNodes.length - 1 && (f = !1),
      Wn(u) && ((u = i), (s = 0)),
      u === i)
    ) {
      ...
      if (u.hasChildNodes()) {
        if (
          ...
          (u = u.childNodes[s]),
          (s = qn(u) && c ? u.data.length : 0),
          !t && u === i.lastChild && Mf(u))
        )
          return he.none();
        if (
          (function (e, t) {
    ...
    return (
      t === r && qn(t)
        ? 0 < n &&
          ...
          ((t = (r = Hf(t, n)).previousSibling),
          n < o
            ? ((t = r = Hf(r, (o -= n)).previousSibling),
        ...
        : (qn(t) &&
          ...
          qn(r) &&
            0 < o &&
            o < r.nodeValue.length &&
            (o = (r = Hf(r, o).previousSibling).nodeValue.length)),
  ...
  var $f = {
    ...
    Wf = Jn;
  (qf.compareRanges = Lf),
    (qf.getCaretRangeFromPoint = Pf),
    (qf.getSelectedNode = qu),
    (qf.getNode = $u);
  var Kf,
    Xf,
    Yf =
      ...
      }),
      {
        set: function (e, t) {
          if (!E(t) && !t.match(/^[0-9]+$/))
            throw new Error(
              Kf + '.set accepts only positive integer values. Value was ' + t,
            );
          var n = e.dom;
  ...
  function td(e, t, n, r, o) {
    ...
    e.fire('ScrollIntoView', i).isDefaultPrevented() ||
      (n(t, Gt(t).top, r, o), e.fire('AfterScrollIntoView', i));
  }
  function nd(e, t, n, r) {
  ...
  function ad(e, t, n, r) {
    ...
    f.top < d.y
      ? Qt(n.element, !1 !== r)
      : f.top > d.bottom && Qt(n.element, !0 === r);
  }
  function ud(e, t, n) {
    return ed(e, id, t, n);
  }
  ...
  function md(e) {
    return (
      void 0 === e && (e = Et.fromDom(document)),
      he.from(e.dom.activeElement).map(Et.fromDom)
    );
  }
  function gd(e, t) {
  ...
  function pd(e) {
    return $d.range(
      e.start,
      gd(e.soffset, e.start),
      e.finish,
      gd(e.foffset, e.finish),
    );
  }
  function hd(e, t) {
  ...
  function yd(e) {
    return $d.range(
      Et.fromDom(e.startContainer),
      e.startOffset,
      Et.fromDom(e.endContainer),
      e.endOffset,
    );
  }
  function Cd(e) {
  ...
  function wd(e) {
    var t,
      n,
      r = bd(e)
        ? ((t = Et.fromDom(e.getBody())),
          ((n = Rt(t).dom.getSelection()) && 0 !== n.rangeCount
            ? he.from(n.getRangeAt(0))
            : he.none()
          )
            .map(yd)
            .filter(vd(t)))
  ...
  function Sd(u) {
    ...
    u.on('init', function () {
      ...
      u.inline &&
        ((t = u),
        (n = s),
        cu.DOM.bind(document, 'mouseup', e),
      ...
      t.on('focusout', function () {
        Ur.setEditorTimeout(t, function () {
          ...
          Ed(
            ...
            (function (e) {
              try {
                return md(Ln(Et.fromDom(e.getElement()))).fold(
                  function () {
  ...
  function kd(e, t) {
    e.focusedEditor === t.editor && (e.focusedEditor = null),
      e.activeEditor || (Xd.unbind(document, 'focusin', Md), (Md = null));
  }
  function _d(t, e) {
    var n, r;
    (n = Et.fromDom(t.getBody())),
      ((r = e).collapsed
        ? he.from($u(r.startContainer, r.startOffset)).map(Et.fromDom)
        : he.none()
      )
        .bind(function (e) {
      ...
      ? (r = e.getBody()) &&
          (dd((t = Et.fromDom(r))) ||
            md(Ln((n = t)))
              ...
              .isSome())
      : e.iframeElement && dd(Et.fromDom(e.iframeElement));
    var t, n, r;
  }
  ...
  var Md,
        ...
        l =
          ...
          (s = (function (e, t) {
            ...
            return Qf(r)
              ...
              ? { element: r, offset: 1 }
              : Tn(r)
              ? { element: r, offset: Wl(r).length }
              : { element: r, offset: On(r).length };
          })(a, u)),
          (c = Et.fromHtml('<span data-mce-bogus="all">\ufeff</span>')),
          Vt(s.element, c),
          Zf(c, function () {
            return Mn(c);
          }));
    ...
    Jd =
      ...
      (Qd.prototype.empty = function () {
        if (this.firstChild) {
          for (var e = [], t = this.firstChild; t; t = Ld(t, this)) e.push(t);
        ...
        if (r)
          do {
            ...
            if (
              ...
              return !1;
            if (3 === r.type && r.parent && t[r.parent.name] && no(r.value))
              return !1;
            if (n && n(r)) return !1;
          } while ((r = Ld(r, this)));
        return !0;
  ...
  function tm(W, K) {
    ...
    void 0 === K && (K = go());
    var X =
        null !== (e = (W = W || {}).document) && void 0 !== e ? e : document,
      ...
      for (
        var t,
          ...
          B = function (e, t, n, r, o) {
            ...
            if (
              ((n = Zd(
                ((t = t.toLowerCase()) in F) ? t : N(n || r || o || ''),
                m,
              )),
              U &&
                !p &&
            ...
            if (
              ...
              if (k[t] && !W.allow_script_urls) {
                ...
                if (
                  ((c = d),
                  (l = e),
                  !(s = W).allow_html_data_urls &&
                    (/^data:image\//i.test(c)
                      ? !(re((f = s.allow_svg_data_urls)) ? ie(nm, l) : f) &&
                        /^data:image\/svg\+xml/i.test(c)
                      : /^data:/i.test(c)))
                )
                  return;
              }
              (p && ((t in k) || 0 === t.indexOf('on'))) ||
                ((g.map[t] = n), g.push({ name: t, value: n }));
            }
          },
          P = new RegExp(
        ...
        var q = t[0];
        if ((x < t.index && R(N(w.substr(x, t.index - x))), (i = t[7])))
          T((i = ':' === (i = i.toLowerCase()).charAt(0) ? i.substr(1) : i));
        else if ((i = t[8])) {
          ...
          (u =
            ...
            I),
            j && M[i] && 0 < S.length && S[S.length - 1].name === i && T(i);
          var $ = (function (e, t) {
            var n = e.exec(t);
            if (n) {
              var r = n[1],
          ...
          if (!U || (s = K.getElementRule(i))) {
            if (
              ...
              (f = t[9])
                ? ((p = -1 !== f.indexOf('data-mce-type')) && z && (c = !1),
                  ((g = []).map = {}),
                  f.replace(L, function (e, t, n, r, o) {
                    return B(i, t, n, r, o), '';
                  }))
                : ((g = []).map = {}),
              U && !p)
              ...
              if (
                ...
                (b = s.attributesDefault),
                (y = s.attributesForced),
                s.removeEmptyAttrs && !g.length && (c = !1),
                y)
              )
                for (r = y.length; r--; )
                  (a = (l = y[r]).name),
                    '{$uid}' === (C = l.value) && (C = 'mce_' + E++),
                    (g.map[a] = C),
                    g.push({ name: a, value: C });
              if (b)
                for (r = b.length; r--; )
                  (a = (l = b[r]).name) in g.map ||
                    ('{$uid}' === (C = l.value) && (C = 'mce_' + E++),
                    (g.map[a] = C),
                    g.push({ name: a, value: C }));
              if (d) {
  ...
  function pm(e) {
    ...
    return (
      qn(t) &&
      (0 === t.data.length || (Bo(t.data) && Gl.isBookmarkNode(t.parentNode)))
    );
  }
  function hm(t, n) {
    return function (e) {
  ...
  function bm(e) {
    return (
      Jn(e) && !(Hn((t = e)) && 'all' === t.getAttribute('data-mce-bogus'))
    );
    var t;
  }
  function ym(e) {
  ...
  function Rm(e, t) {
    return (
      he.from(t.getNode(!0)).map(Et.fromDom).exists($r) || Am(!1, e, t).isSome()
    );
  }
  function Dm(e) {
  ...
  function Fm(e, t) {
    return (
      ...
      Mm(
        ...
        ((r = (n = t).container()),
        (o = n.offset()),
        qn(r) && o < r.data.length ? bs(r, o + 1) : n),
      )
    );
    var n, r, o;
  }
    ...
    return he
      ...
      .bind(function (e) {
        var t,
          ...
          d = (i = l).data,
          m = bs(i, 0);
        return (!Um(d, 0) || Fm(f, m)
          ? ((s = (a = l).data),
            (c = R((u = s.split('')), function (e, t) {
              return vf(e) &&
                0 < t &&
                t < u.length - 1 &&
                cl(u[t - 1]) &&
  ...
  function Hm(t) {
    ...
    t.selection.isCollapsed() &&
      jm(e, bs.fromRangeStart(t.selection.getRng())).each(function (e) {
  ...
  function Vm(e, t, n) {
    var r, o, i, a, u, s, c, l;
    0 !== n &&
      ((o = hr((r = Et.fromDom(e)), So).getOr(r)),
      (i = e.data.slice(t, t + n)),
      (a = t + n >= e.data.length && Mm(o, bs(e, e.data.length))),
      (u = 0 === t && Im(o, bs(e, 0))),
      e.replaceData(
        t,
        n,
          ...
          function (e, t) {
            return sl(t) || vf(t)
              ? e.previousCharIsSpace ||
                ...
                ? { previousCharIsSpace: !1, str: e.str + Do }
  ...
  function Km(e, t) {
    return (
      ...
      (o = (n = t).container()),
      (i = n.offset()),
      !1 === bs.isTextPosition(n) &&
      o === r.parentNode &&
      i > bs.before(r).offset()
        ? bs(t.container(), t.offset() - 1)
        : t
    );
    var n, r, o, i;
  }
  function Xm(e) {
    return eo(e.previousSibling)
      ? he.some(
          ((t = e.previousSibling), qn(t) ? bs(t, t.data.length) : bs.after(t)),
        )
      : e.previousSibling
      ? gf(e.previousSibling)
      : he.none();
    var t;
  }
  function Ym(e) {
    return eo(e.nextSibling)
      ? he.some(((t = e.nextSibling), qn(t) ? bs(t, 0) : bs.before(t)))
      : e.nextSibling
      ? mf(e.nextSibling)
      : he.none();
    var t;
  ...
  function Gm(r, o) {
    return Xm(o)
      ...
      .orThunk(function () {
        return (
          (e = r),
          (n = bs.before((t = o).previousSibling || t.parentNode)),
          df(e, n).fold(function () {
  ...
  function tg(t, n, e, r) {
    ...
    var o,
      ...
      C =
        ((u = b),
        (i = a = e),
        (s = Ee(t.schema.getTextInlineElements(), Nt(i))),
        (m = Ot(a).filter(Tn)),
        (g = Bt(a).filter(Tn)),
        Mn(a),
        (l = g),
        ...
        ((c = m).isSome() && l.isSome() && f.isSome()
          ? he.some(d(c.getOrDie(), l.getOrDie(), f.getOrDie()))
          : he.none()
        ).orThunk(function () {
          return (
            s &&
  ...
  function ug(e) {
    return function (t) {
      return ag(t, e).map(function (e) {
        return { rng: t, table: e, cells: ng(e) };
      });
    };
  }
  function sg(e, t, n, r) {
  ...
  function lg(n) {
    return fn(
      cg(n.cells, n.rng.start),
      cg(n.cells, n.rng.end),
      function (e, t) {
  ...
  function dg(e, t) {
    ...
    return (
      ...
      y.exists(function (e) {
        ...
        : C.isMultiTable
        ? sg(y, (u = C), (s = t), b).bind(function (e) {
            var t = e.start,
              n = e.end,
              r = t.bind(lg).getOr([]),
              o = n.bind(lg).getOr([]);
        ...
        : sg(y, (i = C), (a = t), b)
            ...
            .bind(function (e) {
              ...
              if (t && e.cells.length === n.length)
                return he.some(gp.fullTable(e.table));
              if (0 < n.length) {
                if (t) return he.some(gp.partialTable(n, he.none()));
                var r = fg(a, i);
                return he.some(
                  gp.partialTable(n, he.some(ke(ke({}, i), { rng: r }))),
                );
              }
              return he.none();
            })
  ...
  function gg(e, t) {
    ...
    e.selection.setCursorLocation(t.dom, 0),
      1 < n.length && gn(t, 'data-mce-selected', '1');
  }
  function pg(u, e, t) {
    return (
      mg(e),
      t.map(function (e) {
        var t,
          ...
          a =
            ...
            he.from(u.dom.getParent(t, u.dom.isBlock)).map(Et.fromDom));
        o.deleteContents(),
          (n = u),
          (r = i),
          a.filter(oo).each(function (e) {
  ...
  function vg(e, t, n) {
    ...
    return (
      oo(i) && (ym(i), e.selection.setCursorLocation(i.dom, 0)),
      je(n, i) ||
        X(
          (ln(Dt(i), n)
            ? []
    ...
    return hp(m, s).fold(
      function () {
        return (
          ...
          (a = m),
          (e = s),
          (u = bs.fromRangeStart(o.selection.getRng())),
          yg(a, e)
            .bind(function (e) {
              return oo(e)
                ? vp(o, e)
                : ((t = a),
                  (n = e),
                  (r = u),
                  Gc(i, o.getBody(), r).bind(function (e) {
            ...
            .getOr(!1) ||
            ((n = d),
            (r = bs.fromRangeStart((t = f).selection.getRng())),
            Cg(n, r) ||
              cf(n, t.getBody(), r).exists(function (e) {
                return Cg(n, e);
              }))
        );
        var o, i, a, e, u, t, n, r;
      ...
      function (e) {
        return (
          ...
          (r = m),
          (o = e),
          (i = bs.fromRangeStart((t = f).selection.getRng())),
          (oo(o)
            ? vp(t, o)
            : ((u = r),
              (c = o),
              (l = i),
              Gc((s = n), (a = t).getBody(), l)
                .bind(function (e) {
                  return (
                    (r = s),
                    (o = l),
                    ...
                    mf((n = c).dom)
                      ...
                      ? vp(a, c)
                      : ((t = c),
                        hp(u, Et.fromDom(e.getNode())).map(function (e) {
                          return !1 === je(e, t);
                        }))
                  );
                  var t, n, r, o, i;
  ...
  function Sg(e) {
    return e.collapsed
      ? e
      : ((a = e),
        (u = bs.fromRangeStart(a)),
        (s = bs.fromRangeEnd(a)),
        (c = a.commonAncestorContainer),
        cf(!1, c, s)
          .map(function (e) {
            return !uc(u, s, c) && uc(u, e, c)
              ? ((t = u.container()),
                (n = u.offset()),
                (r = e.container()),
                (o = e.offset()),
      ...
      r &&
        (r.isEmpty(o) ||
          ...
          n.getBlockElements()[i.name] &&
            ...
            ('br' === (a = i.firstChild).name || a.value === Do))) &&
        (s = s.prev),
  ...
  function Ag(e, o, i, t) {
    ...
    return n(1)
      ? ((S = D),
        (_ = (x = T).parentNode),
        St.each(R, function (e) {
          _.insertBefore(e, x);
        }),
        (E = S),
        (N = bs.before(x)),
        (k = Wc(E).next(N)) ? k.toRange() : null)
      : n(2)
      ? ((l = T), (d = D), o.insertAfter((f = R).reverse(), l), _g(f[0], d))
      : ((g = R),
        (p = D),
        (h = m = T),
        (b = (v = i).cloneRange()),
        ...
        (w = m.parentNode).insertBefore(C[0], m),
        St.each(g, function (e) {
          w.insertBefore(e, m);
        }),
        w.insertBefore(C[1], m),
        w.removeChild(m),
        _g(g[g.length - 1], p));
  }
  function Tg(e, t, n) {
    ...
    /^ | $/.test(t) &&
      ...
      (o = u.getRng()),
      (i = t),
      (i = Im((a = Et.fromDom(r.getRoot())), bs.fromRangeStart(o))
        ? i.replace(/^ /, '&nbsp;')
        : i.replace(/^&nbsp;/, ' ')),
      (t = i =
        Mm(a, bs.fromRangeEnd(o))
          ? i.replace(/(&nbsp;| )(<br( \/)>)?$/, '&nbsp;')
          : i.replace(/&nbsp;(<br( \/)?>)?$/, ' ')));
    var c = e.parser,
      l = n.merge,
    ...
    if (m.isDefaultPrevented())
        ...
        u.isCollapsed() ||
          (function (e) {
            ...
            var r,
              ...
              i = n;
            null !== (r = o) &&
            r === t.getParent(i.endContainer, bp) &&
            jl(Et.fromDom(r), i)
              ? vg(e, n, Et.fromDom(o))
      ...
      var b,
        ...
        B = c.parse(t, O);
      if (!0 === n.paste && Eg(e.schema, B) && kg(s, I))
        return (
          (g = Ag(f, s, u.getRng(), B)),
          u.setRng(g),
      ...
      (E = l),
        ...
        E &&
          ((N = S.getBody()),
          (k = am(A)),
          St.each(A.select('*[data-mce-fragment]'), function (e) {
            if (
          ...
          if (e) {
            ...
            qn(s)
              ? (u.setStart(s, s.nodeValue.length),
                Ct.ie ||
                  ((a = e.nextSibling),
                  qn(a) && (s.appendData(a.data), a.parentNode.removeChild(a))))
        ...
        (T = e.getBody()),
        St.each(T.getElementsByTagName('*'), function (e) {
          e.removeAttribute('data-mce-fragment');
        }),
        (R = s),
        (D = u.getStart()),
        he.from(R.getParent(D, 'td,th')).map(Et.fromDom).each(Cm),
        e.fire('SetContent', m),
        e.addVisual();
    }
  }
  ...
  function Og(u, s, e) {
    var c = e.no_events
      ...
      : u.fire(
          'BeforeSetContent',
          ke(ke({ format: 'html' }, e), { set: !0, content: Rg(s) ? '' : s }),
        );
    return (
      Rg(s) || (s = c.content),
      he.from(u.getBody()).fold(J(s), function (e) {
        return Rg(s)
          ? (function (e, t, n, r) {
              var o, i, u, a;
              ...
              return (
                (r.content = To(Et.fromDom(t)) ? s : St.trim(s)),
                Dg(e, r.content, r.no_selection),
              ...
              ? ((i = '<br data-mce-bogus="1">'),
                ...
                (r =
                  ...
                  t.schema.isValidChild(
                    ...
                    ? ((r = i), t.dom.createHTML(a, Is(t), r))
                    : r || '<br data-mce-bogus="1">'),
                Dg(t, r, o.no_selection),
                t.fire('SetContent', o))
              : ('raw' !== o.format &&
                  (r = sm({ validate: t.validate }, t.schema).serialize(
                    t.parser.parse(r, { isRootContent: !0, insert: !0 }),
                  )),
                (o.content = To(Et.fromDom(n)) ? r : St.trim(r)),
                Dg(t, o.content, o.no_selection),
    ...
    if (a)
      if (b(a.length)) {
        ...
        for (var f = 0; f < a.length; f++)
          if ('attributes' === r ? e.getAttrib(t, a[f]) : bl(e, t, a[f]))
            return 1;
    return 1;
  }
  ...
  function jg(e) {
    if (e) {
      var t = new jr(e, e);
      for (e = t.current(); e; e = t.next()) if (qn(e)) return e;
    }
    return null;
  }
  function Hg(e) {
    ...
    return (
      pn(t, { id: Sp, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
      e && In(t, Et.fromText(xp)),
      t
    );
  }
  function Vg(e, t, n) {
    ...
    zg(t)
      ...
      : ((r = d.getRng()),
        ...
        (u = r.endContainer),
        (s = r.endOffset),
        (l = jg(t)) && l.nodeValue.charAt(0) === xp && l.deleteData(0, 1),
        (c = l),
        f.remove(t, !0),
        i === c && 0 < a && r.setStart(c, a - 1),
        u === c && 0 < s && r.setEnd(c, s - 1),
        o && f.isEmpty(o) && ym(Et.fromDom(o)),
        d.setRng(r));
  }
  function qg(e, t, n) {
    void 0 === n && (n = !0);
  ...
  function Xg(e, t, n, r) {
    ...
    for (
      3 === S.nodeType &&
      (E !== S.nodeValue.length && (o = !0), (N = N.parentNode));
      N;
    ...
    i &&
      (o
        ? ((a = C.getBookmark()),
          x.collapse(!0),
          (u = Vf(Ll(e, x, e.formatter.get(t), !0))),
          e.formatter.remove(t, n, u, r),
          C.moveToBookmark(a))
        : ((s = Zc(e.getBody(), i)),
          (d = c = Hg(!1).dom),
          (p = (g = e.dom).getParent((m = null !== s ? s : i), A(ml, e))) &&
          g.isEmpty(p)
            ...
            : ((h = Et.fromDom(m)),
              ...
              v.length === b.length && X(b, Mn),
              g.isEmpty(m)
                ? m.parentNode.replaceChild(d, m)
                : g.insertAfter(d, m)),
          (l = Kg(e, c, i, t, n, r)),
          (f = Wg(w.concat(l.toArray()), c)),
          Vg(e, s, !1),
  ...
  var Gg,
    ...
    pp = function (e) {
      var t;
      return (8 === kt((t = e)) || '#comment' === Nt(t) ? Ot : Ft)(e)
        .bind(pp)
        .orThunk(function () {
          return he.some(e);
        });
  ...
  function Tp(e, t, n) {
    ...
    if (
      ...
      return (
        e.remove(n),
        St.each(St.grep(n.childNodes), function (e) {
          t.appendChild(e);
        }),
        t
      );
  ...
  function Pp(e, t, n) {
    ...
    return (
      ...
      qn(o) &&
        ...
        (o = new jr(o, e.getBody()).next() || o),
      (qn(o) && !n && 0 === i && new jr(o, e.getBody()).prev()) || o
    );
  }
  function Lp(e, t) {
  ...
  function Up(e, r, o, t, i) {
    ...
    if (
      !(
        (El((a = r)) && Dh(c, a.inline)) ||
        (xl(a) && Dh(c, a.block)) ||
        (Sl(a) && Hn(c) && s.is(c, a.selector)) ||
    ...
    if (El(r) && 'all' === r.remove && S(r.preserve_attributes)) {
      ...
      if (
        ...
        return Ah.rename('span');
    }
    if ('all' !== r.remove) {
      Rh(r.styles, function (e, t) {
        (e = vl(u, pl(e, o), t + '')),
          E(t) && ((t = e), (i = null)),
          (!r.remove_similar && i && !Dh(bl(u, i, t), e)) ||
            u.setStyle(b, t, ''),
          (n = !0);
      }),
        n &&
        ...
        Rh(r.attributes, function (e, t) {
          var n;
          if (
            ((e = pl(e, o)),
            E(t) && ((t = e), (i = null)),
            r.remove_similar || !i || Dh(u.getAttrib(i, t), e))
          )
            if (
              'class' === t &&
              (e = u.getAttrib(b, t)) &&
              ...
              if (
                (Th.test(t) && b.removeAttribute('data-mce-' + t),
                'style' === t &&
                  rn(['li'])(b) &&
    ...
    return 'none' !== r.remove
      ? ((l = e),
        ...
        xl(d) &&
          (v
            ? p === h.getRoot() &&
              ((d.list_block && Dh(f, d.list_block)) ||
                X(Ce(f.childNodes), function (e) {
                  gl(l, v, e.nodeName.toLowerCase())
                    ? m
                      ? m.appendChild(e)
                      : ((m = Ip(h, e, v)),
            ...
            : h.isBlock(f) &&
              !h.isBlock(p) &&
              (Fp(h, f, !1) ||
                Fp(h, f.firstChild, !0, !0) ||
                f.insertBefore(h.create('br'), f.firstChild),
              Fp(h, f, !0) ||
                Fp(h, f.lastChild, !1, !0) ||
                f.appendChild(h.create('br')))),
        (Sl((g = d)) && El(g) && ln(ae(g, 'mixed'), !0) && !Dh(d.inline, f)) ||
          h.remove(f, !0),
        Ah.removed())
      : Ah.keep();
  }
  function zp(t, e, n, r, o) {
    return Up(t, e, n, r, o).fold(
      T,
      function (e) {
  ...
  function jp(u, s, c, e, l) {
    function a(e) {
      var n,
        ...
        t =
          ...
          (o = c),
          (i = l),
          X(Cl((n = u).dom, e.parentNode).reverse(), function (e) {
            var t;
            a ||
              '_start' === e.id ||
              '_end' === e.id ||
              ((t = wp(n, e, r, o, i)) && !1 !== t.split && (a = e));
          }),
          a);
    ...
    var n,
      ...
      v = function (t) {
        ...
        if (
          (p &&
            !n &&
            ((r = f(t)), (o = t.parentNode), !r && V(o) && Nl(g) && f(o)),
          g.deep && i.length)
        ) {
    ...
    if ('false' !== h.getContentEditable(r.getNode()))
      r.isCollapsed() && El(g) && !Ul(u).length
        ? Xg(u, s, c, l)
        : ($l(r, !0, function () {
            ql(u, t);
          }),
          El(g) && Ug(u, s, c, r.getStart()) && fl(h, r, r.getRng()),
          u.nodeChanged()),
        Df(u, s, e, c);
    else {
      e = r.getNode();
      for (
        var o = 0;
        o < m.length && (!m[o].ceFalseOverride || !zp(u, m[o], c, e, e));
        o++
      );
      Df(u, s, e, c);
    }
      ...
      X(l.split(','), function (t) {
        ...
        var n,
          r = ae(g, t).getOrThunk(function () {
            var e = {
              withSimilar: { state: pu(!1), similar: !0, callbacks: [] },
              withoutSimilar: { state: pu(!1), similar: !1, callbacks: [] },
              withVars: [],
            };
            return (g[t] = e);
          });
        ...
        unbind: function () {
          ...
          X(t.split(','), function (t) {
            return ae(r, t).each(function (e) {
              r[t] = {
                withSimilar: ke(ke({}, e.withSimilar), {
                  callbacks: U(e.withSimilar.callbacks, function (e) {
                    return e !== n;
                  }),
                }),
                withoutSimilar: ke(ke({}, e.withoutSimilar), {
  ...
  function eh(e) {
    var o = Xp(Pu(e), 0, []);
    return (
      X(Au(e, 'tr'), function (n, r) {
        X(Au(n, 'td,th'), function (e, t) {
          !(function (e, t, n, r, o) {
            for (
              var i = Gp(o, 'rowspan'), a = Gp(o, 'colspan'), u = e.rows, s = n;
              s < n + i;
              s++
            ) {
              u[s] || (u[s] = Yp(Lu(r), []));
            ...
            .bind(function (u) {
              return Qp(s, t).map(function (e) {
                return (
                  ...
                  (r = u.y),
                  (o = e.x),
                  (a = r < (i = e.y) ? Zp(t, n, r, o, i) : Zp(t, n, i, o, r)),
                  Xp(t.element, Jp(a), a)
                );
                var t, n, r, o, i, a;
              });
  ...
  function ch(n) {
    var e,
      t = z(
        ((e = n.getBody()),
        U(R(Ce(e.childNodes), uh), function (e) {
          return 0 < e.length;
        })),
        function (e) {
  ...
  function mh(e, t) {
    return (
      !(!e || !t) && ((r = t), fh(e) === fh(r) || ((n = t), dh(e) === dh(n)))
    );
    var n, r;
  }
  function gh(e) {
      ...
      undoManager: {
        ...
        add: function (e, t, n, r, o, i) {
          return (function (e, t, n, r, o, i, a) {
            var u = ch(e);
            if (((i = St.extend((i = i || {}), u)), !1 === gh(r) || e.removed))
              return null;
            var s = t.data[n.get()];
            if (
              e
        ...
        undo: function (e, t, n) {
          return (
            ...
            (i = t),
            (a = n),
            (o = e).typing && (o.add(), (o.typing = !1), ph(o, !1, i)),
            0 < a.get() &&
              (a.set(a.get() - 1),
              lh(r, (u = o.data[a.get()]), !0),
              r.setDirty(!0),
              r.fire('Undo', { level: u })),
            u
          );
        ...
        hasUndo: function (e, t) {
          return (
            (n = c),
            (r = e),
            0 < t.get() || (r.typing && r.data[0] && !mh(ch(n), r.data[0]))
          );
          var n, r;
        },
        ...
        transact: function (e, t, n) {
          return (
            (o = n), hh((r = e), t), r.beforeChange(), r.ignore(o), r.add()
          );
          var r, o;
        },
        ignore: function (e, t) {
      ...
      formatter: {
        ...
        canApply: function (u) {
          return (function (e) {
            ...
            if (t)
              for (
                var r = Cl(n, e.selection.getStart()), o = t.length - 1;
                0 <= o;
                o--
              ) {
                var i = t[o];
        ...
        toggle: function (e, t, n) {
          ...
          (!Ug(r, o, i, a) || ('toggle' in u[0] && !u[0].toggle) ? Ph : jp)(
            r,
            o,
            i,
            a,
      ...
      editor: {
        getContent: function (e, t) {
          return (
            ...
            he
              .from(f.getBody())
              .fold(
                J('tree' === d.format ? new Jd('body', 11) : ''),
                function (e) {
                  return (
                    (t = f),
                    (r = m),
                    ...
                    (c = (n = d).no_events
                      ...
                      : t.fire(
                          'BeforeGetContent',
                          ke(ke({}, n), { format: r, get: !0, getInner: !0 }),
                        )),
                    (l =
                      'raw' === c.format
                        ? St.trim(cm(t.serializer, o.innerHTML))
                        : 'text' === c.format
                        ? t.dom.isEmpty(o)
                          ? ''
                          : Po(o.innerText || o.textContent)
                        : 'tree' === c.format
                        ? t.serializer.serialize(o, c)
                        : ((a = (i = t).serializer.serialize(o, c)),
                          (u = Ls(i)),
                          (s = new RegExp(
                            '^(<' +
                              u +
                          ...
                          a.replace(s, ''))),
                    ie(['text', 'tree'], c.format) || To(Et.fromDom(o))
                      ? (c.content = l)
                      : (c.content = St.trim(l)),
                    (c.no_events ? c : t.fire('GetContent', c)).content
                  );
        ...
        addVisual: function (e) {
          ...
          b(i.hasVisual) && (i.hasVisual = i.getParam('visual', !0, 'boolean')),
            X(a.select('table,a', n), function (e) {
              switch (e.nodeName) {
                case 'TABLE':
                  var t = i.getParam(
                      'visual_table_class',
        ...
        getContent: function (e, t) {
          return (function (e, t, n) {
            ...
            if (r.isDefaultPrevented())
              return e.fire('GetContent', r), r.content;
            if ('text' === r.format)
              return (
                (f = e),
                he
                  .from(f.selection.getRng())
                  .map(function (e) {
                    var t = he.from(
                        f.dom.getParent(
                      ...
                      a = ah(i, o),
                      u = Po(i.textContent);
                    if ((f.dom.remove(i), ih(u, 0) || ih(u, u.length - 1))) {
            ...
            var o,
              ...
              d =
                ((i = r),
                (a = (o = e).selection.getRng()),
                (u = o.dom.create('body')),
                (s = o.selection.getSel()),
                (c = Pd(o, Ml(s))),
                (l = i.contextual
                  ? oh(Et.fromDom(o.getBody()), c).dom
                  : a.cloneContents()) && u.appendChild(l),
                o.selection.serializer.serialize(u, i));
            return 'tree' === r.format
              ? d
              : ((r.content = e.selection.isCollapsed() ? '' : d),
                e.fire('GetContent', r),
                r.content);
          })(c, e, t);
        },
  ...
  function Sh(e, t, u, s) {
    e.bind(function (a) {
      return (
        (s ? $m : qm)(a.dom, s ? a.dom.length : 0),
        t.filter(Tn).map(function (e) {
          var t = u,
            n = s,
            r = a.dom,
            o = e.dom,
            i = (n ? r : o).length;
          n
            ? (Wm(r, o, !1, !n), t.setStart(o, i))
            : (Wm(o, r, !1, !n), t.setEnd(o, i));
        })
      );
    }).orThunk(function () {
      var e = s;
      return t
        ...
        .map(function (e) {
          ...
          Dt((n = e)).each(function (e) {
            ...
            r && Im(e, bs(t, 0))
              ? qm(t, 0)
              : !r && Mm(e, bs(t, t.length)) && $m(t, t.length);
          });
        });
    });
  }
  function Eh(e, t, n) {
    var r,
      o =
        ((r = t),
        ke(ke({ format: 'html' }, (n = void 0 === n ? {} : n)), {
          set: !0,
          selection: !0,
          content: r,
        })),
    ...
    Ph = function (S, E, N, r) {
      function k(n, e) {
        ...
        y((e = void 0 === e ? A : e).onformat) && e.onformat(n, e, N, r),
          Bh(e.styles, function (e, t) {
            u.setStyle(n, t, pl(e, N));
          }),
          !e.styles ||
            ((t = u.getAttrib(n, 'style')) &&
              u.setAttrib(n, 'data-mce-style', t)),
          Bh(e.attributes, function (e, t) {
        ...
        Il(w, e, function (e) {
          var s,
            c = function (e) {
              ...
              if (
                (Hn(e) &&
                  w.getContentEditable(e) &&
                  ((n = f), (f = 'true' === w.getContentEditable(e)), (t = !0)),
                Xn(e) &&
                  !(function (e, t, n, r) {
                    if (
                ...
                return (s = null), void (xl(A) && w.remove(e));
          ...
          X(x, function (e) {
            ...
            (!(1 < x.length) && w.isBlock(e)) || 0 !== y
              ? (El(A) || (xl(A) && A.wrapper)) &&
                (A.exact ||
                  1 !== y ||
                  (e = I((d = e).childNodes, Hp)
                    .filter(function (e) {
                      return Mg(w, e, A);
                    })
                    .map(function (e) {
                ...
                Oh(_, function (t) {
                  var r, e, n;
                  El(t) &&
                    Oh(h.dom.select(t.inline, b), function (e) {
                      _p(e) && zp(h, t, v, e, t.exact ? e : null);
                    }),
                    (r = h.dom),
                    (e = t).clear_child_styles &&
                      ((n = e.links ? '*:not(a)' : '*'),
                      kh(r.select(n, b), function (n) {
                        _p(n) &&
                          kh(e.styles, function (e, t) {
                            r.setStyle(n, t, '');
                          });
                      }));
                }),
                (s = A),
                (wp((u = S), (f = e).parentNode, (c = E), (l = N)) &&
                  zp(u, s, l, f)) ||
                ...
                (i = A).styles &&
                  ...
                  _h(
                    a,
                    Dp(w, 'fontSize'),
                    Op(w, 'backgroundColor', pl(i.styles.backgroundColor, N)),
                  ),
                (m = w),
                (p = e),
                (g = A).styles &&
                  (g.styles.color || g.styles.textDecoration) &&
                  (St.walk(p, C, 'childNodes'), C(p)),
                (t = w),
                (o = e),
                !El((r = A)) ||
                  ('sub' !== r.inline && 'sup' !== r.inline) ||
                  (_h(o, Dp(t, 'fontSize'), Op(t, 'fontSize', '')),
                  t.remove(
  ...
  function Uh(e) {
    return (
      e && e.ownerDocument && He(Et.fromDom(e.ownerDocument), Et.fromDom(e))
    );
  }
  function zh(a, u, e, s) {
    function t(e, t) {
    ...
    var l,
      ...
      h = function (e, t) {
        ...
        if (
          (r = e) &&
          (Fh(r) || (Uh(r.startContainer) && Uh(r.endContainer)))
        ) {
          var r,
            o = Fh(e) ? e : null;
          if (o) {
      ...
      v = {
        ...
        setCursorLocation: function (e, t) {
          var n = a.createRng();
          V(e) && V(t)
            ? (n.setStart(e, t), n.setEnd(e, t), h(n), o(!1))
            : (Hl(a, n, s.getBody(), !0), h(n));
        },
        getContent: function (e) {
          return (
            (n = (t = void 0 === (t = e) ? {} : t).format || 'html'),
            (r = t),
            wh(s).selection.getContent(n, r)
          );
          var t, n, r;
        },
        setContent: t,
        ...
        getNode: function () {
          return (function (e, t) {
            ...
            return !t.collapsed &&
              ...
              3 === n.nodeType &&
                3 === r.nodeType &&
                ((n = n.length === o ? Bd(n.nextSibling, !0) : n.parentNode),
                (r = 0 === i ? Bd(r.previousSibling, !1) : r.parentNode),
                n && n === r))
              ? n
              : a && 3 === a.nodeType
              ? a.parentNode
        ...
        getSelectedBlocks: function (e, t) {
          return (function (e, t, n, r) {
            var o = [],
              i = e.getRoot();
            if (
              ((n = e.getParent(n || Dd(i, t, t.collapsed), e.isBlock)),
              (r = e.getParent(r || Od(i, t, t.collapsed), e.isBlock)),
              n && n !== i && o.push(n),
              n && r && n !== r)
            )
              for (var a, u = new jr(n, i); (a = u.next()) && a !== r; )
        ...
        getBoundingClientRect: function () {
          var e = p();
          return e.collapsed
            ? bs.fromRangeStart(e).getClientRects()[0]
  ...
  function jh(e, t) {
    ...
    t.convert_fonts_to_spans &&
      ((r = e),
      (a = o),
      (u = St.explode(t.font_size_legacy_values)),
  ...
  function Vh(e, t) {
    ...
    for (var r = new Uint8Array(n.length), o = 0; o < r.length; o++)
      r[o] = n.charCodeAt(o);
    return he.some(new Blob([r], { type: e }));
  }
  function qh(e) {
  ...
  function Wh(r, d) {
    ...
    return {
      findAll: function (e, n) {
        n = n || x;
        var t = R(
          U(e ? Ce(e.getElementsByTagName('img')) : [], function (e) {
            var t = e.src;
            return (
              Ct.fileApi &&
  ...
  function Kh(e, t, n, r) {
    (e.padd_empty_with_br || t.insert) && n[r.name]
      ? (r.empty().append(new Jd('br', 1)).shortEnded = !0)
      : (r.empty().append(new Jd('#text', 3)).value = Do);
  }
  function Xh(n, e, t, r) {
          ...
          .filter(function () {
            return (function (e, t) {
              if (t.images_dataimg_filter) {
                ...
                return (
                  (n.src = e.attr('src')),
                  Q(e.attributes.map, function (e, t) {
                    n.setAttribute(t, e);
                  }),
          ...
          if (
            ...
            o &&
              ...
              Xh(h, m, g, i) &&
                ...
                (c.removeEmpty ? i.remove() : c.paddEmpty && Kh(p, n, d, i)));
          } else {
            for (
              a = o;
            ...
            a === i &&
              ...
              (((l = new Jd('#text', 3)).value = Do), o.replace(l));
          }
      }),
          ...
          for (var t, n, r, o = e.length; o--; )
            ('ul' !== (r = (n = e[o]).parent).name && 'ol' !== r.name) ||
              (n.prev && 'li' === n.prev.name
                ? n.prev.append(n)
                : ((t = new Jd('li', 1)).attr('style', 'list-style-type: none'),
                  n.wrap(t)));
        }),
      p.validate &&
        h.getValidClasses() &&
  ...
  function Gh(_, A) {
    ...
    var e = {
      ...
      getNodeFilters: function () {
        var e,
          t = [];
        for (e in T) Ee(T, e) && t.push({ name: e, callbacks: T[e] });
        return t;
      },
      filterNode: B,
      parse: function (e, u) {
        ...
        var m = yv(
            hv('script,style,head,html,body,title,meta,param'),
            A.getBlockElements(),
          ),
          ...
          N = tm(
            {
              ...
              text: function (e, t) {
                ...
                E ||
                  ((e = e.replace(x, ' ')),
                  (r = c.lastChild) &&
                    (Ee(m, r.name) || 'br' === r.name) &&
                    (e = e.replace(C, ''))),
                  0 !== e.length &&
                    (((n = d('#text', 3)).raw = !!t), (c.append(n).value = e));
              },
              comment: function (e) {
              ...
              start: function (e, t, n) {
                ...
                if (a) {
                  ...
                  if ((E && y[e] && (E = !1), a.removeEmpty && Xh(A, g, y, c)))
                    return (
                      (o = c.parent),
                  ...
                  a.paddEmpty &&
                    ((pv((i = c), '#text') && i.firstChild.value === Do) ||
                      Xh(A, g, y, c)) &&
                    Kh(_, u, m, c),
                    (c = c.parent);
                }
        ...
        if (
          ...
          h &&
            ...
            (u.context
              ...
              : (function (e) {
                  for (
                    var t = hv('tr,td,th,tbody,thead,tfoot,table'),
                    ...
                    if (c.parent && !c.fixed)
                      if (o[c.name] && 'li' === c.parent.name) {
                        ...
                        for (
                          var m = [c], l = c.parent;
                          l && !A.isValidChild(l.name, c.name) && !t[l.name];
                          l = l.parent
                        )
                          m.push(l);
                        if (l && 1 < m.length)
                          if (A.isValidChild(l.name, c.name)) {
                            m.reverse();
                            for (
                              var g = (s = B(m[0].clone())), p = 0;
                              p < m.length - 1;
                              p++
                            ) {
                              A.isValidChild(g.name, m[p].name)
                                ? ((f = B(m[p].clone())), g.append(f))
                                : (f = g);
                              for (
                          ...
                          c.parent &&
                            ('li' !== c.name
                              ? A.isValidChild(c.parent.name, 'div') &&
                                A.isValidChild('div', c.name)
                                ? c.wrap(B(new Jd('div', 1)))
                                : a(c)
                              : !(d = c.prev) ||
                                ('ul' !== d.name && 'ol' !== d.name)
                              ? !(d = c.next) ||
                                ('ul' !== d.name && 'ol' !== d.name)
                                ? c.wrap(B(new Jd('ul', 1)))
              ...
              if (A.isValidChild(k.name, b.toLowerCase())) {
                for (; t; ) {
                  ...
                  (1 === t.type &&
                    ...
                    ? (n ||
                        ((n = d(b, 1)).attr(_.forced_root_block_attrs),
                        k.insert(n, t)),
                      n.append(t))
                    : (e(n), (n = null)),
                    (t = r);
      ...
      t.addAttributeFilter('data-mce-type', function (e, t, n) {
        for (var r = e.length; r--; ) {
          ...
          'bookmark' !== o.attr('data-mce-type') ||
            n.cleanup ||
            (he.from(o.firstChild).exists(function (e) {
              return !Bo(e.value);
            })
              ? o.unwrap()
              : o.remove());
                ...
                (d = I) && d.hasEventListeners('PreProcess') && !E.no_events
                  ? ((h = g),
                    ...
                    (S = document.implementation).createHTMLDocument &&
                      ...
                      St.each(
                        'BODY' === x.nodeName ? x.childNodes : [x],
                        function (e) {
                          b.body.appendChild(b.importNode(e, !0));
                        },
                      ),
                      (x = 'BODY' !== x.nodeName ? b.body.firstChild : b.body),
                      (v = w.doc),
                      (w.doc = b)),
                    (y = p),
                    (C = ke(ke({}, h), { node: x })),
                    ...
                    x)
                  : m)),
              (o = Po((r = D).getInner ? n.innerHTML : M.getOuterHTML(n))),
              r.selection || To(Et.fromDom(n)) ? o : St.trim(o)),
            B =
              ((i = U),
              (a = O),
              (s = (u = D).selection ? ke({ forced_root_block: !1 }, u) : u),
              (c = i.parse(a, s)),
              !P((f = c.lastChild)) ||
    ...
    var o,
      ...
      h =
        ((i =
          ...
          (0,
          (f = (l = u).sections()),
          rv(l, 'mobile') && 'mobile' === f.mobile.theme)
            ? U(c, A(ie, kv))
            : a && rv(u, 'mobile')
            ? c
            : s)),
        [].concat(nv(d)).concat(nv(i)));
    if (Ct.browser.isIE() && ie(h, 'rtc'))
      ...
      p = St.extend(
          ...
          : {},
        {
          ...
          external_plugins:
            ...
            u && u.external_plugins ? St.extend({}, u.external_plugins, s) : s),
        },
      );
    return iv(e, g, r, p);
  }
    ...
    function t(n, e) {
      if (
        ...
        !o.removed &&
          ...
          he.from(r).map(Et.fromDom).map(Fn).getOr(!1)))
      )
        return (
          ...
          I(c, function (e) {
            ...
            return (
              c.push(e),
              u(),
              o.fire('OpenNotification', { notification: ke({}, e) }),
              e
            );
          })
        );
    ...
    wv =
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var o,
            i = e[r];
          for (o in i) Ee(i, o) && (n[o] = dv(n[o], i[o]));
        }
        return n;
      }),
    xv = ft().deviceType,
  ...
  function Fv(e, t, n) {
    Tf(e, t, { message: n }), console.error(n);
  }
  function Uv(e, t, n) {
    return n
  ...
  function Vv(e) {
    return (
      e + fy++ + ('s' + new Date().getTime().toString(36) + t() + t() + t())
    );
    function t() {
  ...
  function Xv(l) {
      ...
      return (
        (e = r(
          ...
          'src="' +
            n +
            '"' +
            (n === Ct.transparentSrc ? ' data-mce-placeholder="1"' : ''),
        )),
    ...
    function f(t, n) {
      X(l.undoManager.data, function (e) {
        'fragmented' === e.type
          ? (e.fragments = R(e.fragments, function (e) {
              return o(e, t, n);
            }))
                      ...
                      l.getParam('images_replace_blob_uris', !0, 'boolean')
                        ...
                        : e.error &&
                          (e.error.options.remove &&
                            (f(u.getAttribute('src'), Ct.transparentSrc),
                            s.push(u)),
                          (n = e.error.message),
                          Mv(
                            l,
                            yu.translate(['Failed to upload image: {0}', n]),
                          )),
                      {
                        element: u,
                        status: e.status,
    ...
    function i(t) {
      return (
        ...
        (0 !== t.getAttribute('src').indexOf('data:') ||
          l.getParam('images_dataimg_filter', x, 'function')(t))
      );
    }
    function a(e) {
    ...
    var u,
      ...
      v = function () {
        return (s = s || Wh(g, m)).findAll(l.getBody(), i).then(
          t(function (e) {
            return (
              (e = U(e, function (e) {
  ...
  function Yv(e, t) {
    function m(e) {
      ...
      var t,
        ...
        r = n;
      return (
        (t = o).classes.length && my.addClass(r, t.classes.join(' ')),
        my.setAttribs(r, t.attrs),
        n
      );
    }
    var n,
      ...
      p = function (n, e, t) {
        ...
        return (
          ...
          t &&
            (r || (r = my.create('div')).appendChild(n),
    ...
    return e && e.length
      ? ((n = m((o = e[0]))),
        (r = my.create('div')).appendChild(p(n, e.slice(1), o.siblings)),
        r)
      : '';
  }
  function Gv(e) {
    ...
    var s,
      ...
      l =
        (s = e.selector) && 'string' == typeof s
          ...
          : [],
      f = l.length
        ? (l[0].name || (l[0].name = c), (c = e.selector), Yv(l, n))
        : Yv([c], n),
      d = my.select(c, f)[0] || f.firstChild;
    return (
      dy(e.styles, function (e, t) {
        var n = a(e);
        n && my.setStyle(d, t, n);
      }),
      ...
      my.setStyles(f, { position: 'absolute', left: -65535 }),
      n.getBody().appendChild(f),
      (r = my.getStyle(n.getBody(), 'fontSize', !0)),
      (r = /px$/.test(r) ? parseInt(r, 10) : 0),
      dy(i.split(' '), function (e) {
        var t = my.getStyle(d, e, !0);
        if (
          !(
            ('background-color' === e &&
              /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
              ((t = my.getStyle(n.getBody(), e, !0)),
              '#ffffff' === my.toHex(t).toLowerCase())) ||
            ('color' === e && '#000000' === my.toHex(t).toLowerCase())
          )
        ) {
    ...
    var e,
      ...
      a =
        ...
        (o = function (e, t) {
          e &&
            (K(e)
              ? (X((t = !S(t) ? [t] : t), function (e) {
                  b(e.deep) && (e.deep = !Sl(e)),
                    b(e.split) && (e.split = !Sl(e) || El(e)),
                    b(e.remove) && Sl(e) && !El(e) && (e.remove = 'none'),
                    Sl(e) && El(e) && ((e.mixed = !0), (e.block_expand = !0)),
                    K(e.classes) && (e.classes = e.classes.split(/\s+/));
                }),
                (n[e] = t))
              : Q(e, function (e, t) {
                  o(t, e);
    ...
    return (
      ...
      (i = c).on('mouseup keydown', function (e) {
        ...
        qg(t, null, !1),
          (8 !== n && 46 !== n) ||
            !r.isCollapsed() ||
            r.getStart().innerHTML !== xp ||
            qg(t, Zc(o, r.getStart())),
          (37 !== n && 39 !== n) || qg(t, Zc(o, r.getStart()));
      }),
      {
        get: a.get,
        has: a.has,
        ...
        matchNode: function (e, t, n, r) {
          return (
            ...
            (a = n),
            (u = r),
            wh(c).formatter.matchNode(o, i, a, u)
          );
          var o, i, a, u;
        },
        canApply: function (e) {
        ...
        formatChanged: function (e, t, n, r) {
          return (
            ...
            (u = n),
            (s = r),
            wh(c).formatter.formatChanged(o, i, a, u, s)
          );
          var o, i, a, u, s;
        },
        getCssText: A(Jv, c),
      ...
      d = {
        ...
        add: function (e, t) {
          return (
            ...
            (a = e),
            (u = t),
            wh(s).undoManager.add(n, r, o, i, a, u)
          );
          var n, r, o, i, a, u;
        },
        undo: function () {
            ...
            ((33 <= n && n <= 36) || (37 <= n && n <= 40) || 45 === n
              ...
              : ((t = (e.ctrlKey && !e.altKey) || e.metaKey),
                !(n < 16 || 20 < n) ||
                  ...
                  r.typing ||
                  t ||
                  (r.beforeChange(), ph(r, !0, o), r.add({}, e), i.set(!0))));
        }),
  ...
  function ib(e, t) {
    ...
    return e
      ? Kr(n)
        ...
        : t
      : Kr(n)
      ? qn(n.previousSibling)
        ? bs(n.previousSibling, n.previousSibling.data.length)
        : bs.before(n)
      : Jr(t)
      ? bs(n, r - 1)
      : t;
  ...
  function hb(e, t, n) {
    return (
      ...
      pb(!1, n),
      (He((o = n), (r = t))
        ? ((i = xm(r, o)), he.from(i[i.length - 1]))
        : he.none()
      ).fold(A(gb, e, t, n), A(mb, e, t, n))
    );
    var r, o, i;
  }
  function vb(e, t, n, r) {
              ...
              return cf(a, i, e.position).bind(function (e) {
                return lb(i, e).map(function (e) {
                  return (
                    (t = i),
                    (n = a),
                    Xn((r = e).position.getNode()) && !1 === oo(r.block)
                      ? Jc(!1, r.block.dom)
                          .bind(function (e) {
                            return e.isEqual(r.position)
                              ? cf(n, t, e).bind(function (e) {
                                  return lb(t, e);
                                })
                              : he.some(r);
                          })
  ...
  function Cb(e) {
    ...
    return (
      (a = d),
      (c = df((i = f).dom, bs.fromRangeStart(a)).isNone()),
      (l = ff(i.dom, bs.fromRangeEnd(a)).isNone()),
      !yb((u = i), (s = a).startContainer) && !yb(u, s.endContainer) && c && l
        ? ((t = e).setContent(''), t.selection.setCursorLocation(), !0)
        : ((n = f),
          (r = e.selection),
          (o = r.getRng()),
          fn(
            ub(n, Et.fromDom(o.startContainer)),
            ub(n, Et.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === je(e, t) &&
                (o.deleteContents(),
                vb(n, !0, e, t).each(function (e) {
                  r.setRng(e.toRange());
                }),
                !0)
              );
  ...
  function Sb(e, t) {
    ...
    return e.fire('BeforeObjectSelected', { target: t }).isDefaultPrevented()
      ? he.none()
      : he.some(((r = (n = t).ownerDocument.createRange()).selectNode(n), r));
  }
  function Eb(e, t, n) {
  ...
  function Ab(n, r, e, t, o, i) {
    ...
    return (
      ...
      (a = n.dom),
      qn((u = e)) && 0 === u.data.length && a.remove(u),
      !0
    );
  }
  function Tb(e, t) {
  ...
  function Rb(l, f, d) {
    return cf(f, l, d).bind(function (e) {
      return (
        ...
        ((o = l),
        (u = e),
        dc(!(i = f), (a = d)).fold(function () {
          return dc(i, u).fold(T, c);
        }, c))
          ? he.none()
          : (f && Jn(e.getNode())) || (!1 === f && Jn(e.getNode(!0)))
          ? ((t = l),
            (n = d),
            (r = e.getNode(!1 === f)),
            ub(Et.fromDom(t), Et.fromDom(n.getNode()))
              .map(function (e) {
  ...
  function Ob(m, g) {
    ...
    return Db(m, e)
      ...
      .fold(function () {
        return (
          (s = m.getBody()),
          (l = fc((c = g) ? 1 : -1, s, m.selection.getRng())),
          (f = bs.fromRangeStart(l)),
          (d = Et.fromDom(s)),
          (!1 === c && up(f)
            ? he.some(wy.remove(f.getNode(!0)))
            : c && ap(f)
            ? he.some(wy.remove(f.getNode()))
            : !1 === c && ap(f) && Rm(d, f)
            ? dp(d, f).map(function (e) {
                return wy.remove(e.getNode());
              })
            : c && up(f) && Tm(d, f)
            ? mp(d, f).map(function (e) {
                return wy.remove(e.getNode());
              })
            : ((r = s),
              (e = c),
              ...
              Hn(a) && a.getAttribute('data-mce-caret') === u
                ? ((n = o.getNode(!1 === (t = e))),
                  (t && Jn(n.nextSibling)
                    ? he.some(wy.moveToElement(n.nextSibling))
                    : !1 === t && Jn(n.previousSibling)
                    ? he.some(wy.moveToElement(n.previousSibling))
                    : he.none()
                  ).fold(function () {
                    return Rb(r, e, o);
                  }, he.some))
  ...
  function Bb(e, t) {
    ...
    return (
      ...
      Db(e, n.parentNode)
        ...
        .fold(function () {
          return (
            X(Au(Et.fromDom(e.getBody()), '.mce-offscreen-selection'), Mn),
            tg(e, t, Et.fromDom(e.selection.getNode())),
            sb(e),
            !0
          );
        }, x)
  ...
  function Ib(e, t) {
    return (
      ...
      ((n = e),
      (r = t),
      (o = bs.fromRangeStart(n.selection.getRng())),
      cf(r, n.getBody(), o)
        .filter(function (e) {
          return (r ? ep : tp)(e);
        })
      ...
      e
        ? function (e) {
            if (xy(e.previousSibling))
              return (
                Fb(e.previousSibling) || e.previousSibling.appendData(Oo),
                e.previousSibling
              );
        ...
        : function (e) {
            if (xy(e.nextSibling))
              return (
                Mb(e.nextSibling) || e.nextSibling.insertData(0, Oo),
                e.nextSibling
              );
  ...
  function Qb(e) {
    return (
      !1 ===
      ((t = ky(e)),
      'rtl' === cu.DOM.getStyle(t, 'direction', !0) ||
        ((n = t.textContent), hy.test(n)))
    );
    var t, n;
  }
  function Zb(e, t, n) {
  ...
  function iy(e, t) {
    return e
      ? t.fold(i(he.some, Ny.start), he.none, i(he.some, Ny.after), he.none)
      : t.fold(he.none, i(he.some, Ny.before), he.none, i(he.some, Ny.end));
  }
  function ay(e, a, u, s) {
    var t = ib(e, s),
      c = Zb(a, u, t);
  ...
  function _y(e, t, n) {
    var r = e ? 1 : -1;
    return (
      t.setRng(bs(n.container(), n.offset() + r).toRange()),
    ...
    for (var o, i, a, u, s = Wc(n), c = r, l = []; c; ) {
      ...
      if (Xn(f.getNode(!1)))
        return t === vc.Forwards
          ...
          : { positions: Ay(t, l), breakType: sy.Br, breakAt: he.some(f) };
      if (f.isVisible()) {
        if (e(c, f)) {
          var d =
            ((o = c),
            Xn((i = f).getNode(t === vc.Forwards))
              ? sy.Br
              : !1 === uc(o, i)
              ? sy.Block
              : sy.Wrap);
          return { positions: Ay(t, l), breakType: d, breakAt: he.some(f) };
        }
        l.push(f), (c = f);
      } else c = f;
    }
  ...
  function jy(o, i, a, e, u, t) {
    function n(e) {
      ...
      for (var n = 0; n < t.length; n++) {
        var r = t[n];
        if (!a(r, l)) {
          if ((0 < c.length && i(r, ge(c)) && s++, (r.line = s), u(r)))
            return !0;
          c.push(r);
        }
      }
    ...
    return (
      n(r),
      (function (e, t, n, r) {
        for (; (r = ic(r, e, to, t)); ) if (n(r)) return;
      })(o, e, n, r),
      c
    );
  }
  ...
  function Xy(e, o) {
    return de(e, function (e, t) {
      ...
      return Wy(o, t) || (!Wy(o, e) && ((r === n && FC(t.node)) || r < n))
        ? t
        : e;
    });
  }
    ...
    if (
      ...
      (i = Xy(
        (function (e, r, t) {
          ...
          return (
            o.push(r),
            Yy(Ly.Up, e, A(n, ju), r.node, t),
            Yy(Ly.Down, e, A(n, Hu), r.node, t),
            o
          );
        })(e, i, !sn(i.node) && !Zn(i.node)),
        t,
      )) &&
      rc(i.node)
    )
      return { node: (r = i).node, before: qy(r, (o = t)) < $y(r, o) };
    return null;
  }
  function Jy(e, t) {
    ...
    if ((c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : qu(n))) {
      var p = (function (e, t, n, r) {
          ...
          var i,
            ...
            f =
              1 === e
                ? ((i = s.next), (a = Hu), (u = ju), bs.after(r))
                : ((i = s.prev), (a = ju), (u = Hu), bs.before(r)),
            d = o(f);
          do {
            if (f.isVisible()) {
              var m = o(f);
  ...
  function i0(e, t, n) {
    return (
      ...
      (i = n),
      (a = (r = e).getBody()),
      (u = bs.fromRangeStart(r.selection.getRng())),
      ay(i, A(rb, r), a, u)
        .bind(function (e) {
          return o0(r, o, e);
        })
  ...
  function a0(e, t, n) {
    return (
      ...
      (a = r ? bs.fromRangeEnd(i) : bs.fromRangeStart(i)),
      !!y(o.selection.getSel().modify) &&
        (r && Gr(a)
          ? _y(!0, o.selection, a)
          : !(r || !Jr(a)) && _y(!1, o.selection, a)))
    );
    var r, o, i, a;
  }
  function u0(g) {
      ...
      g.on('NodeChange', function (e) {
        ...
        !Ws(g) ||
          ...
          (l = g).selection.isCollapsed() &&
            !0 !== l.composing &&
            f.get() &&
            ((d = bs.fromRangeStart(l.selection.getRng())),
            bs.isTextPosition(d) &&
              !1 === (Gr((m = d)) || Jr(m)) &&
              (n0(l, Zs(f.get(), d)), f.set(null))),
          (n = h),
          (r = g),
          (o = p),
          (t = e.parents),
  ...
  function l0(r, o, i, a) {
    ...
    r.undoManager.ignore(function () {
      ...
      r.selection.setRng(
        ...
        Zb(s, u, bs.fromRangeStart(r.selection.getRng())).map(ny).map(c0(r, o));
    }),
      r.nodeChanged();
  }
  function f0(e, t, n) {
    if (e.selection.isCollapsed() && Ws(e)) {
      ...
      return (
        ...
        (u = r),
        (s = (i = e).getBody()),
        (c = ac(u.container(), s) || s),
        (l = A(rb, i)),
        (f = Zb(l, c, u))
          .bind(function (e) {
            return a
              ? e.fold(J(he.some(ny(e))), he.none, J(he.some(ty(e))), he.none)
              : e.fold(he.none, J(he.some(ty(e))), he.none, J(he.some(ny(e))));
          })
          .map(c0(i, o))
          .getOrThunk(function () {
            var t = Gc(a, c, u),
  ...
  function m0(g, p) {
    var t,
      ...
      h = U(
        M((t = xm(n, e)), So).fold(J(t), function (e) {
          return t.slice(0, e);
        }),
        d0,
      );
    return Y(h).exists(function (e) {
      var t,
        ...
        m = e.dom;
      return !(
        !fn(mf(m), gf(m), function (e, t) {
          var n = ib(!0, e),
            r = ib(!1, t),
            o = ib(!1, d);
          return f
            ? ff(m, o).exists(function (e) {
  ...
  function h0(e, t) {
    return e.selection.isCollapsed()
      ? ((i = e),
        (u = (a = t) ? np : rp),
        (s = a ? vc.Forwards : vc.Backwards),
        (c = mc(s, i.getBody(), i.selection.getRng())),
        u(c)
          ? p0(i, a, c.getNode(!a))
          : he
              .from(ib(a, c))
    ...
    e.queryCommandState('InsertUnorderedList') ||
      ...
      X(VC(e), function (e) {
        var t,
          ...
          u = b0(d, Et.fromDom(a));
        'outdent' === r
          ? ((t = Math.max(0, v0(a.style[u]) - o)),
            n.setStyle(a, u, t ? t + i : ''))
          : ((t = v0(a.style[u]) + o + i), n.setStyle(a, u, t));
      });
  }
  function x0(e, t) {
  ...
  function k0(e) {
    ...
    if (s && Hn(s) && l) {
      ...
      if (
        ...
        (m = c),
        (g = s),
        !F(wm(Et.fromDom(g), Et.fromDom(m)), function (e) {
          return N0(d, e.dom);
        }))
      ) {
        for (
        ...
        r &&
          x &&
          (v.setStart(b, y), v.setEnd(C, w), i.setRng(v), e.nodeChanged());
      }
    }
  }
  function _0(e, t) {
  ...
  function A0(e, t) {
    var n = yr(Et.fromDom(e.getBody()), '*[data-mce-caret]')
      .map(function (e) {
        return e.dom;
      })
      .getOrNull();
    if (n)
      return 'compositionstart' === t.type
        ? (t.preventDefault(), t.stopPropagation(), void _0(e, n))
        : void (Yr(n) && (_0(e, n), e.undoManager.add()));
  }
  function T0(e, t, n) {
    var r,
      o,
    ...
    !n.collapsed ||
      ...
      ((r = e.dom.getParent(n.startContainer, 'PRE')) &&
        (u(bs.fromRangeStart(n)) ||
          ((i = e.dom.create(Ls(e))),
          (!Ct.ie || 11 <= Ct.ie) && (i.innerHTML = '<br data-mce-bogus="1">'),
          (o = i),
  ...
  function I0(h, v) {
    var b = Et.fromDom(h.getBody()),
      ...
      e = y,
      t = A(je, b);
    return vr(Et.fromDom(e.container()), So, t)
      .filter(B0)
      .exists(function () {
        if (
          ((d = b),
          (m = y),
          v
            ? ((p = d.dom), Fy(p, m).breakAt.isNone())
            : ((g = d.dom), My(g, m).breakAt.isNone()))
        ) {
          var e =
            ((t = b),
            (r = w),
            (o = v),
            '' === (n = C)
              ? ((l = o), L0(t, (f = Et.fromTag('br')), l), P0(f))
              : ((i = t),
                (a = o),
                (u = r),
                (s = Et.fromTag(n)),
  ...
  function q0(e, t, n) {
    var r,
      o,
      i = e(t, n);
    return (i.breakType === sy.Wrap && 0 === i.positions.length) ||
      (!Xn(n.getNode()) && i.breakType === sy.Br && 1 === i.positions.length)
      ? ((r = e),
        (o = t),
  ...
  function W0(u, s, c) {
    var e,
      ...
      n =
        ((e = !!s),
        (t = c.getNode(e)),
        Hn(t) && 'TABLE' === t.nodeName ? he.some(t) : he.none()),
      r = !1 === s;
    n.fold(
      function () {
    ...
    if (t) {
      !/^(LI|DT|DD)$/.test(t.nodeName) ||
        ((r = (function (e) {
          ...
          t.insertBefore(i.doc.createTextNode(Do), t.firstChild));
      var u = i.createRng();
  ...
  function aC(e, t, n) {
    return !1 === qn(t)
      ? n
      : e
      ? 1 === n && t.data.charAt(n - 1) === Oo
        ? 0
        : n
      : n === t.data.length - 1 && t.data.charAt(n) === Oo
      ? t.data.length
      : n;
  }
  function uC(e, t) {
    ...
    n &&
      ...
      (function (e, o, t) {
        ...
        he
          ...
          fn(
            he.from(t.class).map(function (e) {
              return e.split(/\s+/);
            }),
  ...
  function cC(a, e) {
    ...
    function r() {
      (u = /^(H[1-6]|PRE|FIGURE)$/.test(C) && 'HGROUP' !== w ? t(p) : t()),
    ...
    F &&
      ...
      'LI' !== (w = y ? y.nodeName.toUpperCase() : '') ||
        v ||
        ((y = (b = y).parentNode), (C = w)),
      /^(LI|DT|DD)$/.test(C) && c.isEmpty(b)
        ? ((N = t),
          ...
          k !== E.getBody() &&
            ((R = (A = eC((T = k)) && eC(T.parentNode) ? 'LI' : A)
              ? N(A)
              : I.create('BR')),
            nC(k, _, !0) && nC(k, _, !1)
              ? Z0(k, 'LI')
                ? ((D = tC(k)),
                  I.insertAfter(R, D),
                  (null === (L = (P = k).parentNode) || void 0 === L
                    ? void 0
                    : L.firstChild) === P
                    ? I.remove(D)
                    : I.remove(k))
              ...
              : (nC(k, _, !0)
                  ? Z0(k, 'LI')
                    ? (I.insertAfter(R, tC(k)),
                      R.appendChild(I.doc.createTextNode(' ')),
                      R.appendChild(k))
                  ...
                  : ((k = tC(k)),
                    ...
                    'LI' === A && B.firstChild && 'LI' === B.firstChild.nodeName
                      ? ((R = B.firstChild), I.insertAfter(B, k))
                      : (I.insertAfter(B, k), I.insertAfter(R, k))),
                I.remove(_)),
            J0(E, R)))
        : (p && b === a.getBody()) ||
          ((p = p || 'P'),
          Wr(b)
            ? ((u = Qr(b)), c.isEmpty(b) && rC(b), sC(a, u), J0(a, u))
            : n()
            ? r()
            : n(!0)
            ? ((u = b.parentNode.insertBefore(t(), b)),
              J0(a, oC(b, 'HR') ? u : b))
            : ((S = (x = d).cloneRange()).setStart(
                x.startContainer,
                aC(!0, x.startContainer, x.startOffset),
              ),
              S.setEnd(x.endContainer, aC(!1, x.endContainer, x.endOffset)),
              (o = S.cloneRange()).setEndAfter(b),
              (i = o.extractContents()),
              X(Zu(Et.fromDom(i), Tn), function (e) {
                var t = e.dom;
              ...
              (function (e) {
                for (
                  ;
                  qn(e) && (e.nodeValue = e.nodeValue.replace(/^[\r\n]+/, '')),
                    (e = e.firstChild);
              ...
              c.isEmpty(b) && rC(b),
              u.normalize(),
              c.isEmpty(u) ? (c.remove(u), r()) : (sC(a, u), J0(a, u))),
          c.setAttrib(u, 'id', ''),
      ...
      : (function (e, t) {
          ...
          'LI' !== d || m || (l = f),
            c &&
              ...
              !(function (e) {
                for (
                  var t, n = new jr(c, l), r = e.getNonEmptyElements();
                  (t = n.next());
  ...
  function AC(e, t) {
    ...
    (n = e),
      ...
      qb(
        [
          _C([bC], GC.none()),
          _C([wC('summary', !0)], GC.br()),
          _C([xC(!0), SC(!1), NC], GC.br()),
          _C([xC(!0), SC(!1)], GC.block()),
          _C([xC(!0), SC(!0), NC], GC.block()),
          _C([xC(!0), SC(!0)], GC.br()),
          _C([CC(!0), NC], GC.br()),
          _C([CC(!0)], GC.block()),
          _C([yC(!0), NC, kC], GC.block()),
          _C([yC(!0)], GC.br()),
          _C([EC], GC.br()),
          _C([yC(!1), NC], GC.br()),
          _C([kC], GC.block()),
  ...
  function OC(n, r) {
    var e = r.container(),
      t = r.offset();
    return qn(e)
      ? (e.insertData(t, n), he.some(bs(e, t + n.length)))
      : gc(r).map(function (e) {
          var t = Et.fromText(n);
  ...
  function LC(e) {
    var o,
      ...
      p = u0(e);
    return (
      e.on('keyup compositionstart', A(A0, e)),
      (g = p),
      (m = e).on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          U0(
            [
              { keyCode: $f.RIGHT, action: F0(R0, t, !0) },
              { keyCode: $f.LEFT, action: F0(R0, t, !1) },
              { keyCode: $f.UP, action: F0(D0, t, !1) },
              { keyCode: $f.DOWN, action: F0(D0, t, !0) },
              { keyCode: $f.RIGHT, action: F0(Y0, t, !0) },
              { keyCode: $f.LEFT, action: F0(Y0, t, !1) },
              { keyCode: $f.UP, action: F0(G0, t, !1) },
              { keyCode: $f.DOWN, action: F0(G0, t, !0) },
              { keyCode: $f.RIGHT, action: F0(z0, t, !0) },
              { keyCode: $f.LEFT, action: F0(z0, t, !1) },
              { keyCode: $f.UP, action: F0(j0, t, !1) },
              { keyCode: $f.DOWN, action: F0(j0, t, !0) },
              { keyCode: $f.RIGHT, action: F0(i0, t, n, !0) },
              { keyCode: $f.LEFT, action: F0(i0, t, n, !1) },
              {
                keyCode: $f.RIGHT,
                ctrlKey: !o.isOSX(),
                altKey: o.isOSX(),
              ...
              { keyCode: $f.UP, action: F0(M0, t, !1) },
              { keyCode: $f.DOWN, action: F0(M0, t, !0) },
            ],
            r,
          ).each(function (e) {
            r.preventDefault();
      ...
      (f = e).on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          U0(
            [
              { keyCode: $f.BACKSPACE, action: F0(x0, (t = f), !1) },
              { keyCode: $f.BACKSPACE, action: F0(Lb, t, !1) },
              { keyCode: $f.DELETE, action: F0(Lb, t, !0) },
              { keyCode: $f.BACKSPACE, action: F0(Tb, t, !1) },
              { keyCode: $f.DELETE, action: F0(Tb, t, !0) },
              { keyCode: $f.BACKSPACE, action: F0(f0, t, n, !1) },
              { keyCode: $f.DELETE, action: F0(f0, t, n, !0) },
              { keyCode: $f.BACKSPACE, action: F0(xg, t, !1) },
              { keyCode: $f.DELETE, action: F0(xg, t, !0) },
              { keyCode: $f.BACKSPACE, action: F0(Ib, t, !1) },
              { keyCode: $f.DELETE, action: F0(Ib, t, !0) },
              { keyCode: $f.BACKSPACE, action: F0(h0, t, !1) },
              { keyCode: $f.DELETE, action: F0(h0, t, !0) },
              { keyCode: $f.BACKSPACE, action: F0(wb, t, !1) },
              { keyCode: $f.DELETE, action: F0(wb, t, !0) },
              { keyCode: $f.BACKSPACE, action: F0(bb, t, !1) },
              { keyCode: $f.DELETE, action: F0(bb, t, !0) },
              { keyCode: $f.BACKSPACE, action: F0(g0, t, !1) },
              { keyCode: $f.DELETE, action: F0(g0, t, !0) },
            ],
            r,
          ).each(function (e) {
            r.preventDefault();
      ...
      f.on('keyup', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          U0(
            [
              { keyCode: $f.BACKSPACE, action: F0(Pb, (t = f)) },
              { keyCode: $f.DELETE, action: F0(Pb, t) },
            ],
            n,
          ));
      }),
      ...
      (c = e).on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = e),
          U0([{ keyCode: $f.SPACEBAR, action: F0(PC, c) }], t).each(function (
            e,
          ) {
            t.preventDefault();
          }));
      ...
      (u = e).on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          U0(
            [
              { keyCode: $f.END, action: F0(O0, (t = u), !0) },
              { keyCode: $f.HOME, action: F0(O0, t, !1) },
              { keyCode: $f.END, action: F0(H0, t, !0) },
              { keyCode: $f.HOME, action: F0(H0, t, !1) },
              { keyCode: $f.END, action: F0(s0, t, !0, n) },
              { keyCode: $f.HOME, action: F0(s0, t, !1, n) },
            ],
            r,
          ).each(function (e) {
            r.preventDefault();
      ...
      QC.os.isOSX() ||
        ...
        o.on('keyup', function (e) {
          ...
          !1 === e.isDefaultPrevented() &&
            ...
            U0(
              [
                { keyCode: $f.PAGE_UP, action: F0(s0, (t = o), !1, (n = i)) },
                { keyCode: $f.PAGE_DOWN, action: F0(s0, t, !0, n) },
              ],
              r,
            )),
  ...
  var IC = A(jy, Ly.Up, ju, Hu),
    ...
    e1 = A(OC, ' '),
    t1 =
      ((n1.prototype.nodeChanged = function (e) {
        var t,
          n,
          r,
  ...
  function n1(r) {
    ...
    'onselectionchange' in r.getDoc() ||
      r.on('NodeChange click mouseup keyup focus', function (e) {
        ...
        ('nodechange' !== e.type && Lf(n, o)) || r.fire('SelectionChange'),
          (o = n);
      }),
      ...
      r.on('SelectionChange', function () {
        ...
        !e ||
          (!Ct.range && r.selection.isCollapsed()) ||
          (Vl(r) &&
      ...
      r.on('mouseup', function (e) {
        !e.isDefaultPrevented() &&
          ...
          ('IMG' === r.selection.getNode().nodeName
            ? Ur.setEditorTimeout(r, function () {
                r.nodeChanged();
              })
            : r.nodeChanged());
      });
      ...
      function (x) {
        return e.on(function (e) {
          var t,
            ...
            C,
            w = Math.max(
              Math.abs(x.screenX - e.screenX),
              Math.abs(x.screenY - e.screenY),
            );
          if (!e.dragging && 10 < w) {
          ...
          e.dragging &&
            ...
            (t = {
              pageX:
                ((p = x),
                (h = (g = S).inline ? o1(g.getBody()) : { left: 0, top: 0 }),
                (C = (y = g).getBody()),
                (v = y.inline
  ...
  function s1(e) {
    ...
    function a(e) {
      ...
      e.isDefaultPrevented() ||
        ((t = e.dataTransfer) &&
          (ie(t.types, 'Files') || 0 < t.files.length) &&
          (e.preventDefault(),
          'drop' === e.type && Mv(i, 'Dropped file type is not supported')));
    }
    function u(e) {
      Ed(i, e.target) && a(e);
    }
      ...
      (n = e).on('drop', function (e) {
        var t =
          void 0 !== e.clientX
            ...
            : null;
        (!D1(t) && 'false' !== n.dom.getContentEditableParent(t)) ||
          e.preventDefault();
      }),
  ...
  function l1(l) {
    ...
    function d(e, t, n, r) {
      return (
        ...
        l
          ...
          .isDefaultPrevented()
          ? null
          : (r && p.scrollIntoView(t, -1 === e), s.show(n, t))
      );
    }
    function t(e) {
    ...
    function c(e, t) {
      ...
      if (
        (3 === a.nodeType &&
          0 === u &&
          L1(a.parentNode) &&
          ((a = a.parentNode), (u = h.nodeIndex(a)), (a = a.parentNode)),
        1 !== a.nodeType)
      )
        return null;
        ...
        if (f(c))
          return (function (e) {
            ...
            var r = (function (e, t, n) {
                var r = l.$,
                  o = yr(Et.fromDom(l.getBody()), '#' + b).fold(
                    function () {
                      return r([]);
                    },
                    function (e) {
                ...
                t === n && Ct.ie
                  ? (o
                    ...
                    i.setEndAfter(t))
                  : (o.empty().append(Do).append(t).append(Do),
                    i.setStart(o[0].firstChild, 1),
                    i.setEnd(o[0].lastChild, 0)),
                  o.css({ top: h.getPos(e, l.getBody()).y }),
                  o[0].focus();
                var a = p.getSel();
            ...
            return (
              X(
                Au(Et.fromDom(l.getBody()), '*[data-mce-selected]'),
                function (e) {
                  je(o, e) || bn(e, y);
                },
              ),
              h.getAttrib(e, y) || e.setAttribute(y, '1'),
              (g = e),
              C(),
              r
            );
    ...
    function a() {
      g && g.removeAttribute(y),
        yr(Et.fromDom(l.getBody()), '#' + b).each(Mn),
        (g = null);
    }
    var g,
      n,
    ...
    return (
      Ct.ceFalse &&
        ...
        l.on('click', function (e) {
          var t = c1(l, e.target);
          t &&
            (L1(t) && (e.preventDefault(), l.focus()),
            P1(t) && h.isChildOf(t, p.getNode()) && a());
        }),
        l.on('blur NewBlock', a),
        l.on('ResizeWindow FullscreenStateChanged', s.reposition),
        l.on(
          'tap',
          function (e) {
            var t = e.target,
              n = c1(l, t);
            L1(n)
              ? (e.preventDefault(), Sb(l, n).each(c))
              : f(t) && Sb(l, t).each(c);
          },
          !0,
        ),
        l.on('mousedown', function (e) {
          var t,
            ...
            r,
            o = e.target;
          (o !== v && 'HTML' !== o.nodeName && !h.isChildOf(o, v)) ||
            !1 === lv(l, e.clientX, e.clientY) ||
            ((t = c1(l, o))
              ? L1(t)
                ? (e.preventDefault(), Sb(l, t).each(c))
                : (a(),
                  (P1(t) && e.shiftKey) ||
                    Af(e.clientX, e.clientY, p.getRng()) ||
                    (C(), p.placeCaretAt(e.clientX, e.clientY)))
              : f(o)
              ? Sb(l, o).each(c)
              : !1 === rc(o) &&
                (a(),
                C(),
                (n = Gy(v, e.clientX, e.clientY)) &&
                  (w(o, n.node) ||
                    (e.preventDefault(),
                    (r = d(1, n.node, n.before, !1)),
                    l.getBody().focus(),
                    i(r)))));
        }),
        ...
        l.on('SetSelectionRange', function (e) {
          ...
          e.range =
            ...
            (a = t.endContainer),
            (u = t.endOffset),
            Ee(n, o.nodeName.toLowerCase())
              ? 0 === i
                ? r.setStartBefore(o)
                : r.setStartAfter(o)
              : r.setStart(o, i),
            Ee(n, a.nodeName.toLowerCase())
              ? 0 === u
                ? r.setEndBefore(a)
                : r.setEndAfter(a)
              : r.setEnd(a, u),
        ...
        l.on('AfterSetSelectionRange', function (e) {
          ...
          m(t) || 'mcepastebin' === n.id || C(),
            h.hasClass(n, 'mce-offscreen-selection') || a();
        }),
        l.on('copy', function (e) {
          ...
          e.isDefaultPrevented() ||
            !e.clipboardData ||
            Ct.ie ||
            ((t = (n = h.get(b)) && n.getElementsByTagName('*')[0]) &&
              (e.preventDefault(),
              r.clearData(),
    ...
    function w(e, t) {
      var n,
        ...
        o = h.getParent(t, u);
      return (
        (r && e !== o && h.isChildOf(r, o) && !1 === L1(c1(l, r))) ||
        (r &&
          ((n = o), h.getParent(r, u) !== h.getParent(n, u)) &&
          (function (e) {
            var t = Wc(e);
            if (e.firstChild) {
              var n,
      ...
      a.inline ||
        b.bind(a.getDoc(), 'mousedown mouseup', function (e) {
          ...
          e.target === a.getDoc().documentElement &&
            ...
            a.getBody().focus(),
            'mousedown' === e.type
              ? Xr(t.startContainer) || y.placeCaretAt(e.clientX, e.clientY)
              : y.setRng(t));
        });
    }
    function r() {
      Range.prototype.getClientRects ||
        a.on('mousedown', function (e) {
          ...
          u(e) ||
            ...
            ((t = a.getBody()).blur(),
            Ur.setEditorTimeout(a, function () {
              t.focus();
            }));
        });
    }
  ...
  function g1(e) {
    ...
    e.bindPendingEventDelegates(),
      ...
      (n = (u = e).dom.getRoot()),
      u.inline ||
        (Vl(u) && u.selection.getStart(!0) !== n) ||
        mf(n).each(function (e) {
          var t,
            n,
            r,
            o,
          ...
          Ct.browser.isIE()
            ? ((t = u),
              (n = a.toRange()),
              (r = Et.fromDom(t.getBody())),
              (o = (bd(t) ? he.from(n) : he.none()).map(yd).filter(vd(r))),
  ...
  function h1(e) {
    ...
    0 < e.contentStyles.length &&
      ((r = ''),
      St.each(e.contentStyles, function (e) {
        r += e + '\r\n';
      }),
      e.dom.addStyle(r));
    var u,
    ...
    return (
      e.settings.content_style &&
        ...
        (g = jt(Ln(m))),
        gn((p = Et.fromTag('style')), 'type', 'text/css'),
        In(p, Et.fromText(d)),
        In(g, p),
  ...
  function v1(e) {
    var t;
    !0 !== e.removed &&
      (bh((t = e)) || t.load({ initial: !0, format: 'html' }),
  ...
  function b1(t, e) {
    ...
    n.inline || (t.getElement().style.visibility = t.orgVisibility),
      ...
      t.inline &&
        (I1.addClass(r, 'mce-content-body'),
    ...
    (h.disabled = !0),
      ...
      t.readonly ||
        (t.inline &&
          'static' === I1.getStyle(h, 'position', !0) &&
      ...
      (t.parser =
        ((i = Gh(m1((u = t)), u.schema)).addAttributeFilter(
        ...
        i.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function (e) {
          for (var t = e.length, n = u.schema.getNonEmptyElements(); t--; ) {
            ...
            r.isEmpty(n) &&
              ...
              (r.append(new Jd('br', 1)).shortEnded = !0);
          }
        }),
        i)),
      (t.serializer = Zh(
      ...
      (t.selection = zh(t.dom, t.getWin(), t.serializer, t)),
      (t.annotator = Yl(t)),
      (t.formatter = Qv(t)),
      (t.undoManager = eb(t)),
      (t._nodeChangeDispatcher = new t1(t)),
      (t._selectionOverrides = l1(t)),
      (d = t),
      (m = wu()),
      (g = pu(!1)),
      (p = Su(function (e) {
        d.fire('longpress', ke(ke({}, e), { type: 'longpress' })), g.set(!0);
      }, 400)),
      d.on(
        'touchstart',
        function (n) {
          ...
          p.cancel(),
            E0(e).each(function (i) {
              m.on(function (e) {
                ...
                (5 < r || 5 < o) &&
                  (m.clear(), g.set(!1), d.fire('longpresscancel'));
              });
            });
        },
        !0,
      ...
      bh(t) ||
        (s = t).on('click', function (e) {
          ...
          3 <= e.detail &&
            ...
            (o = bs.fromRangeStart(r)),
            (i = bs.fromRangeEnd(r)),
            !bs.isElementPosition(o) ||
              (r1((n = o.container())) &&
                mf(n).each(function (e) {
                  return r.setStart(e.container(), e.offset());
                })),
            !bs.isElementPosition(i) ||
              (r1((n = o.container())) &&
                gf(n).each(function (e) {
    ...
    (N = k),
      ...
      Ls((b = t)) && b.on('NodeChange', A(k0, b)),
      (C = (y = t).dom),
      (w = Ls(y)),
      (x = y.getParam(
        'placeholder',
        kc.getAttrib(y.getElement(), 'placeholder'),
        'string',
      )),
      (S = function (e, t) {
        var n, r, o;
        !(function (e) {
          ...
          (r =
            !(
              tb((o = e)) &&
              !(nb(o) || ('keyup' === o.type && 229 === o.keyCode))
            ) &&
            (function (e, t, n) {
          ...
          (('' !== C.getAttrib(n, py)) === r && !t) ||
            (C.setAttrib(n, py, r ? x : null),
            C.setAttrib(n, 'aria-placeholder', r ? x : null),
            y.fire('PlaceholderToggle', { state: r }),
    ...
    (function (t) {
      ...
      t.fire('PreInit'),
        e.browser_spellcheck ||
          e.gecko_spellcheck ||
          ((n.body.spellcheck = !1), I1.setAttrib(r, 'spellcheck', 'false')),
        (t.quirks = f1(t)),
        t.fire('PostRender');
  ...
  function x1(e) {
    ...
    return (
      ...
      K($s(e))
        ...
        : y($s(e))
        ? ((n = (t = e).getElement()),
          (r = $s(t)(t, n)).editorContainer.nodeType &&
        ...
        : ((u = (o = e).getElement()),
          o.inline
            ? w1(null)
            : ((i = u), (a = F1.create('div')), F1.insertAfter(a, i), w1(a)))
    );
  }
  function S1(e) {
    var n, t, r, o, i, a, u, s;
    e.fire('ScriptsLoaded'),
      ...
      Q(ke(ke({}, Av.get('default').icons), Av.get(t).icons), function (e, t) {
        Ee(r, t) || n.ui.registry.addIcon(t, e);
      }),
      (a = $s((o = e))),
      K(a)
        ? ((o.settings.theme = C1(a)),
          (i = Pv.get(a)),
          (o.theme = new i(o, Pv.urls[a])),
          o.theme.init &&
            o.theme.init(
              o,
              Pv.urls[a] || o.documentBaseUrl.replace(/\/$/, ''),
              o.$,
            ))
        : (o.theme = {}),
      (s = []),
      St.each(Ks((u = e)).split(/[ ,]/), function (e) {
        U1(u, s, C1(e));
      });
    var c = x1(e),
      l = e,
    ...
    return (
      ...
      e.inline
        ...
        : ((p = y1((m = e), (g = h))),
          g.editorContainer &&
            ((M1.get(g.editorContainer).style.display = m.orgDisplay),
            (m.hidden = M1.isHidden(g.editorContainer))),
          (m.getElement().style.display = 'none'),
          M1.setAttrib(m.id, 'aria-hidden', 'true'),
          void (p || b1(m)))
    );
  }
  function E1(e) {
    ...
    var e,
      ...
      o = function () {
        ...
        (e = f),
            ...
            function (e) {
              t.add(e.url, oe, void 0, function () {
                Fv(
                  n,
                  'IconsLoadError',
                  Uv('icons', e.url, e.name.getOrUndefined()),
                );
              });
            },
          ),
          (r = c),
          (o = l),
          St.each(r.getParam('external_plugins'), function (e, t) {
    ...
    K(i)
      ? (E1(i) ||
          ...
          ((t = e.getParam('theme_url'))
            ? Pv.load(i, e.documentBaseURI.toAbsolute(t))
            : Pv.load(i, 'themes/' + i + '/theme' + r + '.js')),
      ...
      he
        ...
        .bind(function (e) {
          ...
          return e.startContainer === t && 0 === e.startOffset
            ? he.none()
            : he.from(o.selection.getStart(!0));
        })
        .orThunk(A(A1, n))
        .map(Et.fromDom)
        .filter(An)
  ...
  var D1 = Jn,
    ...
    U1 = function (t, n, r) {
      ...
      if (
        ...
        e &&
          -1 === St.inArray(n, r) &&
          (St.each(Bv.dependencies(r), function (e) {
            U1(t, n, e);
          }),
          !t.plugins[r]))
      )
        try {
          ...
          (i = r),
            (a = e),
            Tf((o = t), 'PluginLoadError', {
              message: (u = yu.translate([
    ...
    W1 = St.inArray,
    K1 =
      ((X1.prototype.execCommand = function (t, n, r, e) {
        var o,
          i,
          a = !1,
          u = this;
        if (!u.editor.removed) {
          ...
          if (
            (q1(this.editor.plugins, function (e) {
        ...
        this.addCommands({
              ...
              (r = u).removed ||
                (o
                  ...
                  : function (t) {
                      ...
                      t.inline || (Ct.opera || Ad(n), t.getWin().focus()),
                        (Ct.gecko || t.inline) && (Ad(n), _d(t, r)),
                        Yd(t);
                    })(r);
          },
          ...
          'JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone':
            function (e) {
              var t = e.substring(7);
              'full' === t && (t = 'justify'),
                q1('left,center,right,justify'.split(','), function (e) {
          ...
          FontSize: function (e, t, n) {
            var r;
            (r = u).formatter.toggle('fontsize', { value: R1(r, n) }),
              r.nodeChanged();
          },
    ...
    _u(e, t) && !1 === n
      ? ((o = t),
        Nu((r = e))
          ...
          : ((u = o),
            0 <
            (s = U(Eu((a = r), 'class'), function (e) {
              return e !== u;
            })).length
              ? gn(a, 'class', s.join(' '))
              : bn(a, 'class')),
        0 === (Nu((i = r)) ? i.dom.classList : Eu(i, 'class')).length &&
          bn(i, 'class'))
      : n && ku(e, t);
  }
  function G1(e, t, n) {
  ...
  function Q1(e, t) {
    var n,
      r,
      o = Et.fromDom(e.getBody());
    Y1(o, 'mce-content-readonly', t),
      t
        ? (e.selection.controlSelection.hideResizeRect(),
          e._selectionOverrides.hideFakeCaret(),
          he.from(e.selection.getNode()).each(function (e) {
            e.removeAttribute('data-mce-selected');
          }),
          J1(o, !(e.readonly = !0)),
          X(Au(o, '*[contenteditable="true"]'), function (e) {
            gn(e, tw, 'true'), J1(e, !1);
          }))
        : (J1(o, !(e.readonly = !1)),
          X(Au(o, '*[' + tw + '="true"]'), function (e) {
            bn(e, tw), J1(e, !0);
          }),
          G1(e, 'StyleWithCSS', !1),
          G1(e, 'enableInlineTableEditing', !1),
          G1(e, 'enableObjectResizing', !1),
          (Td((n = e)) ||
            ((r = n),
            md(Ln(Et.fromDom(r.getElement())))
              .filter(function (e) {
                return (
                  !(
  ...
  function ew(t) {
    t.parser.addAttributeFilter('contenteditable', function (e) {
      Z1(t) &&
        X(e, function (e) {
          e.attr(tw, e.attr('contenteditable')),
  ...
  function ow(e) {
    (this.bindings = {}),
      ...
      (this.toggleEvent = this.settings.toggleEvent || T);
  }
  function iw(n) {
    return (
      n._eventDispatcher ||
        (n._eventDispatcher = new rw({
          scope: n,
  ...
  function aw(e, t) {
    ...
    var n = qs(e);
    return n
      ? (e.eventRoot || (e.eventRoot = mw.select(n)[0]), e.eventRoot)
      : e.getBody();
  }
  function uw(e, t, n) {
    var r, o, i, a;
  ...
  function cw(e, t, n, r) {
    ...
    o.deactivate(),
      o.editorReadOnly !== i.editorReadOnly && Q1(e, i.editorReadOnly),
      t.set(r),
    ...
    hw(vw(e.toLowerCase(), '+'), function (e) {
      e in yw
        ...
        : ((n.charCode = e.charCodeAt(0)),
          (n.keyCode = bw[e] || e.toUpperCase().charCodeAt(0)));
    });
    var r = [n.keyCode];
    for (t in yw) n[t] ? r.push(t) : (n[t] = !1);
    return (
      (n.id = r.join(',')),
      n.access && ((n.alt = !0), Ct.mac ? (n.ctrl = !0) : (n.shift = !0)),
      n.meta && (Ct.mac ? (n.meta = !0) : ((n.ctrl = !0), (n.meta = !1))),
      n
    );
  }
  var fw,
        ...
        'focus' !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                (n.dom.unbind(aw(n, e), e, n.delegates[e]),
    ...
    Cw =
      ((ww.prototype.add = function (e, n, t, r) {
        var o = this,
          i = o.normalizeCommandFunc(t);
        return (
          hw(vw(St.trim(e)), function (e) {
      ...
      (ww.prototype.createShortcut = function (e, t, n, r) {
        ...
        return (
          (o[o.length - 1] = St.extend(o[o.length - 1], {
            func: n,
            scope: r || this.editor,
          })),
          St.extend(o[0], {
        ...
        return (
          0 !==
            (r =
              (n = u.length - o) <= 0
                ? H(i).join('/')
                : u.slice(0, n).join('/') + '/' + H(i).join('/')).indexOf(
              '/',
            ) && (r = '/' + r),
      ...
      : ((n = 0 === e.indexOf('//')),
        ...
        /^[\w\-]*:?\/\//.test(e) ||
          ((r = this.settings.base_uri
            ...
            : new _w(document.location.href).directory),
          (e =
  ...
  var Aw = cu.DOM,
    ...
    Bw =
        ...
        !(function (t) {
          ...
          bi.Event.domLoaded
            ? t.getElement() &&
              ...
              (i = t.getElement().form || z1.getParent(e, 'form')) &&
                ((t.formElement = i),
                t.getParam('hidden_input') &&
                  !Vn(t.getElement()) &&
                  (z1.insertAfter(
                    z1.create('input', { type: 'hidden', name: e }),
                    e,
                  ),
                  (t.hasHiddenInput = !0)),
                ...
                z1.bind(i, 'submit reset', t.formEventDelegate),
                t.on('reset', function () {
                  t.resetContent();
                }),
              ...
              (t.windowManager = Lv(t)),
              (t.notificationManager = fv(t)),
              ...
              'string' == typeof (s = l)
                ? X(
                    ...
                    function (e) {
                      var t = e.split('=');
                      1 < t.length
                        ? (c[St.trim(t[0])] = St.trim(t[1]))
                        : (c[St.trim(t[0])] = St.trim(t[0]));
                    },
                  )
                : (c = s),
              c)
      ...
      (Pw.prototype.show = function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (Aw.show(this.getContainer()), Aw.hide(this.id)),
          this.load(),
          this.fire('show'));
      }),
          ...
          return (
            ...
            Vn(o)
              ...
              : ((!e.is_removing && r.inline) || (o.innerHTML = t),
                (n = Aw.getParent(r.id, 'form')) &&
                  Rw(n.elements, function (e) {
      ...
      (Pw.prototype.resetContent = function (e) {
        void 0 === e
          ? ev(this, this.startContent, { format: 'raw' })
          : ev(this, e),
      ...
      (Pw.prototype.getElement = function () {
        return (
          this.targetElm || (this.targetElm = Aw.get(this.id)), this.targetElm
        );
      }),
      ...
      (Pw.prototype.remove = function () {
        ...
        (e = this).removed ||
          ...
          e.hasHiddenInput && o && Cv.remove(o.nextSibling),
          e.fire('remove'),
          e.editorManager.remove(e),
          !e.inline && r && Cv.setStyle(e.id, 'display', e.orgDisplay),
          e.fire('detach'),
          Cv.remove(e.getContainer()),
          tv(t),
          tv(n),
          e.destroy());
      }),
            ...
            (n || t.removed
              ? (n ||
                ...
                (o = (r = t).formElement) &&
                  ...
                  Cv.unbind(o, 'submit reset', r.formEventDelegate)),
  ...
  function Pw(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        (mu.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy),
        cu.DOM.styleSheetLoader._setReferrerPolicy(
          this.settings.referrer_policy,
        )),
      ...
      (this.id = e),
      this.setDirty(!1),
      (this.documentBaseURI = new kw(this.settings.document_base_url, {
        base_uri: this.baseUri,
      })),
      (this.baseURI = this.baseUri),
      (this.inline = !!this.settings.inline),
      (this.shortcuts = new Cw(this)),
      (this.editorCommands = new K1(this)),
      this.settings.cache_suffix &&
        (Ct.cacheSuffix = this.settings.cache_suffix.replace(/^[\?\&]+/, '')),
      (this.ui = {
        registry: {
          addAutocompleter:
            ((u = {}),
    ...
    var x,
      ...
      _ =
        ((N = pu('design')),
        (k = pu({
          design: { activate: oe, deactivate: oe, editorReadOnly: !1 },
          readonly: { activate: oe, deactivate: oe, editorReadOnly: !0 },
        })),
        (S = x = this).serializer
          ? ew(S)
    ...
    (this.mode = _),
      ...
      (this.$ = ou.overrideDefaults(function () {
        return {
  ...
  function Iw(e) {
    e !== qw &&
      (e
        ? ou(window).on('resize scroll', Lw)
        : ou(window).off('resize scroll', Lw),
      (qw = e));
  }
  function Mw(t) {
    var e = Ww;
    ...
    return (
      ...
      Xw.activeEditor === t && (Xw.activeEditor = 0 < Ww.length ? Ww[0] : null),
      Xw.focusedEditor === t && (Xw.focusedEditor = null),
      e.length !== Ww.length
    );
  }
  var Fw,
    ...
    Xw = ke(ke({}, dw), {
      ...
      setup: function () {
        ...
        (this.baseURL = new kw(n).toAbsolute(e)),
          (this.documentBaseURL = n),
          (this.baseURI = new kw(this.baseURL)),
          (this.suffix = t),
          this.on('AddEditor', A(Nd, this)),
          this.on('RemoveEditor', A(kd, this));
      },
        ...
        var n,
          ...
          t = function () {
            ...
            var o,
              ...
              i = 0,
              a = [];
            Uw.unbind(window, 'ready', t),
              (e = r.onpageload) && e.apply(c, []),
              (o = ou.unique(
                (function (t) {
                  var n = [];
                  if (Ct.browser.isIE() && Ct.browser.version.major < 11)
                    return (
                      uy(
              ...
              r.types
                ? jw(r.types, function (t) {
                    St.each(o, function (e) {
                      return (
                        !Uw.is(e, t.selector) || (n(u(e), Hw({}, r, t), e), !1)
                      );
                    });
                  })
                : (St.each(o, function (e) {
      ...
      add: function (e) {
        ...
        return (
          $w[e.id] === e ||
            (null === n.get(e.id) &&
              ('length' !== e.id && ($w[e.id] = e), $w.push(e), Ww.push(e)),
            Iw(!0),
            (n.activeEditor = e),
            ...
            Fw ||
              ...
              window.addEventListener('beforeunload', Fw))),
          e
        );
      },
      ...
      remove: function (e) {
        ...
        if (e) {
          if (!K(e))
            return (
              ...
              l(r.get(n.id))
                ? null
                : (Mw(n) && r.fire('RemoveEditor', { editor: n }),
                  0 === Ww.length &&
                    window.removeEventListener('beforeunload', Fw),
                  n.remove(),
                  Iw(0 < Ww.length),
                  n)
            );
        ...
        } else for (t = Ww.length - 1; 0 <= t; t--) r.remove(Ww[t]);
      },
      ...
      _setBaseUrl: function (e) {
        (this.baseURL = new kw(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, ''),
        )),
          (this.baseURI = new kw(this.baseURL));
      },
  ...
  Gw.extend = ex = function (n) {
    ...
    return (
      (tx = !1),
      n.Mixins &&
        (ux(n.Mixins, function (e) {
          for (var t in e) 'init' !== t && (n[t] = e[t]);
        }),
        o.Mixins && (n.Mixins = o.Mixins.concat(n.Mixins))),
      n.Methods &&
        ux(n.Methods.split(','), function (e) {
          n[e] = t;
        }),
      n.Properties &&
        ux(n.Properties.split(','), function (e) {
          var t = '_' + e;
          n[e] = function (e) {
      ...
      n.Statics &&
        ux(n.Statics, function (e, t) {
          r[t] = e;
        }),
      n.Defaults && o.Defaults && (n.Defaults = sx({}, o.Defaults, n.Defaults)),
      Q(n, function (e, t) {
        var n, r;
    ...
    vx = ke(ke({}, dw), {
      send: function (e) {
        ...
        if (
          ...
          (e.async = !1 !== e.async),
          (e.data = e.data || ''),
          vx.fire('beforeInitialize', { settings: e }),
          ...
          e.requestheaders &&
            St.each(e.requestheaders, function (e) {
              t.setRequestHeader(e.key, e.value);
            }),
          t.setRequestHeader('X-Requested-With', 'XMLHttpRequest'),
          (t = vx.fire('beforeSend', { xhr: t, settings: e }).xhr).send(e.data),
          !e.async)
        )
          return r();
        Ur.setTimeout(r, 10);
    ...
    yx =
      ...
      (Cx.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          (e =
            void 0 === (e = px.parse(e)) ? { error: 'JSON Parse error.' } : e)
            .error
