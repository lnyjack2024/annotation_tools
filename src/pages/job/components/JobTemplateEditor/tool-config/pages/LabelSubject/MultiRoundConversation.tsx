...
export interface LabelSubjectMultiRoundConversationHandle {
  updateValues: () => Promise<string>;
}

const LabelSubjectMultiRoundConversation = forwardRef<
    ...
    <Form form={form} colon={false}>
      <div className="common-wrapper">
        ...
        <div className="form-block">
          <div className="form-title form-title-inline">
            {formatMessage({
              id: "TEMPLATE_SUBJECT_ROUND_CONVERSATION_EDITABLE",
            })}
                  ...
                  <div className="common-panel">
                    ...
                    <div style={{ display: 'flex' }}>
                      <Form.Item
                        ...
                        valuePropName="checked">
                        <Checkbox>
                          {formatMessage({ id: 'TEMPLATE_SUBJECT_ROUND_CONVERSATION_COUNT_LIMITED' })}
                        </Checkbox>
                      </Form.Item>
                      <Form.Item
                        shouldUpdate={(prevValues, curValues) =>
...
export default LabelSubjectMultiRoundConversation;
