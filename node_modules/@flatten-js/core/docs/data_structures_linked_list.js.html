...
<head>
    ...
    <title>data_structures/linked_list.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">data_structures/linked_list.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import Flatten from "../flatten";
