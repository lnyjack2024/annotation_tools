...
describe('#Algorithms.Boolean Operations', function () {
    describe('#Algorithms.Boolean Union', function () {
        ...
        it('Can perform unify. Infinite loop for boolean union over (valid) polygons. Issue #55 case 2', function () {
            ...
            let res = unify(poly1, poly2);
            expect(res.faces.size).to.equal(1);
            expect(res.edges.size).to.equal(32);
        });
...
// const z0Surface = [[[1, 1, 0], [9, 1, 0], [9, 9, 0], [1, 11, 0]]]; // subtraction works when not producing holes
        ...
        it('Can perform subtract. Issue #55 case 0', function () {
            "use strict";
        ...
        it('Can perform subtract. Issue #55 case 1', function () {
            "use strict";
        ...
        it('Can perform subtract. Infinite loop for boolean union over (valid) polygons. Issue #55 case 2', function () {
            "use strict";
        ...
        it('Can perform subtract. Infinite loop for boolean union over (valid) polygons. Issue #55 case 3', function () {
            "use strict";
    ...
    describe('#Algorithms.Boolean Intersection', function () {
        ...
        it('Can perform intersection. Issue #55 case 1', function () {
            "use strict";
        ...
        it('Can perform intersect. Infinite loop for boolean union over (valid) polygons. Issue #55 case 2', function () {
            "use strict";
        ...
        it('Can perform intersect. Infinite loop for boolean union over (valid) polygons. Issue #55 case 3', function () {
            "use strict";
